                                     ...
                                     <fo:table-body>
                                       <xsl:for-each select="tituloEncabezado/element"> 
                                        ...
                                        <fo:table-row font-weight="bold" background-color="#000066">
                                            <fo:table-cell>
                                              <fo:block text-align="left" font-weight="bold" font-size="11pt" color="#ffffff">
                                                      <xsl:value-of select="titulo"/>
                                              </fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                       ...
                       <!--tabla titulo detalle -->
                                              ...
                                              <fo:table-body>
                                                <xsl:for-each select="tituloDetalle/element"> 
                                                  <fo:table-row font-weight="bold" background-color="#000066">
                                                      <fo:table-cell>
                                                        <fo:block text-align="left" font-weight="bold" font-size="11pt" color="#ffffff">
                                                                     <img border="2" width="16" height="16">
                                                                      
                                                                                           <xsl:attribute name="src">http://localhost:7001/belwls/bciexpress/img/cnf_h_empresas2.gif"</xsl:attribute> 
                                                                                      </img>
                        ...
                        <fo:block space-before="2mm" font-weight="bold" />    
                         ...
                         <!-- fin listado -->
                          ...
                          <fo:block font-family="Times" text-align="left" font-size="9pt" line-height="20mm"/>
                                                   
                         <!-- Totales --> 
                         <fo:block text-align="left" border-width="40px" />     
                         <fo:block>
                         ...
                         <fo:table table-layout="fixed" width="200mm">
                           ...
                           <fo:table-body>
                              <xsl:for-each select="totales/element"> 
                                <fo:table-row  >
                                  <fo:table-cell>
                                    <fo:block >
                                       Totales
