    ...
    <xsl:template match="documento">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="minutaDeAprobacion" page-width="200mm" page-height="279.4mm" margin-top="10mm" margin-bottom="10mm" margin-left="5mm" margin-right="5mm">
                    <fo:region-body/>
                  ...
                  <!-- bloque titulo General -->
                    ...
                    <!-- bloque titulo encabezado -->
                       ...
                       <!--tabla titulo detalle -->
                         ...
                         <fo:table table-layout="fixed" width="194mm">
