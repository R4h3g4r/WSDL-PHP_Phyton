...
<xsl:template match="/">
		...
		<body>
			...
			<tr bgcolor="#dedede">
 			...
 			<td xsl:use-attribute-sets="ColHeader">
	 			<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=BCK">
	 			<xsl:text>Back Office</xsl:text>
	 			</a>
 			</td>
 			<td xsl:use-attribute-sets="ColHeader">
	 			<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=CCE">
	 			<xsl:text>Call Center</xsl:text>
	 			</a>
 			</td>
 			<td xsl:use-attribute-sets="ColHeader" width="100">
	 			<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=FVT">
				<xsl:text>Fuerza Venta</xsl:text>
				</a>
	 			
 			</td>
 			<td xsl:use-attribute-sets="ColHeader">
 				<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=MRK">
	 			<xsl:text>Marketing</xsl:text>
	 			</a>
 			</td>
 			<td xsl:use-attribute-sets="ColHeader">
 			
 			<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=RGO">
 				<xsl:text>Riesgo</xsl:text>
 			</a>
 			
 			</td>
 			<td xsl:use-attribute-sets="ColHeader">
 				<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=TEC">
 				<xsl:text>Tecnologia</xsl:text>
			</a>
 			</td>
 			<td xsl:use-attribute-sets="ColHeader">
 			
 			<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=UAS">
 				<xsl:text>UAS</xsl:text>
 			</a>
 			
 			</td>
 			<td xsl:use-attribute-sets="ColHeader">
 				<a href="ReportServlet?reportName=Ejecutivo/Area&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=BOT">
		...
		<xsl:template match="BEANDATA" >
			...
			<tr bgcolor="#f0f0f0">
				...
				<xsl:attribute name="href">
					<xsl:text>
						ReportServlet?reportName=Ejecutivo&#32;call&#32;center&#40;Envia&#41;&#38;typeCode=
					</xsl:text>
