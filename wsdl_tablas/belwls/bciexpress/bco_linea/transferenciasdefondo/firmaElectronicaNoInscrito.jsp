...
<%
	String numeroDeLaCuenta   = request.getParameter("numeroDeLaCuenta");
	String codigoDelBanco     = request.getParameter("codigoDelBanco" );
	String rutBeneficiario    = request.getParameter("rutBeneficiario");
	String dvBeneficiario     = request.getParameter("dvBeneficiario");
	String nombreBeneficiario = request.getParameter("nombreBeneficiario");
	String nombreDeLaCuenta   = request.getParameter("nombreDeLaCuenta");
...
<form method='post' action='/belwls/bciexpress/bco_linea/transferenciasdefondo/cuentasInscritas.do?accion=agregarCuentasInscritas' name='firma1'>
...
<INPUT name="accion"         type="hidden" value="agregarCuentasInscritas">

<INPUT name="numeroDeLaCuenta"   type="hidden" value="<%= numeroDeLaCuenta%>">
<INPUT name="codigoDelBanco"     type="hidden" value="<%= codigoDelBanco%>">
<INPUT name="rutBeneficiario"    type="hidden" value="<%= rutBeneficiario%>">
<INPUT name="dvBeneficiario"     type="hidden" value="<%= dvBeneficiario%>">
<INPUT name="nombreBeneficiario" type="hidden" value="<%= nombreBeneficiario%>">
<INPUT name="nombreDeLaCuenta"   type="hidden" value="<%= nombreDeLaCuenta%>">
<INPUT name="emailBeneficiario"  type="hidden" value="<%= emailBeneficiario%>">
...
<SCRIPT language=javascript>
  ...
  "<table width=100%><TR><TD><FONT SIZE=-1 FACE='Courier'>Estoy autorizando la creaci&oacute;n de una Cuenta Inscrita</FONT></TD></TR></table>";
  }

</SCRIPT>

<form name=cancelar action="<%=TablaValores.getValor("ws_sophialite.parametros", "urlCtaInscrita", "Desc" )%>" method="post">
<center>
<table border="0">
<tr>
...
<%--
******************************************************************************************************
* Archivo           firmaElectronicaNoInscrito.jsp

* Descripción		Validador de Certificado Digital para Agregar Cuenta
