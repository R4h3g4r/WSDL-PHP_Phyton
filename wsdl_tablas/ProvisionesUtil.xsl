                            ...
                            <fo:table-body>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0">       
                                        <fo:block >
                                            <fo:inline >
                                            	...
                                            	<xsl:value-of select="format-number( RiesgosVO/comportamientoPorcentajeProvisionBci, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0">       
                                        <fo:block >
                                            <fo:inline >
                                                ...
                                                <xsl:value-of select="format-number( RiesgosVO/comportamientoPorcentajeProvisionLeasing, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0">       
                                        <fo:block >
                                            <fo:inline >
                                                ...
                                                <xsl:value-of select="format-number( RiesgosVO/protestosPorcentajeProvisionBci, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0">       
                                        <fo:block >
                                            <fo:inline >
                                           		...
                                           		<xsl:value-of select="format-number( RiesgosVO/protestosPorcentajeProvisionLeasing, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0">       
                                        <fo:block >
                                            <fo:inline >
                                            	...
                                            	<xsl:value-of select="format-number( RiesgosVO/renegociadosPorcentajeProvisionBci, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0" >       
                                        <fo:block >
                                            <fo:inline >
                                            	...
                                            	<xsl:value-of select="format-number( RiesgosVO/renegociadosPorcentajeProvisionLeasing, '#.##0,00#', 'euro')"/>
                                ...
                                <fo:table-row  background-color="#f0f0f0">		     
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0" >       
                                        <fo:block >
                                            <fo:inline >
                                            	<xsl:value-of select="format-number( RiesgosVO/cuentasEspecialesPorcentajeProvisionBci, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="normal" text-align="center" background-color="#f0f0f0">       
                                        <fo:block >
                                            <fo:inline >
                                            	<xsl:value-of select="format-number( RiesgosVO/cuentasEspecialesPorcentajeProvisionLeasing, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="bold" text-align="center" background-color="#dedede">       
                                        <fo:block >
                                            <fo:inline >
                                            	...
                                            	<xsl:value-of select="format-number( RiesgosVO/totalRiesgosPorcentajeProvisionBci, '#.##0,00#', 'euro')"/>
                                    ...
                                    <fo:table-cell  color="#006666" font-size="6pt" font-weight="bold" text-align="center" background-color="#dedede">       
                                        <fo:block >
                                            <fo:inline >
                                            	...
                                            	<xsl:value-of select="format-number( RiesgosVO/totalRiesgosPorcentajeProvisionLeasing, '#.##0,00#', 'euro')"/>
