...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
						...
						<fo:table table-layout="fixed">
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src"><xsl:value-of select="convenio-empresa/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
											<xsl:value-of select="convenio-empresa/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/nombreCliente"/>
							</fo:block>
							<!-- nombre cliente -->
						</fo:table-cell>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
								...
								<fo:inline color="{$txt-azul-claro}">
									<xsl:value-of select="convenio-empresa/rutCliente"/>
								</fo:inline>
							</fo:block>
							<!-- rut cliente -->
						</fo:table-cell>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell>
							<xsl:call-template name="subTitulo">
								<xsl:with-param name="titulo" select="'Detalle de Relación Cliente - Convenio'"/>
							</xsl:call-template>
							<!-- Separador -->
							<fo:block space-after="2mm">
								</fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<xsl:call-template name="subTitulo">
								<xsl:with-param name="titulo" select="'Detalle de Convenios'"/>
							</xsl:call-template>
							<!-- Separador -->
							<fo:block space-after="2mm">
								</fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<xsl:call-template name="subTitulo">
								<xsl:with-param name="titulo" select="'Planes'"/>
							</xsl:call-template>
							<!-- Separador -->
							<fo:block space-after="2mm">
								</fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<xsl:call-template name="subTitulo">
								<xsl:with-param name="titulo" select="'Detalles de Planes'"/>
							</xsl:call-template>
							<!-- Separador -->
							<fo:block space-after="2mm">
								</fo:block>
							<!-- Separador -->
							<xsl:call-template name="detallePlanes"/>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block font-weight="bold" font-size="9pt" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;&#0160;&#0160;&#0160;&#0160;<xsl:value-of select="convenio-empresa/rutEmpresa"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:choose>
						<xsl:when test="count(convenio-empresa/convenios/convenio) > 0">
							<xsl:for-each select="convenio-empresa/convenios/convenio">
								<fo:table-row>
									<fo:table-cell border="0.5pt solid {$lineas}">
				...
				<fo:table-body>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell background-color="{$bgcolor}" number-columns-spanned="4" border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="8pt" font-weight="bold" text-align="left" color="{$txt-azul-oscuro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/descripcion"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<!-- FILA 1 -->
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/fechaApertura"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/estado"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
								<xsl:call-template name="itemTitulo">
									<xsl:with-param name="titulo" select="'Fecha Eliminación:'"/>
								</xsl:call-template>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/fechaEliminacion"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/minProductos"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
								<xsl:call-template name="itemTitulo">
									<xsl:with-param name="titulo" select="'Renta Mínima (UF):'"/>
								</xsl:call-template>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/rentaMinima"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/oficinaConvenio"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/clienteEspecial"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-convenio/tipoConvenio"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/plan/descPlan"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
								<xsl:call-template name="itemTitulo">
									<xsl:with-param name="titulo" select="'Valor del plan:'"/>
								</xsl:call-template>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/plan/valorSegunConvenio"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
								<xsl:call-template name="itemTitulo">
									<xsl:with-param name="titulo" select="'Pdo. Gracia:'"/>
								</xsl:call-template>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/plan/periodoGracia"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/plan/estadoPlan"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
	...
	<xsl:template name="detallePlanes">
		<fo:block space-after="0.1mm" font-size="7pt">
			<fo:table table-layout="fixed">
				<fo:table-column column-width="3cm"/>
				<fo:table-column column-width="3cm"/>
				<fo:table-column column-width="3cm"/>
				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-plan/producto"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>		
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-plan/valorCobro"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>		
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-plan/moneda"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>		
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-plan/spread"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>		
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="convenio-empresa/detalle-plan/tipo"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>	
					...
					<fo:table-row>
						<fo:table-cell padding-before="1mm">
							<fo:external-graphic height="1.2mm" width="1.2mm">
								<xsl:attribute name="src"><xsl:value-of select="convenio-empresa/rutaImagen"/>01-bullet2-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
					...
					<fo:table-row>
						<fo:table-cell padding-left="2mm" padding-before="1mm">
							<fo:external-graphic height="1mm" width="1mm">
								<xsl:attribute name="src"><xsl:value-of select="convenio-empresa/rutaImagen"/>01-bullet1-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
