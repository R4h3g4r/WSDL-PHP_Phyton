                        ...
                        <fo:table table-layout="fixed">
                            ...
                            <fo:table-body>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:value-of select="fechaPerido1"/>
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell>
                                        </fo:table-cell>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:value-of select="numeBalance1"/>
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell>
                                        </fo:table-cell>
...
<!--***************************************************************************************************-->
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDeActivos/ccaDesActCirUno"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDeActivos/ccaDesActCirDos"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDeActivos/ccaDesActCirTres"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDeActivos/ccaDesActCirLPUno"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDeActivos/ccaDesActCirLPDos"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDeActivos/ccaDesActCirLPTres"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDeActivos">
                                        <fo:table-cell>
                         ...
                         <fo:block space-after="2mm">
                            <fo:leader leader-pattern=" " leader-length="17cm"/>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPasCirUno"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPasCirDos"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPasCirTres"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPasCirLPUno"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPasCirLPDos"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPatrimonioUno"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                               ...
                               <!-- Aca esta el pasivo DOS -->
                               <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstComparacionDePasivos/ccaDesPatrimonioDos"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstComparacionDePasivos">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrIngreExplotacion * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrCostoExplotacion * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(dadDepreciacion * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrMargenExplotacion * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrGastosAdminVtas * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell padding="1pt" border="0.5pt solid black">
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrResultadoOperac * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrIngreFinanciero * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrUtilInvEmpRelac * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrOtrosIngreFueraExp * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrPerdInvEmpRelac * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrAmortMenValorInv * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrGastosFinancieros * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrOtrosEgreFuerExplo * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrCorrecMonetaria * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstConCompEstResultadoBalance/ccaDesCtaResultadoUno"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        <fo:table-cell>
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(ccaValCtaResultadoUno * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstConCompEstResultadoBalance/ccaDesCtaResultadoDos"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        <fo:table-cell>
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(ccaValCtaResultadoDos * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell padding="1pt" border="0.5pt solid black">
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrResultNoOpera * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrResulAntImpRenta * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrImpRenta * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrUtilPerdConso * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrIntMinoritario * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrUtilPerdLiquida * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrAmortMayValorInv * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstConCompEstResultadoBalance">
                                        ...
                                        <fo:table-cell padding="1pt" border="0.5pt solid black">
                                            <fo:block text-align="end">
                                                <xsl:if test="number(edrIngreExplotacion) != 0"><xsl:if test="number(edrIngreExplotacion) > 99999"><xsl:value-of select="format-number(edrUtilPerdEjercicio * 100 div edrIngreExplotacion, '#.##0,00', 'pesos')"/></xsl:if></xsl:if>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:for-each>                                        
                                </fo:table-row>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstIndicesDeFecu">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                    ...
                    <fo:block space-after="2mm">
                        <fo:leader leader-pattern=" " leader-length="17cm"/>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDesActCirc1"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDesActCirc2"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDesActCirc3"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDesPasCirc1"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDesPasCirc2"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDesPasCirc3"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoAumDesAcLP1"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoAumDesAcLP2"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoAumDesAcLP3"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDisDsPasLP1"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDisDsPasLP2"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDisDsActLP1"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDisDsActLP2"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoDisDsActLP3"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoAumDsPasLP1"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="EstUsos_y_FuentesFecu/usoAumDsPasLP2"/>:
                                        </fo:block>
                                    </fo:table-cell>
                                    <xsl:for-each select="EstUsos_y_FuentesFecu">
                                        <fo:table-cell>
                                ...
                                <fo:table-row>
                                    ...
                                    <xsl:for-each select="EstReconciliacion">
                                        <fo:table-cell>
                                            <fo:block text-align="end">
