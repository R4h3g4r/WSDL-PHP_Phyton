										...
										<fo:block font-size="5px" font-weight="bold" text-align="center" color="{$txt}" border="2px solid {$txt}">
											<fo:table table-layout="fixed">
												...
												<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="9px" color="{$txt}" text-align="center">FACTURA ELECTRONICA</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell>
						<xsl:choose>
						<xsl:when test= "DTE/Documento/Encabezado/IdDoc/GlsFmaPago">
						<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="DTE/Documento/Encabezado/IdDoc/GlsFmaPago"/></fo:block>
						</xsl:when>
						<xsl:otherwise>
							...
							<fo:block font-weight="bold" font-size="12px" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center" border="1px solid {$lineas}">
								...
								<fo:table table-layout="fixed">
									...
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell>
												<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">&#xA0;<xsl:value-of select="format-number(DTE/Documento/Encabezado/Totales/MntNeto, $miles, 'CL')"/></fo:block>
											</fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell>
												<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">&#xA0;<xsl:value-of select="format-number(DTE/Documento/Encabezado/Totales/IVA, $miles, 'CL')"/></fo:block>
											</fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="dte-T33.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
