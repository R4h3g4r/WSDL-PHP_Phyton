										...
										<fo:block font-size="5px" font-weight="bold" text-align="center" color="{$txt}" border="2px solid {$txt}">
											<fo:table table-layout="fixed">
												...
												<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="9px" color="{$txt}" text-align="center">FACTURA NO AFECTA O EXENTA ELECTRONICA</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
			...
			<fo:table table-layout="fixed" height="9cm">
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right" margin-right="1mm">&#xA0;</fo:block>
						</fo:table-cell>
						<fo:table-cell>
