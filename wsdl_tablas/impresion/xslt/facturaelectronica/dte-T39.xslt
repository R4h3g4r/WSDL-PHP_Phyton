										...
										<fo:block space-after="1mm" text-align="center" color="{$txt}">
											...
											<fo:table table-layout="fixed">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="13px" color="{$txt}" text-align="center">R.U.T.&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Emisor/RUTEmisor"/></fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="13px" color="{$txt}" text-align="center">
																<xsl:value-of select="BOLETA/Documento/Encabezado/Emisor/RznSocEmisor"/>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="13px" color="{$txt}" text-align="center">GIRO:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Emisor/GiroEmisor"/></fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="11px" color="{$txt}" text-align="center">
																<xsl:value-of select="BOLETA/Documento/Encabezado/Emisor/DirOrigen"/>&#xA0;-&#xA0;
																<xsl:value-of select="BOLETA/Documento/Encabezado/Emisor/CmnaOrigen"/>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
												</fo:table-body>
										...
										<fo:block font-size="5px" font-weight="bold" text-align="center" color="{$txt}" border="2px solid {$txt}">
											<fo:table table-layout="fixed">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="11px" color="{$txt}" margin-left="4mm" padding-before="1mm" text-align="center">&#xA0;</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="9px" color="{$txt}" text-align="center">BOLETA ELECTRONICA</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="9px" color="{$txt}" padding-before="3mm" padding-after="1mm" text-align="center">Nº&#xA0;
																<xsl:value-of select="BOLETA/Documento/Encabezado/IdDoc/Folio"/>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
												</fo:table-body>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Receptor/RznSocRecep"/></fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" space-after="1mm" space-before="2mm" margin-left="2mm" text-align="left" color="{$txt}">R.U.T.</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Receptor/RUTRecep"/></fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						<fo:table-cell>
						...
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Receptor/DirRecep"/></fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" space-after="1mm" space-before="2mm" margin-left="2mm" text-align="left" color="{$txt}">FECHA</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/IdDoc/FchEmis"/></fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						<fo:table-cell>
						...
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Receptor/CmnaRecep"/></fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" space-after="1mm" space-before="2mm" margin-left="2mm" text-align="left" color="{$txt}">CONDICIÓN DE PAGO</fo:block>
						</fo:table-cell>
						<fo:table-cell>
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="bold" font-family="Helvetica" space-after="1mm" space-before="2mm" text-align="left" color="{$txt}">:&#xA0;<xsl:value-of select="BOLETA/Documento/Encabezado/Receptor/CiudadRecep"/></fo:block>
						</fo:table-cell>
						<fo:table-cell>
			...
			<fo:table table-layout="fixed" height="9cm">
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell background-color="{$lineas}">
							<fo:block font-weight="bold" font-size="8px" color="{$txt}" text-align="center">
							</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$lineas}">
							<fo:block font-weight="bold" font-size="8px" color="{$txt}" text-align="center">&#xA0;</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$lineas}">
							<fo:block font-weight="bold" font-size="8px" color="{$txt}" text-align="center">&#xA0;TOTAL</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<xsl:for-each select="BOLETA/Documento/Detalle">
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">
						...
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right" margin-right="1mm">
								<xsl:value-of select="format-number(PrcItem, $miles, 'CL')"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right" margin-right="1mm">
					...
					<fo:table-row height="0.3cm">
							...
							<fo:block font-weight="bold" font-size="5px" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
								<fo:table table-layout="fixed">
									...
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell>
												<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">TOTAL</fo:block>
											</fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell>
						...
						<fo:table-cell>
							<fo:block font-weight="bold" font-size="12px" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center" border="1px solid {$lineas}">
								<!-- TABLA ANIDADA EN TERCERA COLUMNA -->
								<fo:table table-layout="fixed">
									<fo:table-column column-width="2cm"/>
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell>
												<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">&#xA0;<xsl:value-of select="format-number(BOLETA/Documento/Encabezado/Totales/MntTotal, $miles, 'CL')"/></fo:block>
											</fo:table-cell>
										</fo:table-row>
									</fo:table-body>
								</fo:table>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row height="2.5cm">
						<fo:table-cell margin-right="1mm" margin-left="1mm">
							<fo:block font-weight="bold" font-size="7px" color="{$txt-azul-claro}" padding-before="1mm" text-align="left">
							</fo:block>
							<fo:block font-weight="bold" font-size="7px" color="{$txt-azul-claro}" padding-before="1mm" text-align="left">
							</fo:block>
							<fo:block font-weight="bold" font-size="7px" color="{$txt-azul-claro}" padding-before="1mm" text-align="left">
							...
							<fo:block font-weight="bold" font-size="4px" color="{$txt}" padding-before="1mm" text-align="left">
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="dte-T39.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
	...
	<MapperMetaTag>
		<MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no">
			<SourceSchema srcSchemaPath="dte-T39.xml" srcSchemaRoot="BOLETA" AssociatedInstance="" loaderFunction="document" loaderFunctionUsesURI="no"/>
		</MapperInfo>
		<MapperBlockPosition>
			<template match="/">
