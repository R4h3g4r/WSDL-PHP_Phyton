										...
										<fo:block font-size="5px" font-weight="bold" text-align="center" color="{$txt}" border="2px solid {$txt}">
											<fo:table table-layout="fixed">
												...
												<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-family="Helvetica" font-weight="bold" font-size="9px" color="{$txt}" text-align="center">NOTA DE CREDITO ELECTRONICA</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
					...
					<fo:table-row height="9cm">
						<fo:table-cell>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">&#xA0;
								<xsl:value-of select="DTE/Documento/Detalle/NroLinDet"/>&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;
								&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;
								<xsl:value-of select="DTE/Documento/Detalle/NmbItem"/>
							</fo:block>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">&#xA0;
								&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;
								&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;
								<xsl:value-of select="DTE/Documento/Detalle/DscItem"/>
							</fo:block>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">&#xA0;</fo:block>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">&#xA0;</fo:block>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">&#xA0;</fo:block>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">&#xA0;</fo:block>
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">&#xA0;</fo:block>
							...
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left" margin-left="4mm">
								<xsl:value-of select="DTE/Documento/Referencia/RazonRef"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block>&#xA0;</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5px solid {$lineas}">						
							<fo:block font-size="7px" font-weight="normal" font-family="Helvetica" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right" margin-right="1mm">
								<xsl:value-of select="format-number(DTE/Documento/Detalle/MontoItem, $miles, 'CL')"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block font-weight="bold" font-size="5px" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
								<fo:table table-layout="fixed">
									...
									<fo:table-body>
										<xsl:choose>
											<xsl:when test= "(DTE/Documento/Referencia/TpoDocRef = '34') or (DTE/Documento/Referencia/TpoDocRef = '41')">
												<fo:table-row>
													<fo:table-cell>
											...
											<xsl:otherwise>
												<fo:table-row>
													<fo:table-cell>
														<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">TOTAL NETO</fo:block>
													</fo:table-cell>
												</fo:table-row>
												<fo:table-row>
													<fo:table-cell>
														<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">IVA 19.0%</fo:block>
													</fo:table-cell>
												</fo:table-row>												
											</xsl:otherwise>
										</xsl:choose>
						...
						<fo:table-cell>
							<fo:block font-weight="bold" font-size="12px" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center" border="1px solid {$lineas}">
								...
								<fo:table table-layout="fixed" height="0.8cm">
									<fo:table-column column-width="2cm"/>
									<fo:table-body>
										<xsl:choose>										
											<xsl:when test= "(DTE/Documento/Referencia/TpoDocRef = '34') or (DTE/Documento/Referencia/TpoDocRef = '41')">
												<fo:table-row>
													<fo:table-cell>
														<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" padding-before="3mm" padding-after="1mm" text-align="right" margin-right="1mm">
															&#xA0;		<xsl:value-of select="format-number(DTE/Documento/Encabezado/Totales/MntExe, $miles, 'CL')"/>
														</fo:block>
													</fo:table-cell>
												</fo:table-row>
												<fo:table-row>
													<fo:table-cell>
														<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">
															&#xA0;
														</fo:block>
													</fo:table-cell>
												</fo:table-row>
											...
											<xsl:otherwise>
												<fo:table-row>
													<fo:table-cell>
														<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">
															<xsl:choose>
																<xsl:when test="not(DTE/Documento/Encabezado/Totales/MntNeto)">0</xsl:when>
                        										<xsl:otherwise>
                        											<xsl:value-of select="format-number(DTE/Documento/Encabezado/Totales/MntNeto, $miles, 'CL')"/>
                        										</xsl:otherwise>
															</xsl:choose>
														</fo:block>
													</fo:table-cell>
												...
												<fo:table-row>
													<fo:table-cell>
														<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" 	text-align="right" margin-right="1mm">
															<xsl:choose>
																<xsl:when test="not(DTE/Documento/Encabezado/Totales/IVA)">0</xsl:when>
                        										<xsl:otherwise>
																	<xsl:value-of select="format-number(DTE/Documento/Encabezado/Totales/IVA, $miles, 'CL')"/>
																</xsl:otherwise>
															</xsl:choose>
														</fo:block>
													</fo:table-cell>
										...
										<fo:table-row>
											<fo:table-cell>
												<fo:block font-family="Helvetica" font-weight="bold" font-size="7px" color="{$txt}" text-align="right" margin-right="1mm">
													<xsl:value-of select="format-number(DTE/Documento/Encabezado/Totales/MntTotal, $miles, 'CL')"/>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
									</fo:table-body>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="dte-T61.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
