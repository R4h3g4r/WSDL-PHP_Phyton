		...
		<fo:block>
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">Deuda Garantía </fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
				...
				<fo:table-body>
					...
					<xsl:for-each select="Info/Estados/Estado">
						<fo:table-row>
							...
							<xsl:call-template name="celda">
								<xsl:with-param name="texto" select="Deuda"/>
							</xsl:call-template>
							<xsl:call-template name="celda">
								<xsl:with-param name="texto" select="Garantias"/>
							</xsl:call-template>
							<xsl:call-template name="celda">
								<xsl:with-param name="texto" select="Superhabit"/>
							</xsl:call-template>
						</fo:table-row>
					</xsl:for-each>
				</fo:table-body>
