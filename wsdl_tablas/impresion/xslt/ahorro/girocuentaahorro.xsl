...
<xsl:param name="imglogo"/>
  ...
  <xsl:template match="GirarCuentaAhorro/GirarCuentaAhorroForm">
				  ...
				  <fo:external-graphic height="54pt" width="117pt" src="url( {$imglogo} )"/></fo:block>
				      ...
				      <fo:table-cell number-columns-spanned="3"><fo:block  color="#FFFFFF" font-size="36pt" font-family="Arial, Helvetica, sans-serif">.</fo:block></fo:table-cell>             
                                ...
                                <fo:table-row>
                                  ...
                                  <fo:table-cell background-color="#E7EAF0" height="18pt">
                                    <fo:block text-align="start">Comprobante de Giro en Cuenta de
                                      Ahorro </fo:block>
                                  </fo:table-cell>
                                            ...
                                            <fo:table text-align="left" table-layout="fixed">
                                              ...
                                              <fo:table-body>
                                                <fo:table-row>
                                                  ...
                                                  <fo:block>
						  <!--
                                                    <fo:inline font-size="6pt"> DEL  <xsl:value-of
                                                      select="dia"/> DE <xsl:value-of
                                                        select="mes"/> DE  <xsl:value-of select="anno"/>,  <xsl:value-of
                                                  select="hora"/> hrs </fo:inline>
						  -->
						   ...
						   <fo:inline font-size="6pt">
							<xsl:value-of select="fecha"/> 
                                        ...
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell>
                                            <fo:block font-size="8pt" space-after.optimum="1.5pt">
                                                <xsl:value-of select="format-number( rutCliente, '#.##0,#', 'euro')"/>-<xsl:value-of select="dvCliente"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell>
                                            <fo:block text-align="right"
                                              font-family="Arial, Helvetica, sans-serif"
                                              font-size="8pt">Número de Cuenta de Abono</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell>
                                            <fo:block text-align="center"
                                              font-family="Arial, Helvetica, sans-serif"
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell>
                                            <fo:block text-align="right"
                                              font-family="Arial, Helvetica, sans-serif"
                                              font-size="8pt">Monto del Giro</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell>
                                            <fo:block text-align="center"
                                              font-family="Arial, Helvetica, sans-serif"
                                          ...
                                          <fo:table-cell>
                                            <fo:block color="#FF0000" font-size="8pt"
                                              ...
                                              $<xsl:value-of select="format-number( montoGiro, '#.##0,#', 'euro')"/>
                                             </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          <fo:table-cell>
                                            <fo:block text-align="right"
                                              font-family="Arial, Helvetica, sans-serif"
                                              font-size="8pt">Número de giros realizados</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell>
                                            <fo:block text-align="center"
                                              font-family="Arial, Helvetica, sans-serif"
                                          ...
                                          <fo:table-cell>
                                            <fo:block color="#FF0000" font-size="8pt"
                                              ...
                                              <xsl:value-of select="format-number( giroMasUno, '#.##0,#', 'euro')"/>
                                              de 
                                              <xsl:value-of select="format-number( numeroPermitidoDeGiros, '#.##0,#', 'euro')"/>
