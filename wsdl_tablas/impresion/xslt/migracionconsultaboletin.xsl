...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="contenido">
		...
		<fo:block font-size="9pt" text-align="left" color="{$txt}">
			...
			<fo:inline font-weight="normal" space-before="30pt"><xsl:value-of select="info/subTipoBusqueda"/>: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="info/subTipoBusquedaValor"/>&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;</fo:inline>
				...
				<fo:table-body>
					...
					<xsl:when test="count(info/listado-protestos/protesto) > 0">
						...
						<fo:table-row>
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="indiceBoletin"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
