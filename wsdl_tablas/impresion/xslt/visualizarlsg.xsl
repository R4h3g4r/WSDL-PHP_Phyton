		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:for-each select="info/listado-lsg/listado-visualizarlsg">
						<fo:table-row text-align="right">
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" color="{$txt-azul-claro}" text-align="center">
									&#0160;<xsl:value-of select="nroCuenta"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" color="{$txt-azul-claro}" text-align="center">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" color="{$txt-azul-claro}" text-align="center">
									&#0160;<xsl:value-of select="fecVencimiento"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</xsl:for-each>
