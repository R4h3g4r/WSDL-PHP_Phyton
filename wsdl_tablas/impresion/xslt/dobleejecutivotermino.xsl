					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								Término de Contrato Doble Ejecutivo
							</fo:block>
							<!-- titulo -->
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/cuentaCorriente"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Valor Servicio M($) :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/valorServicio"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Motivo Finzalización Contrato :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/motivo"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
