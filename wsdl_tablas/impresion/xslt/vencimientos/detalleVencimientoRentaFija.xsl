			...
			<fo:table-body>
				...
				<fo:table-row background-color="{$bgcolor}">								
					<fo:table-cell padding-before="1mm" padding-left="2mm">
						<fo:block>
							<fo:inline font-size="10pt" font-weight="bold" text-align="center" color="{$txt}">Detalle Renta Fija</fo:inline>
						</fo:block>
					</fo:table-cell>
	...
	<xsl:template name="tablaResumen">
		...
		<fo:table table-layout="fixed">
			...
			<fo:table-body border="0.2pt solid {$bgcolor}">
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total Renta Fija en $: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total Renta Fija en UF: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total Renta Fija en USD: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total General Renta Fija en $: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
		...
		<fo:block font-size="8pt" text-align="left" font-weight="normal" background-color="{$bgcomentario}" space-before="5mm">
			(*) Para los instrumentos con tabla de desarrollo se despliega el o los cupones con vencimiento dentro del</fo:block>
			<fo:block font-size="8pt" text-align="left" font-weight="normal" background-color="{$bgcomentario}">
			período consultado.
			</fo:block>
			<fo:block font-size="8pt" text-align="left" font-weight="normal" background-color="{$bgcomentario}">
			Los montos desplegados en "Monto al Vcto en Pesos" se encuentran expresados con la paridad monetaria del día
			</fo:block>
			<fo:block font-size="8pt" text-align="left" font-weight="normal" background-color="{$bgcomentario}">
