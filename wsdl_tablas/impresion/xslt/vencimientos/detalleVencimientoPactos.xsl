			...
			<fo:table-body>
				...
				<fo:table-row background-color="{$bgcolor}">								
					<fo:table-cell padding-before="1mm" padding-left="2mm">
						<fo:block>
							<fo:inline font-size="10pt" font-weight="bold" text-align="center" color="{$txt}">Detalle Pactos</fo:inline>
						</fo:block>
					</fo:table-cell>
	...
	<xsl:template name="tablaResumen">
		...
		<fo:table table-layout="fixed">
			...
			<fo:table-body border="0.2pt solid {$bgcolor}">
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total Pactos en $: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total Pactos en UF: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total Pactos en USD: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block font-size="8pt" text-align="right" font-weight="bold">Total General Pactos en $: </fo:block>
					</fo:table-cell>
					<fo:table-cell>
		...
		<fo:block font-size="8pt" text-align="left" font-weight="normal" background-color="{$bgcomentario}" space-before="5mm">
			Los montos desplegados en "Monto al Vcto en Pesos" se encuentra expresados con la paridad
			monetaria del día</fo:block>
