...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src">
												<xsl:value-of select="perfiles-provision/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
										<xsl:value-of select="perfiles-provision/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
	...
	<xsl:template name="contenido">
		...
		<fo:block font-size="9pt" text-align="left" color="{$txt}">
			...
			<fo:inline font-weight="bold"><xsl:value-of select="perfiles-provision/ejecutivo"/>&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;</fo:inline>
			<fo:inline font-weight="normal" space-before="30pt">Oficina: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="perfiles-provision/oficina"/></fo:inline>
		</fo:block>
		<!-- ejecutivo -->
		...
		<fo:block font-size="8pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<xsl:choose>
					<xsl:when test="count(perfiles-provision/perfilesProvision) > 0">
						<xsl:for-each select="perfiles-provision/perfilesProvision/listado-perfiles-provision">
