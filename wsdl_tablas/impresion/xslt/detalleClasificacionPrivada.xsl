		...
		<fo:block>
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">Detalle Clasificación Privada</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
				...
				<fo:table-body>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									<xsl:value-of select="info/clasificacion"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'Clasificador:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									<xsl:value-of select="info/clasificador"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'Fecha de Última Modificación:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'Usuario Última Modificación:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
