                            ...
                            <fo:table-body>
                                <fo:table-row height="4mm">
                                      ...
                                      <fo:table-cell border-right="0.5pt solid black" border-top="0.5pt solid black" border-bottom="0.5pt solid black">
                                          <fo:block text-align="right" font-weight="bold" font-size="10pt">Nº <xsl:value-of select="numeroCobranzaJudicial" /></fo:block>
                                      </fo:table-cell>
                                </fo:table-row>
                          </fo:table-body>
           </fo:table>
              ...
              <fo:table table-layout="fixed" width="190.9mm">
                ...
                <fo:table-body>
                  ...
                  <fo:table-row height="4mm">
                    <fo:table-cell  border="0.5pt solid black" padding-left="1mm">
                      <fo:block text-align="left" font-weight="bold">
                        Detalle de la operación Número: <xsl:value-of select="detalledelaOperacionNumero" />
                      </fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                  ...
                  <fo:table-row height="4mm">
                      <fo:table-cell  border="0.5pt solid black" padding-left="1mm">
                        <fo:block text-align="left" font-weight="bold">
                          Número Original: <xsl:value-of select="operacionCol" />
                        </fo:block>
                      </fo:table-cell>
                  </fo:table-row>
                  ...
                  <fo:table-row>
                     <fo:table-cell border="0.5pt solid black" padding-right="1mm">
                       <fo:block text-align="right" font-weight="bold">
                         Total Número Documentos: <xsl:value-of select="documentacionAdjunta/numeroDocumentos" />
                       </fo:block>
                     </fo:table-cell>
                  </fo:table-row>
                  </xsl:if>
                  ...
                  <fo:table table-layout="fixed" width="190.9mm">
                    ...
                    <fo:table-body>
                      ...
                      <fo:table-row height="4mm">
                        <fo:table-cell  border="0.5pt solid black" padding-left="1mm">
                          <fo:block text-align="left" font-weight="bold">
                            Detalle de la Garantía Número: <xsl:value-of select="numero" />
                          </fo:block>
                        </fo:table-cell>
                      </fo:table-row>
                      ...
                      <fo:table-row height="4mm">
                        <fo:table-cell  border="0.5pt solid black" padding-left="1mm">
                          <fo:block text-align="left" font-weight="bold">
                            Datos Legales Garantía (Acreedor Preferencial Prioridad)
                          </fo:block>
                        </fo:table-cell>
                      </fo:table-row>
                                   ...
                                   <fo:table table-layout="fixed" width="190.9mm">
                                     ...
                                     <fo:table-body>
                                       ...
                                       <fo:table-row>
                                         ...
                                         <fo:table-cell border="0.5pt solid black" padding-left="1mm">
                                           <fo:block text-align="left">
                                             Fecha Recepción Abogado: <xsl:value-of select="fechaHoy" />
                                           </fo:block>
                                         </fo:table-cell>
                                       </fo:table-row>
