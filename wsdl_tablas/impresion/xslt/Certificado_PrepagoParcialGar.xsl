...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
   ...
   <!-- <xsl:param name="IMG_URL"/> -->
    ...
    <xsl:template match="Certificado_PrepagoParcialGar">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="miCarta" font-size="9pt" font-family="Helvetica" initial-page-number="1">
...
<fo:block>
<fo:inline color="rgb(0,0,128)" font-size="22pt">
...
<fo:table-row>  
    <fo:table-cell>
    <fo:block> </fo:block>
        <fo:block text-align="center" font-size="18pt">&#x00A0;CERTIFICADO PARA LIQUIDACIÓN DE CRÉDITO</fo:block>
    </fo:table-cell>
</fo:table-row>
</fo:table-body>
</fo:table>
  ...
  <fo:block color="rgb(0,0,128)" text-align="center" margin-bottom="10pt" font-size="14pt" font-family="Helvetica"> <fo:block/><fo:block/> </fo:block>
      <fo:block>
        <fo:table>
          ...
          <fo:table-body>
                                             ...
                                             <fo:block>
                                                  ...
                                                  <fo:block text-align="left" color="rgb(0,0,0)">
                                                                ...
                                                                <fo:block color="rgb(0,0,0)">
                                                                  ...
                                                                  <fo:block color="rgb(0,0,0)">
                                                                    <fo:inline font-weight="bold">Monto Prepago</fo:inline>
                                                                      <fo:inline><xsl:value-of select="montoPrepago"/></fo:inline>
                                                                  </fo:block>  
                                                                </fo:block>
                                                            </fo:table-cell>
                                                            <fo:table-cell text-align="left" border-left-style="none" border-left-width="1pt" border-left-color="rgb(0,0,0)" border-right-style="none" border-right-width="1pt" border-right-color="rgb(0,0,0)" border-top-style="none" border-top-width="1pt" border-top-color="rgb(0,0,0)" border-bottom-style="none" border-bottom-width="1pt" border-bottom-color="rgb(0,0,0)" padding-top="2pt" padding-left="2pt" padding-right="2pt" padding-bottom="2pt">
                                                                ...
                                                                <fo:block color="rgb(0,0,0)">
								   <fo:inline font-weight="bold">Nuevo Valor Cuota referencial:</fo:inline>                                                                 
								   <fo:inline><xsl:value-of select="valorCuota"/></fo:inline>                                                                 
                                                                </fo:block>  
                                                            </fo:table-cell>
                                                        </fo:table-row>
                                                    </fo:table-body>
                            ...
                            <fo:table-body>
                              <fo:table-row display-align="auto">
                                <fo:table-cell text-align="start">
                                  <fo:block>
                                    <fo:table>
                                      <fo:table-column column-width="11%" column-number="1"/>
                                      <fo:table-column column-width="11%" column-number="2"/>
                                      <fo:table-column column-width="11%" column-number="3"/>
                                      <fo:table-column column-width="11%" column-number="4"/>
                                      <fo:table-column column-width="11%" column-number="5"/>
                                      <fo:table-column column-width="11%" column-number="6"/>
                                      <fo:table-column column-width="11%" column-number="7"/>
                                      <fo:table-column column-width="11%" column-number="8"/>
                                      <fo:table-column column-width="11%" column-number="9"/>
                                      <fo:table-header>
                                    ...
                                    <xsl:for-each select="detallePrepagos/element">     
                                      <fo:table-body>
                                        <fo:table-row border-top-style="solid" border-top-width="2px" border-top-color="rgb(255,255,255)" font-size="6pt" font-weight="normal" background-color="rgb(233,233,234)">
                                          ...
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
					      <fo:block>                                        
					        <fo:inline>$&#x00A0;<xsl:value-of select="capitalAdeudado"/></fo:inline>                                         
					      </fo:block>                                        
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
            ...
            <fo:table-row>
               <fo:table-cell>
                  <fo:block text-align="left" color="rgb(0,0,0)">
		    <fo:inline font-weight="bold">Tipo Garantía:</fo:inline>
		    <fo:inline><xsl:value-of select="tipoGarantia"/></fo:inline>
                  </fo:block>
                  <fo:block color="rgb(0,0,0)">
                  <fo:table>
		     ...
		     <fo:table-column column-width="10%" column-number="5"/>                                     
		     <fo:table-column column-width="10%" column-number="6"/>                                     
		     <fo:table-column column-width="10%" column-number="7"/>                                     
		     <fo:table-column column-width="10%" column-number="8"/> 
		     <fo:table-column column-width="10%" column-number="9"/> 
		     <fo:table-column column-width="10%" column-number="10"/> 
		     <fo:table-body>
                       <fo:table-row>
                          <fo:table-cell>
			     <fo:block  font-weight="bold" >                          
			        ...
			        <fo:block font-weight="bold"  text-align="right"  >
			          Año:
                          ...
                          <fo:table-cell  >
			       <fo:block text-align="center"  border-bottom-style="solid" border-bottom-width="1px" >
			         <xsl:value-of select="insGarAnio"/>&#x00A0;
			      </fo:block>     
		         </fo:table-cell>   
		         <fo:table-cell>
			     <fo:block font-weight="bold"  text-align="right" >                   
			...
			<fo:table-cell >
			  <fo:block text-align="center"  border-bottom-style="solid" border-bottom-width="1px" >
			       <xsl:value-of select="insGarFoja"/>&#x00A0;
			  </fo:block>     
			</fo:table-cell> 
			<fo:table-cell>	
		      ...
		      <fo:table-cell>	
		        ...
		        <fo:table-cell   >          
		      		 <fo:block  text-align="center" border-bottom-style="solid" border-bottom-width="1px" >	
		      		         <xsl:value-of select="insProAnio"/>&#x00A0;	
		      		</fo:block>     	
		      	      </fo:table-cell>   	   
		      	      <fo:table-cell>	   
		      		     <fo:block font-weight="bold"  text-align="right"  >                 	  
		      		...
		      		<fo:table-cell   >	
		      		  <fo:block text-align="center"  border-bottom-style="solid" border-bottom-width="1px"  >	
		      		       <xsl:value-of select="insProFoja"/>&#x00A0;	
		      		  </fo:block>     	
		      		</fo:table-cell>   
		      		<fo:table-cell>	
					<fo:block text-align="center" >	
				...
				<fo:block text-align="center" >	
                  ...
                  <fo:block text-align="left" color="rgb(0,0,0)">
		     <fo:inline font-weight="bold">Total Deuda Bci</fo:inline>
		     <fo:inline><xsl:value-of select="totalDeuda"/></fo:inline>
                  </fo:block>
                  <fo:block text-align="left" color="rgb(0,0,0)">
		     <fo:inline font-weight="bold">&#x00A0;</fo:inline>    
                 </fo:block>
                 ...
                 <fo:block text-align="right" color="rgb(0,0,0)" space-after="1mm">
                     <fo:inline font-weight="bold">VB Jefe de Oficina _______________________    </fo:inline>    
                 </fo:block>                   
               </fo:table-cell>
            </fo:table-row>
          </fo:table-body>
