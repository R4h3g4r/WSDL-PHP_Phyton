...
<fo:table-column column-width="9.15cm"/>
		<fo:table-body>
				<fo:table-row>
				<fo:table-cell number-columns-spanned="2"><fo:block line-height="12pt" font-size="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">Comprobante de Avance Efectivo en Cuotas en Curso</fo:block></fo:table-cell>
				</fo:table-row>
		</fo:table-body>
</fo:table>
...
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always"><xsl:value-of select="ProtestosPorCuenta/oficinaReceptora"/></fo:block></fo:table-cell></fo:table-row>
<fo:table-row>
