...
<fo:table-column column-width="8.15cm"/>
<fo:table-body>
<fo:table-row><fo:table-cell number-columns-spanned="2"><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end"><fo:inline white-space-collapse="false"> </fo:inline><fo:external-graphic text-aling="end"><xsl:attribute name="src" >url(<xsl:value-of select="$rutaImg"/>)</xsl:attribute></fo:external-graphic> </fo:block></fo:table-cell></fo:table-row>
<fo:table-row><fo:table-cell number-columns-spanned="2"><fo:block line-height="12pt" font-size="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">Comprobante de Avance Efectivo en Cuotas</fo:block></fo:table-cell></fo:table-row>
...
<fo:table-body>
<fo:table-row><fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Cliente : </fo:block></fo:table-cell>
...
<fo:table-row>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Usuario de Tarjeta de Crédito : </fo:block></fo:table-cell>
...
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always"><xsl:value-of select="ProtestosPorCuenta/oficinaReceptora"/></fo:block></fo:table-cell><fo:table-cell number-rows-spanned="7"><fo:external-graphic text-aling="end"><xsl:attribute name="src" >url(<xsl:value-of select="$rutaImg2"/>)</xsl:attribute></fo:external-graphic> </fo:table-cell>
</fo:table-row>
<fo:table-row>
...
<fo:table-row>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Monto de Efectivo en Cuotas : </fo:block></fo:table-cell>
...
<fo:table-row>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Nº de Cuotas : </fo:block></fo:table-cell>
...
<fo:table-row>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Comisión : </fo:block></fo:table-cell>
...
<xsl:if test="ProtestosPorCuenta/cargaAnualEquivalente != ''">
<fo:table-row>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Carga Anual Equivalente : </fo:block></fo:table-cell>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always"><xsl:value-of select="ProtestosPorCuenta/cargaAnualEquivalente"/>%</fo:block></fo:table-cell>
</fo:table-row>
</xsl:if>
<xsl:if test="ProtestosPorCuenta/costoTotalCredito != ''">
<fo:table-row>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="end">Costo Total del Crédito : </fo:block></fo:table-cell>
<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">$<xsl:value-of select="ProtestosPorCuenta/costoTotalCredito"/></fo:block></fo:table-cell>
</fo:table-row>
</xsl:if>
</fo:table-body>
</fo:table>
