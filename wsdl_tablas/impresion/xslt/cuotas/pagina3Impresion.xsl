...
<fo:flow flow-name="xsl-region-body"><fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always"><fo:inline font-size="10pt"></fo:inline>
...
<fo:table text-align="left" table-layout="fixed">
	...
	<fo:table-column column-width="8.15cm"/>
			<fo:table-body>
						<fo:table-row>
						<fo:table-cell number-columns-spanned="2" ><fo:block line-height="12pt" font-size="14pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">Comprobante de Avance Efectivo en Cuotas</fo:block></fo:table-cell>
						</fo:table-row>
						<fo:table-row>
...
<fo:table text-align="left" border-top-style="double" table-layout="double" border-bottom-style="double" border-left-style="double" border-right-style="double">
			...
			<fo:table-column column-width="2cm"/>
				<fo:table-body>
						...
						<fo:table-cell><fo:block line-height="12pt" font-size="10pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always"><xsl:value-of select="ProtestosPorCuenta/indEnvioBoletin"/></fo:block></fo:table-cell><fo:table-cell number-rows-spanned="9" text-aling="end"><fo:external-graphic text-aling="end"><xsl:attribute name="src" >url(<xsl:value-of select="$rutaImg2"/>)</xsl:attribute></fo:external-graphic> </fo:table-cell>
						</fo:table-row>
						<fo:table-row>
