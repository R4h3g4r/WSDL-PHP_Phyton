...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								Obtener Probabilidad de Incumplimiento (PI)
							</fo:block>
							<!-- titulo -->
						</fo:table-cell>
					</fo:table-row>
	...
	<xsl:template name="datos_1">
		<fo:block>
			<xsl:call-template name="subTitulo">
				<xsl:with-param name="titulo" select="'Datos Generales  '"/>
			</xsl:call-template>
		<fo:block space-after="2mm">
		</fo:block>
		...
		<fo:table table-layout="fixed">
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/fecBalance"/>&#0160;
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/numBalance"/>&#0160;
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/tipBalance"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/numMeses"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Código Ejecutivo :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/codEjc"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Estado Balance :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/estadoBal"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
	...
	<xsl:template name="datos_2">
		<fo:block>
		<xsl:call-template name="subTitulo">
				<xsl:with-param name="titulo" select="'Datos del Balance '"/>
		</xsl:call-template>
		<fo:block space-after="2mm">
		</fo:block>
			<fo:table table-layout="fixed">
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- BANCA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Año del Balance :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/anoBalance"/>&#0160;
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- SEGMENTO -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Caja - DAP - Valores Negociables :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/cajaBanco"/>&#0160;
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/existencias"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/totalActCir"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/totalAct"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Total Activos Año Anterior :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/totActAnoAnt"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/totPasCirc"/>&#0160;
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- SEGMENTO -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Total Pasivos Corto y Largo Plazo :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/totPasCPyLP"/>&#0160;
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/utilReten"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Ventas :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/ventas"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Ventas Año Anterior :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/vtnAnoAnt"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Costos de Explotación :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/costoExplota"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- SEGMENTO -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'EBIT :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/estadoBIT"/>&#0160;
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/gastFinan"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/utilPerdEjer"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Utilidad Pérdida del Ejercicio Año Anterior :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="right" color="{$txt-azul-claro}">
							<xsl:value-of select="info/utilPerdAnt"/>&#0160;
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
