                                            ...
                                            <fo:table-row>
                                                <fo:table-cell>
                                                    <fo:block font-weight="bold" font-size="9pt" font-family="Arial, Helvetica, sans-serif" space-before="2mm" text-align="center" border-bottom-style="solid" border-bottom-width="1px">
                                                        Hoja Resumen Crédito de Consumo
                                                    </fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>                                    
                                        </fo:table-body>
                                                        ...
                                                        <fo:table font-family="Arial, Helvetica, sans-serif" table-layout="fixed" width="100%" border-collapse="collapse">                                                                    
                                                            ...
                                                            <fo:table-body>
                                                                ...
                                                                <fo:table-row font-size="9pt">
                                                                    ...
                                                                    <fo:table-cell>  
                                                                        <fo:block text-align="left">
                                                                            El Crédito de Consumo de que da cuenta esta Hoja Resumen, requiere del Consumidor contratante 
                                                                ...
                                                                <fo:table-row font-size="9pt">
                                                                    <fo:table-cell>
                                                                        ...
                                                                        <fo:block text-align="left" padding-top="5mm">
                                                                            ...
                                                                            cobrar si han transcurrido veinte días corridos  desde el atraso, según lo dispuesto en el artículo 37 de la 
                                                                            Ley de Protección del Consumidor. En caso de estar en presencia de una operación de crédito de dinero cuyo 
                                                                            capital sea igual o inferior a doscientas unidades de fomento no podrá en caso alguno hacerse exigible la 
                                                                            obligación en forma anticipada, sino una vez cumplidos sesenta días corridos desde que el deudor incurra en 
