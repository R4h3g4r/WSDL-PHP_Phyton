        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="basicPSM">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block padding-top="15pt" text-align="right" font-family="sans-serif"
                    ...
                    <fo:block padding-top="8pt" padding-bottom="20pt">
                        <fo:table>
                                ...
                                <xsl:for-each select="documentos/documento">
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell padding-top="10pt">
                                            <fo:block border-right-width="0.5pt" text-align="center"
                                                vertical-align="middle" font-size="10pt">
                                                <xsl:value-of select="bolN" />
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell padding-top="10pt">
                                            <fo:block text-align="center" vertical-align="middle"
                                                font-size="10pt">
                                                <xsl:value-of select="pagN" />
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell padding-top="10pt">
                                            <fo:block text-align="center" vertical-align="middle"
                    ...
                    <fo:block text-align="justify" padding-top="50pt"> Saluda Atte. a Ud., </fo:block>
                    <fo:block font-weight="bold"> Banco de Crédito e Inversiones </fo:block>
                    <xsl:if test="urlFirma">
                        <fo:block text-align="right">
                            <fo:external-graphic width="170px" height="144px" scaling="uniform">
