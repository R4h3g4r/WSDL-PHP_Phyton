				...
				<fo:flow flow-name="xsl-region-body">
					...
					<xsl:if test="LineaSobreGiro">
						<fo:table border-collapse="collapse" table-layout="fixed"  padding-top="20pt">
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell><fo:block text-align="rigth" font-size="10pt" margin-left="5pt" font-weight="bold">Linea de Sobregiro</fo:block></fo:table-cell>
								</fo:table-row>
							</fo:table-body>
						</fo:table>
							...
							<fo:table-body>
								...
								<xsl:for-each select="LineaSobreGiro/linea">
									<fo:table-row>
										...
										<fo:table-cell>
											<fo:block text-align="right" font-size="9pt" margin-right="5pt"><xsl:value-of select="interes" /></fo:block>
										</fo:table-cell>
									</fo:table-row>
								</xsl:for-each>
							</fo:table-body>
					...
					<xsl:if test="SaldoVisa">
						<fo:table border-collapse="collapse" table-layout="fixed" padding-top="20pt">
					    		...
					    		<fo:table-body>
					    			<fo:table-row>
					    				<fo:table-cell><fo:block text-align="rigth" font-size="10pt" margin-left="5pt" font-weight="bold">Tarjeta de Crédito Nacional</fo:block></fo:table-cell>
					    			</fo:table-row>
					    		</fo:table-body>
					    	</fo:table>
						<fo:table border-collapse="collapse" table-layout="fixed"  padding-top="3pt">
					...
					<xsl:if test="LineaSobreGiroNova">
						<fo:table border-collapse="collapse" table-layout="fixed" padding-top="20pt">
					    		...
					    		<fo:table-body>
					    			<fo:table-row>
					    				<fo:table-cell><fo:block text-align="rigth" font-size="10pt" margin-left="5pt" font-weight="bold">Línea de Sobregiro Nova</fo:block></fo:table-cell>
					    			</fo:table-row>
					    		</fo:table-body>
					    	</fo:table>
						<fo:table border-collapse="collapse" table-layout="fixed"  padding-top="3pt">
					...
					<xsl:if test="TarjetaCreditoNova">
						<fo:table border-collapse="collapse" table-layout="fixed" padding-top="20pt">
					    		...
					    		<fo:table-body>
					    			<fo:table-row>
					    				<fo:table-cell><fo:block text-align="rigth" font-size="10pt" margin-left="5pt" font-weight="bold">Tarjeta de Crédito Nova</fo:block></fo:table-cell>
					    			</fo:table-row>
					    		</fo:table-body>
					    	</fo:table>
						<fo:table border-collapse="collapse" table-layout="fixed"  padding-top="3pt">
					...
					<xsl:if test="DetalleCredito">
						<fo:table border-collapse="collapse" table-layout="fixed" padding-top="20pt">
					    		...
					    		<fo:table-body>
					    			<fo:table-row>
					    				<fo:table-cell><fo:block text-align="rigth" font-size="10pt" margin-left="5pt" font-weight="bold">Créditos Vigentes</fo:block></fo:table-cell>
					    			</fo:table-row>
					    		</fo:table-body>
					    	</fo:table>
						<fo:table border-collapse="collapse" table-layout="fixed"  padding-top="3pt">
					...
					<xsl:if test="DetalleHipotecario">
						<fo:table border-collapse="collapse" table-layout="fixed" padding-top="20pt">
					    		...
					    		<fo:table-body>
					    			<fo:table-row>
					    				<fo:table-cell><fo:block text-align="rigth" font-size="10pt" margin-left="5pt" font-weight="bold">Créditos Hipotecarios</fo:block></fo:table-cell>
					    			</fo:table-row>
					    		</fo:table-body>
					    	</fo:table>
						<fo:table border-collapse="collapse" table-layout="fixed"  padding-top="3pt">
					    		...
					    		<fo:table-body>
					    			...
					    			<xsl:for-each select="DetalleHipotecario/credito">
					    				<fo:table-row>
					    					...
					    					<fo:table-cell>
					    						<fo:block text-align="right" font-size="9pt" margin-right="5pt">U.F.<xsl:value-of select="monto_credito" />	</fo:block>
					    					</fo:table-cell>
					    					<fo:table-cell>
					    						<fo:block text-align="right" font-size="9pt" margin-right="5pt">U.F. <xsl:value-of select="saldo_insoluto" /></fo:block>
					    					</fo:table-cell>
					    				</fo:table-row>
					    			</xsl:for-each>
					    		</fo:table-body>
					...
					<fo:block padding-left="3pt" text-align="left"  font-family="sans-serif" font-size="11pt" > <fo:inline font-weight="bold">Valores al  <xsl:value-of select='fecha_actual'/></fo:inline> </fo:block>    	
					...
					<fo:block font-weight="bold"  padding-top="20pt"> Banco Crédito e Inversiones </fo:block>
