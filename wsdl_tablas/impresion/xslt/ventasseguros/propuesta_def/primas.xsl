					...
					<fo:table-row keep-with-next="always">
						<fo:table-cell  border-style="solid" border-width="1.0pt" border-color="#000000" display-align="center" background-color="{$varTablaTituloColor}" padding-left="5pt">
							<fo:block font-weight="bold" color="{$varTablaTituloTextColor}" font-size="12pt">
								PRIMAS <xsl:value-of select="universo/plan/periodicidad"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell  border-style="solid" border-width="1.0pt" border-color="#000000">
							<fo:block>
								...
								<fo:table table-layout="fixed" width="{$varTablaAncho}">
									...
									<xsl:if test="universo/plan/inversion='true'">
										<fo:table-column column-width="proportional-column-width(35)"/>
									</xsl:if>
									<xsl:if test="universo/plan/inversion='false'">
									...
									<fo:table-body>
										...
										<fo:table-row background-color="{$varTablaColumnaLabelColor}" keep-with-next="always">
											<fo:table-cell padding-left="5pt">
												<fo:block>
													<xsl:value-of select="universo/plan/nombreplan"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding-left="5pt">
												<fo:block>
													<xsl:value-of select="universo/plan/descripcion"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell text-align="center">
												<fo:block>
													<xsl:value-of select="universo/plan/exenta"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell text-align="center">
												<fo:block>
													<xsl:value-of select="universo/plan/afecta"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell text-align="center">
												<fo:block>
													<xsl:value-of select="universo/plan/iva"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell text-align="center">
												<fo:block>
													<xsl:value-of select="universo/plan/bruta"/>
												</fo:block>
											</fo:table-cell>
											<xsl:if test="universo/plan/inversion='true'">
												<fo:table-cell text-align="center">
													<fo:block>
														<xsl:value-of select="universo/plan/primaminima"/>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell text-align="center">
													<fo:block>
														<xsl:value-of select="universo/plan/primaexceso"/>
													</fo:block>
												</fo:table-cell>
											</xsl:if>
											<fo:table-cell text-align="center">
												<fo:block>
													<xsl:value-of select="universo/plan/moneda"/>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
									</fo:table-body>
