			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell border-style="solid" border-width="1.0pt" border-color="#000000" color="#006666">
						<fo:block padding-before="0pt" font-size="11.0pt"> "El valor de la prima anual para esta póliza es de UF 1.21 + IVA. Sin perjuicio de ello la Compañía otorga una  </fo:block>
						...
						<fo:block padding-before="0pt" font-size="11.0pt"> pago de las 3 primeras cuotas de la prima. " </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> En las futuras renovaciones se cobrarán 12 cuotas de UF 0,12, equivalentes a una prima anual de UF 1,21 +  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> IVA, a menos que la Compañía defina cambio de condiciones, en cuyo caso se avisará al asegurado por escrito  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> con 30 días de anticipación." </fo:block>
						...
						<fo:block padding-before="0pt" font-size="11.0pt">  ocurridas desde la primera transacción ilícita hasta la publicación en el boletín respectivo y en ningún caso se  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> indemnizarán transacciones efectuadas luego de 60 días desde la primera transacción ilícita o desde la fecha  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> de cargo en el estado de cuenta de dicha transacción. </fo:block>
						...
						<fo:block padding-before="0pt" font-size="11.0pt"> efectúen en el periodo de 72 horas previas a la comunicación al banco. LIMITE DE INDEMNIZACIÓN: UF 170  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> en el agregado anual como límite para las coberturas: Uso fraudulento, clonación y Asalto en Cajero.  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> Nro. MAXIMO DE EVENTOS: 5 anuales. </fo:block>
						...
						<fo:block padding-before="0pt" font-size="11.0pt"> 4.- ASALTO EN CAJERO: Cobertura de utilización forzada por terceros de tarjeta bancarias o comerciales (POL  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> 1 05 003 Sección C). Indemnización de la pérdida del dinero retirado del cajero automático a consecuencia de  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> un robo, asalto o secuestro hasta UF 11,80 por evento y un límite agregado anual de UF 170 para las  </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> coberturas Uso fraudulento, clonación y Asalto en Cajero. La cobertura ampara hasta 1 hora después de </fo:block>
						<fo:block padding-before="0pt" font-size="11.0pt"> realizada la  transacción en el cajero. En el caso de secuestro, sólo se ampara si es  una  persona  con quien el </fo:block> 
						<fo:block padding-before="0pt" font-size="11.0pt"> asegurado no tenga una relación dentro del cuarto grado de consanguinidad y primero de afinidad y que obligue  </fo:block>
	...
	<xsl:template name="temp_datosCondiciones2">
		<fo:block span="none">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell border-style="solid" border-width="1.0pt" border-color="#000000" color="#006666">
					<fo:block padding-before="0pt" font-size="11.0pt"> al asegurado a realizar una transacción. El secuestro debe involucrar el uso de un  arma  peligrosa o la   </fo:block>
					...
					<fo:block padding-before="0pt" font-size="11.0pt"> Carabineros debe presentarse dentro de las  2 horas posteriores al hecho y el reclamo se debe presentar a más tardar </fo:block>
					<fo:block padding-before="0pt" font-size="11.0pt"> dentro de las 72 horas siguientes a la ocurrencia del hecho. </fo:block>
					<fo:block padding-before="0pt" font-size="11.0pt"> Cláusula de uso general año 2000 (CUG 1 98 031) y Cláusula de uso general de exclusión datos electrónicos  </fo:block>
					<fo:block padding-before="0pt" font-size="11.0pt"> (CUG 1 02 074). </fo:block>
					...
					<fo:block padding-before="0pt" font-size="11.0pt"> no requieran de  la presencia del asegurado y teniendo en nuestro poder autorización notarial para realizar estos </fo:block>
					<fo:block padding-before="0pt" font-size="11.0pt"> trámites:   Límite de 2 eventos por año. </fo:block>
		...
		<fo:block span="none">
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:block padding-before="0pt" font-size="11.0pt"> ?Como la emisión de la presente propuesta, no se obtiene cobertura alguna al riesgo que se procura asegurar.  </fo:block>
					<fo:block padding-before="0pt" font-size="11.0pt"> La cobertura comenzará a regir únicamente a partir del momento en que esta propuesta sea aceptada por el  </fo:block>
					<fo:block padding-before="0pt" font-size="11.0pt"> asegurador y se inicie la vigencia de la póliza.?(Circular Mº1.390 S.V.S.). </fo:block>
