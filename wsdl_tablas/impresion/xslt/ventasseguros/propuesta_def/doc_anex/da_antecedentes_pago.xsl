...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:template name="temp_da_antecedentes_pago">
			...
			<fo:block padding-before="{$varEspacioExtreSecciones}">
				<fo:table table-layout="fixed" width="{$varTablaAncho}">
					...
					<fo:table-body>
						...
						<xsl:for-each select="primerpago">
							<fo:table-row>
								<fo:table-cell border-style="solid" border-width="1.0pt" border-color="#000000" display-align="center" background-color="{$varTablaTituloColor}" padding-left="5pt">
									<fo:block font-weight="bold" color="{$varTablaTituloTextColor}" font-size="12pt">
									...
									<fo:table table-layout="fixed" width="{$varTablaAncho}">
										...
										<fo:table-body>
											...
											<fo:table-row keep-with-next="always">
												...
												<fo:table-cell padding-left="5pt">
													<fo:block>
														<xsl:value-of disable-output-escaping="no" select="valor"/><xsl:text> </xsl:text><xsl:value-of disable-output-escaping="no" select="moneda"/>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding-left="5pt">
													<fo:block>
												...
												<fo:table-cell padding-left="5pt">
													<fo:block>
														<xsl:value-of disable-output-escaping="no" select="valorpesos"/>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
										</fo:table-body>
									...
									<fo:table table-layout="fixed" width="{$varTablaAncho}">
										...
										<fo:table-body>
											...
											<fo:table-row keep-with-next="always">
												...
												<fo:table-cell padding-left="5pt">
													<fo:block>
														<xsl:value-of disable-output-escaping="no" select="cantcuotasrestantes"/>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding-left="5pt">
													<fo:block>
												...
												<fo:table-cell padding-left="5pt">
													<fo:block>
														<xsl:value-of disable-output-escaping="no" select="valorcuota"/>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
										</fo:table-body>
