					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="12pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt}">
								...
								Rut <xsl:value-of select="transferencia/rutEmpresa"/>-<xsl:value-of select="transferencia/dvEmpresa"/>, ha efectuado la siguiente transferencia:
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="transferencia/numeroTransferencia"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="transferencia/detalles/detalle/nombreBeneficiario"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-right="{$espacio-texto-celda-left}">
							<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="right">
								&#0160;<xsl:value-of select="transferencia/detalles/detalle/rutBeneficiario"/>-<xsl:value-of select="transferencia/detalles/detalle/dvBeneficiario"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-right="{$espacio-texto-celda-left}">
							<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="right">
								&#0160;<xsl:value-of select="transferencia/detalles/detalle/cuentaDestino"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-right="{$espacio-texto-celda-left}">
							<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="right">
								&#0160;<xsl:value-of select="transferencia/detalles/detalle/bancoDestino"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-right="{$espacio-texto-celda-left}">
							<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="right">
								&#0160;<xsl:value-of select="transferencia/detalles/detalle/fechaTransferencia"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-right="{$espacio-texto-celda-left}">
							<xsl:call-template name="montoFormateado">
								<xsl:with-param name="montoaFormatear" select="transferencia/detalles/detalle/monto"/>
							</xsl:call-template>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
