...
<xsl:template match="DatosCotizacion">
	...
	<xsl:template name="temp_tituloDatosPrimas">
		<fo:block span="none" padding-before="6pt">
			...
			<xsl:if test="( planesGlobales/largoTotal = '5' )">
					...
					<fo:table-column column-width="proportional-column-width(18)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(18)" column-number="3" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(18)" column-number="4" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(18)" column-number="5" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" number-columns-spanned="4" column-number="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Primas Brutas Mensuales en UF</xsl:text>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row padding-before="0pt">
							...
							<fo:table-cell text-align="center" column-number="4" number-columns-spanned="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Sin Conducción Exclusiva</xsl:text>
								</fo:block>
							</fo:table-cell>
	...
	<xsl:template name="temp_datosPrimas">	
		<fo:block span="none" padding-before="6pt">
			...
			<xsl:if test="( planesGlobales/largoTotal = '5' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(40)" column-number="1" background-color="#FFFFFF"/>
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="0pt">
							...
							<xsl:for-each select="deducibles/deducible">
								<fo:table-cell text-align="center" display-align="center" font-weight="bold" border-after-style="solid" border-color="#DCDCDC" background-color="#FFFFFF" padding-before="4pt" padding-left="8pt">
									<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
										<xsl:value-of disable-output-escaping="no" select="valor"/><xsl:text> UF</xsl:text>
									</fo:block>
								</fo:table-cell>
							</xsl:for-each>
							<xsl:for-each select="deducibles/deducible">
			...
			<xsl:for-each select="textoPlanes/textoPlan">
				<xsl:for-each select="textos/texto">
					...
					<fo:block span="none" padding-before="6pt">
						...
						<fo:block text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
							<xsl:text>Para contratar este seguro contáctese al 600 62 62 777 o acérquese a su Ejecutivo</xsl:text>
						</fo:block>
					</fo:block>
					</xsl:if>
				</xsl:for-each>
...
-->	
		<xsl:template name="temp_firmas">
			<fo:table table-layout="fixed"  width="50%" padding-before="0pt">
