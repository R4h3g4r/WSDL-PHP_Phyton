...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
   ...
   <!-- <xsl:param name="IMG_URL"/> -->
    ...
    <xsl:template match="liquidacion_cancelacion">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="miCarta" page-height="11.000in" page-width="8.500in" margin-top="10.000px" margin-bottom="10.000px" margin-right="5.000px" margin-left="5.000px">
                   ...
                   <fo:block vertical-align="middle">
				             <fo:external-graphic  width="3cm"   height="1.5cm" vertical-align="middle">
               					<xsl:attribute name="src">
               					   <xsl:value-of select="LiquidacionCancelacion/logoTopBci"/>
               					</xsl:attribute>
              			 </fo:external-graphic>                                  
                   </fo:block>                                  
                </fo:table-cell>
...
<fo:table-row>
    ...
    <fo:block> </fo:block>
    <fo:block text-align="left" font-size="27pt">&#x00A0;&#x00A0;Resumen de Créditos</fo:block>
    </fo:table-cell>
</fo:table-row>
</fo:table-body>
</fo:table></fo:inline></fo:block>    
                                            
  <fo:block color="rgb(0,0,128)" text-align="center" margin-bottom="10pt" font-size="14pt" font-family="Helvetica"> <fo:block/>LIQUIDACION DE CANCELACION<fo:block/> </fo:block>
      <fo:block>
        <fo:table>
						                 ...
						                 <fo:table-cell text-align="left" border-left-style="none" border-left-width="1pt" border-left-color="rgb(0,0,0)" border-right-style="none" border-right-width="1pt" border-right-color="rgb(0,0,0)" border-top-style="none" border-top-width="1pt" border-top-color="rgb(0,0,0)" border-bottom-style="none" border-bottom-width="1pt" border-bottom-color="rgb(0,0,0)" padding-top="2pt" padding-left="2pt" padding-right="2pt" padding-bottom="2pt">
							                 ...
							                 <fo:block>
								                  ...
								                  <fo:block color="rgb(0,0,0)">
									                   <fo:inline font-weight="bold">CLIENTE:</fo:inline>
									                   <fo:inline><xsl:value-of select="LiquidacionCancelacion/nombreCliente"/></fo:inline>
								                  </fo:block>
																	<fo:block color="rgb(0,0,0)">
																		<fo:inline font-weight="bold">RUT:</fo:inline>
																		<fo:inline><xsl:value-of select="LiquidacionCancelacion/rutCliente"/></fo:inline>
																	</fo:block>
																	<fo:block color="rgb(0,0,0)">
																		<fo:inline font-weight="bold">EJ COMERCIAL:</fo:inline>
																		<fo:inline><xsl:value-of select="LiquidacionCancelacion/nombreEjecutivo"/></fo:inline>
																	</fo:block>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="left" border-left-style="none" border-left-width="1pt" border-left-color="rgb(0,0,0)" border-right-style="none" border-right-width="1pt" border-right-color="rgb(0,0,0)" border-top-style="none" border-top-width="1pt" border-top-color="rgb(0,0,0)" border-bottom-style="none" border-bottom-width="1pt" border-bottom-color="rgb(0,0,0)" padding-top="2pt" padding-left="2pt" padding-right="2pt" padding-bottom="2pt">
																<fo:block color="rgb(0,0,128)" font-weight="bold"/>
																<fo:block><fo:inline font-weight="bold">COMPANIA:</fo:inline> BCI Creditos e Inversiones</fo:block>
																<fo:block color="rgb(0,0,0)">
																   <fo:inline font-weight="bold">FECHA:</fo:inline>
																	 <fo:inline><xsl:value-of select="LiquidacionCancelacion/fechaActual"/></fo:inline>
																</fo:block>
																<fo:block color="rgb(0,0,0)">
																   <fo:inline font-weight="bold">N° OPERACION:</fo:inline>
																	 <fo:inline><xsl:value-of select="LiquidacionCancelacion/numOperacion"/></fo:inline>
																</fo:block>
                          ...
                          <fo:table z-index="0" border-collapse="collapse" margin-top="20pt">
                            ...
                            <fo:table-header>
                              ...
                              <fo:table-row display-align="auto">
                                <fo:table-cell text-align="start" padding-top="5px" padding-left="10pt" padding-right="5px" padding-bottom="5px" font-size="11pt" font-weight="bold" background-color="rgb(51,51,153)">
                                  <fo:block font-size="11pt" font-family="Helvetica" color="rgb(255,255,255)">Liquidacion Cancelacion</fo:block>
                                </fo:table-cell>
                              </fo:table-row>
							</fo:table-header>
							<fo:table-body>
                                ...
                                <fo:table-cell text-align="start">
                                  <fo:block>
                                    <fo:table>
                                      ...
                                      <fo:table-column column-width="14%" column-number="10"/>
                                      <fo:table-column column-width="14%" column-number="11"/>
                                      <fo:table-column column-width="14%" column-number="12"/>
                                      <fo:table-header>
                                        <fo:table-row border-top-style="solid" border-top-width="2px" border-top-color="rgb(255,255,255)" font-size="7pt" font-family="Helvetica" background-color="rgb(147,149,152)">
                                          ...
                                          <fo:table-cell color="rgb(255,255,255)" border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="2pt" padding-right="2px" padding-bottom="5px">
                                            <fo:block>
                                              REAJUSTES
                                            </fo:block>
                                          </fo:table-cell>
                                          ...
                                          <fo:table-cell color="rgb(255,255,255)" border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="0.5pt" padding-right="0.5px" padding-bottom="5px">
                                            <fo:block>
                                             COMISIONES
                                            </fo:block>
                                          </fo:table-cell>
                                          ...
                                          <fo:table-cell color="rgb(255,255,255)" border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" padding-top="5px" padding-left="2pt" padding-right="2px" padding-bottom="5px">
                                            <fo:block>
                                             CANCELADO
                                            </fo:block>
                                          </fo:table-cell>
                                    ...
                                    <xsl:for-each select="LiquidacionRegistrosCancelacion">  
                                      ...
                                      <fo:table-body>
                                        <fo:table-row border-top-style="solid" border-top-width="2px" border-top-color="rgb(255,255,255)" font-size="6pt" font-weight="normal" background-color="rgb(233,233,234)">
                                          <fo:table-cell border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="2pt" padding-right="2px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="numeroCancelacion"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          ...
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="fechaCancelacion"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center" >
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="fechaVencimiento"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="valorTasa"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="valorCapital"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="valorReajustes"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="interesNormal"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="valorGastos"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="valorComisiones"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="montoMora"/></fo:inline> 
                                            </fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-left-style="solid" border-left-width="3.5px" border-left-color="rgb(255,255,255)" border-right-style="solid" border-right-width="3.5px" border-right-color="rgb(255,255,255)" padding-top="5px" padding-left="5pt" padding-right="5px" padding-bottom="5px" text-align="center">
                                            <fo:block>
                                              <fo:inline><xsl:value-of select="montoCancelado"/></fo:inline>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
