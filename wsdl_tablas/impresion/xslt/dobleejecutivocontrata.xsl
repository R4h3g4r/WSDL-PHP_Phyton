...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="contenido">
		...
		<xsl:call-template name="subTitulo">
			<xsl:with-param name="titulo" select="'Opción de Cobro'"/>
		</xsl:call-template>
		...
		<fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/ctaCte"/>
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/ejecutivoComercial"/>
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Doble Ejecutivo :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/dobleEjecutivo"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/oficinaEjecutivo"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Teléfono Doble Ejecutivo:'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/telefono"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<!-- BANCA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Cliente en Retención :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/clienteEnRetencion"/>
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- SEGMENTO -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Canal de Venta :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/canalVenta"/>
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Fecha Contratación :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/fechaContratacion"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Tarifa Mensual M($):'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/tarifaMensual"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Ejecutivo de Venta :'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/ejecutivoVenta"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="info/mesesGracia"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
