...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="contenido">
		...
		<xsl:call-template name="subTitulo">
			<xsl:with-param name="titulo" select="'Falta Renta + Contrato Multicanal + Multicrédtio'"/>
		</xsl:call-template>
		<!-- sub titulo -->
		...
		Actualiza la Renta de tu cliente, Firma el Contrato Multicanal y Revisa si cliente tiene Margen Vigente, Línea de
		</fo:block>

		<fo:block start-indent="4pt" padding-before="0.5mm">
		Multicrédito Creada, Contrato Multicanal firmado e ingresado y Pantalla Parámetros Producto Cliente (PPC) Ingresada.
		</fo:block>
		...
		<fo:block start-indent="4pt" padding-before="5mm">
		Haz que tu cliente firme el Contrato Multicanal y envíalo por valija en caso de RM y a tu ACA en caso de Regiones. 
		</fo:block>
