...
<!-- cabecera cliente -->
	...
	<fo:block font-size="8pt" font-weight="normal" text-align="left" space-after="4mm">
						...
						efectuar Liquidación por Prórroga de Crédito, la cual se detalla a continuación:
	</fo:block>
...
<fo:inline font-weight="bold" color="{$txt-rojo}"><xsl:value-of select="comex/avisoLiquidacionProrrogaCredito/totalPagadoMN"/></fo:inline>
			...
			<fo:block font-size="8pt" font-weight="normal" space-before="4mm">
				Rogamos tomar nota de este débito, el cual se entenderá confirmado por Ud.(s) si no es objetado 
				por escrito dentro de 15 días contados de la fecha de cobertura antes citada.
			</fo:block>

			<fo:block font-size="8pt" font-weight="normal" space-before="4mm">
				  Para cualquier consulta relacionada con esta operación, favor mencionar nuestra referencia Nº <fo:inline font-weight="bold" color="{$txt-rojo}"><xsl:value-of select="comex/avisoLiquidacionProrrogaCredito/numOperacion"/></fo:inline>
