		...
		<fo:table-cell >
			...
			<!-- titulo -->
				<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
					Imp. / Cobranzas Vigentes / Detalle
				</fo:block>
			<!-- titulo -->
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/instruccionesDeCobranza"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/gastoCedente"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
		Condición Entrega de Documento : </fo:block>
		</fo:table-cell>

		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/CondicionEntregaDocumentos"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/CondicionProtesto"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/declaracionesDeIngreso"/>
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/vencimiento"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/girador"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/cifra_ComisionAgente"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/cedente"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/referenciaCedente"/>
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="1.8cm" />
	...
	<fo:table-row text-align="right">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
		&#0160;<xsl:value-of select="cifra_InteresesMO"/>
		</fo:block>
		</fo:table-cell>
	 	<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
