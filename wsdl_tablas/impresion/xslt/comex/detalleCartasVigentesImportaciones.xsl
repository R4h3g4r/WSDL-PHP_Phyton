		...
		<fo:table-cell >
			...
			<!-- titulo -->
				<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
					Imp. / Cartas Créd. Vigentes / Detalle
				</fo:block>
			<!-- titulo -->
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
		Monto Apertura (mon. origen) : 
		</fo:block>
		</fo:table-cell>

		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/cifra_MontoAperturaMonedaOrigen"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
		Saldo sin Negociar (mon. origen) :
		</fo:block>
		</fo:table-cell>

		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/cifra_SaldoSinNegociarMonedaOrigen"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
		Saldo por Cubrir (Dolar) :  
		</fo:block>
		</fo:table-cell>

		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/cifra_SaldoPorCubrir"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/confirmacion"/>
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/refCliente"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/beneficiario"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/principal/mercaderia"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<xsl:for-each select="comex/principal/declaraciones/declaracion">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" text-align="right">
		<xsl:value-of select="numeroOperacion"/>&#0160;<xsl:value-of select="fecha"/>
		</fo:block>
		</xsl:for-each>
		</fo:table-cell>
...
<fo:table-column column-width="1.8cm" />
	...
	<fo:table-row text-align="right">
		...
		&#0160;<xsl:value-of select="negociacion"/>
		</fo:inline>
		</fo:block>
		</fo:table-cell>
		...
		&#0160;<xsl:value-of select="descEvento"/>
		</fo:block>
		</fo:table-cell>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
		&#0160;<xsl:value-of select="montoMO"/>
		</fo:block>
		</fo:table-cell>

		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
		&#0160;<xsl:value-of select="interesMO"/>
		</fo:block>
		</fo:table-cell>
	 	<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
