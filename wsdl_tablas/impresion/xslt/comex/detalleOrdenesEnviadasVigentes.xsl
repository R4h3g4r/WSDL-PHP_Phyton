		...
		<fo:table-cell >
			...
			<!-- titulo -->
				<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
					Ordenes Enviadas Vigentes / Detalle 
				</fo:block>
			<!-- titulo -->
...
<fo:table-column column-width="9.3cm" />
	...
	<fo:table-row>
		...
		<fo:table-cell border="0" text-align="left">
<!-- TABLA IZQUIERDA -->
		<xsl:call-template name="tablaInferiorIzquierda"/>
<!-- FIN TABLA IZQUIERDA -->
		</fo:table-cell>

		<fo:table-cell border="0" text-align="right">
<!-- TABLA DERECHA -->		
		<xsl:call-template name="tablaInferiorDerecha"/>
<!-- FIN TABLA DERECHA -->
		</fo:table-cell>
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/operacionID"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/fechaInicio"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/hora"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/fechaInstruccion"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/moneda"/>
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/monto"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/fechaValuta"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/gastosPorCuentaDe"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/formaEntregaDivisas"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/observaciones"/>
		</fo:block>
		</fo:table-cell>
...
<xsl:template name="tablaInferiorIzquierda">
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/beneficiarioNombre"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/beneficiarioDireccion"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/beneficiarioCiudad"/>
		</fo:block>
		</fo:table-cell>
...
<xsl:template name="tablaInferiorDerecha">
...
<fo:table-column column-width="4.4cm" />
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/beneficiarioPais"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/beneficiarioBanco"/>
		</fo:block>
		</fo:table-cell>
	...
	<fo:table-row background-color="{$bgcolor}">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
		&#0160;<xsl:value-of select="comex/estaOrdendePagoEnviada/beneficiarioCuentaCorriente"/>
		</fo:block>
		</fo:table-cell>
