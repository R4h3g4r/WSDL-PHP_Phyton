...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="contenido">
		...
		<fo:block font-size="8pt" font-weight="bold" space-before="2mm" space-after="2mm">
			Comprobante de rescate de Fondos Mutuos
	    </fo:block>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell  border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="comprobante-ffmm/comprobante/cuotas"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell />
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell  border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="comprobante-ffmm/comprobante/tipo-rescate"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell />
					</fo:table-row>
					...
					<fo:table-row>
						...
						<fo:table-cell  border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="comprobante-ffmm/comprobante/fecha-rescate"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell />
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell  border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="comprobante-ffmm/comprobante/cuenta-abono"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell />
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell  border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;<xsl:value-of select="comprobante-ffmm/comprobante/fecha-abono"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell />
					</fo:table-row>
