                            ...
                            <fo:table-body>
                               ...
                               url('<xsl:value-of select="Nomina/rutaLogoCabecera" />')
                                    ...
                                    <fo:table-cell>
                                        <fo:external-graphic width="100pt">
                                            <xsl:attribute name="src">
                                               url('<xsl:value-of select="Nomina/rutaLogoSelloAgua" />')
                                            </xsl:attribute>
                                        </fo:external-graphic>
                                    </fo:table-cell>
                                </fo:table-row>
                 ...
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="2cm" font-size="10pt"  margin-left="1.4cm"  font-weight="bold">
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                         Se ha eliminado exitosamente la siguiente nómina:
								...
								<fo:table-row>
									<fo:table-cell>
										...
										<fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="Nomina/codigoId" />
                                         </fo:block>
									</fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="Nomina/rutPagador" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                            <xsl:value-of select="Nomina/razonSocial" />
                                        </fo:block>
                                    </fo:table-cell>
								</fo:table-row>
								<fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                           $         <xsl:value-of select="Nomina/monto" />
                                         </fo:block>
                                    </fo:table-cell>
									<fo:table-cell>
								        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
