              ...
              <fo:static-content flow-name="xsl-region-before" >
                        <fo:block >
                            ...
                            <fo:table-body>
                               ...
                               url('<xsl:value-of select="CargaNomina/rutaLogoCabecera" />')
                               </xsl:attribute>
                             </fo:external-graphic>
                       </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:external-graphic width="100pt">
                                            <xsl:attribute name="src">
                                               url('<xsl:value-of select="CargaNomina/rutaLogoSelloAgua" />')
                                            </xsl:attribute>
                                        </fo:external-graphic>
                                    </fo:table-cell>
                                </fo:table-row>
                 ...
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="2cm" font-size="10pt"  margin-left="1.4cm"  font-weight="bold">
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                           Se ha cargado correctamente la siguiente nómina:
                                ...
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="CargaNomina/codigoId" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="CargaNomina/rutCliente" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                            <xsl:value-of select="CargaNomina/razonSocial" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>                             
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="CargaNomina/modalidadCargo" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="CargaNomina/fechaPago" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                            <xsl:value-of select="CargaNomina/fechaCarga" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>                                    
							</fo:table-body>
