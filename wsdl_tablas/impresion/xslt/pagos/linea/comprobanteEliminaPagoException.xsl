              ...
              <fo:static-content flow-name="xsl-region-before" >
                        <fo:block >
                            ...
                            <fo:table-body>
                               ...
                               url('<xsl:value-of select="Pago/rutaLogoCabecera" />')
                               </xsl:attribute>
                             </fo:external-graphic>
                       </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:external-graphic width="100pt">
                                            <xsl:attribute name="src">
                                               url('<xsl:value-of select="Pago/rutaLogoSelloAgua" />')
                                            </xsl:attribute>
                                        </fo:external-graphic>
                                    </fo:table-cell>
                                </fo:table-row>
                 ...
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="2cm" font-size="10pt"  margin-left="1.4cm"  font-weight="bold">
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                         Se ha eliminado exitosamente el siguiente pago:
                          ...
                          <fo:table-body>
								<fo:table-row>
									<fo:table-cell>
										...
										<fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="Pago/codigoId" />
                                         </fo:block>
									</fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="Pago/idPago" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="Pago/traceNumber" />
                                        </fo:block>
                                    </fo:table-cell>
								</fo:table-row>
								...
								<fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                            <xsl:value-of select="Pago/rutBeneficiario" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="Pago/tipoPago" />
                                        </fo:block>
                                    </fo:table-cell>
									<fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                            <xsl:value-of select="Pago/bancoDestino" />
                                         </fo:block>
                                    </fo:table-cell>
                                 </fo:table-row> 
                                 ...
                                 <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="Pago/cuentaDestino" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                           $         <xsl:value-of select="Pago/monto" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block font-size="10pt" margin-left="1.4cm"   font-weight="bold">
                                            <xsl:value-of select="Pago/fechaPago" />
                                        </fo:block>
                                    </fo:table-cell>
                                 </fo:table-row>  
                                 <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="Pago/estado" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
