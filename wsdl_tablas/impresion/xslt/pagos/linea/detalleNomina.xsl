    ...
    <xsl:template match="DetalleNomina">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master  master-name="first" page-height="11in" page-width="12in" margin-top="1cm" margin-bottom="1cm" margin-left="2cm" margin-right="2cm">
                    <fo:region-body  size="landscape" margin-top="1cm" margin-bottom="4.5cm" background-color="#ffffff"/>
            ...
            <fo:page-sequence master-reference="first" initial-page-number="1" language="en" country="us">
                ...
                <fo:block space-after="1mm">
                    ...
                    <fo:block>
                        ...
                        <fo:table font-size="9pt" border="solid">
                            ...
                            <fo:table-column column-width="40mm"/><!-- Título -->
                            <fo:table-column column-width="42mm"/><!-- Valor -->
                            <fo:table-column column-width="40mm"/><!-- Título -->
                            <fo:table-column column-width="42mm"/><!-- Valor -->
                            <fo:table-column column-width="40mm"/><!-- Título -->
                            <fo:table-column column-width="43mm"/><!-- Valor -->
                            <fo:table-body>
                        ...
                        <fo:table space-before="3mm" font-size="9pt" border="solid">
                            <fo:table-column column-width="1mm"/> <!-- Margen -->
                            <fo:table-column column-width="40mm"/><!-- Forma Pago -->
                            <fo:table-column column-width="20mm"/><!-- Totales -->
                            <fo:table-column column-width="28mm"/><!-- Monto Total -->
                            <fo:table-column column-width="40mm"/><!-- Registros Rechazados -->
                            <fo:table-column column-width="40mm"/><!-- Monto Rechazado -->
                            <fo:table-column column-width="40mm"/><!-- Registros Aceptados -->
                            <fo:table-column column-width="38mm"/><!-- Monto Aceptado -->
                            <fo:table-column column-width="1mm"/> <!-- Margen -->
                            <fo:table-body>
                                <fo:table-row height="5mm">
                                    <fo:table-cell/>
                        ...
                        <fo:table font-size="9pt" border="solid">
                            ...
                            <fo:table-column column-width="40mm"/><!-- Monto Total -->
			    ...
			    <fo:table-column column-width="55mm"/><!-- Motivo -->								
                            <fo:table-header>
					...
					<fo:table-cell border="solid" border-width="0.5pt" number-columns-spanned="9">
                                            <fo:block font-size="5pt">&#160;</fo:block>
                                            <fo:block>
