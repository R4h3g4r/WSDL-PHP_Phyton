                 ...
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="1cm" font-size="10pt"  margin-left="1.4cm" >
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                          Con fecha 
                          <xsl:value-of select="TransferenciaIngreso/fecha" /> - <xsl:value-of select="TransferenciaIngreso/hora" /> se ha realizado correctamente el 
                    </fo:block>
                    <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                          ...
                          <fo:table-body>
								...
								<fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                            <xsl:value-of select="TransferenciaIngreso/modalidad" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                          ...
                          <fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell>
										...
										<fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                                    <xsl:value-of select="TransferenciaIngreso/razonSocial" />
                                         </fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
