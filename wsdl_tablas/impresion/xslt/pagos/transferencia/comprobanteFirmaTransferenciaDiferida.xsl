                    ...
                    <fo:block background-position="center" margin-left="117mm">
                        <fo:block margin-left="5mm" width="200pt" height="200pt" space-before="12mm">
                            ...
                            <fo:block font-weight="normal" text-align="left" font-size="10pt"
                                ...
                                la transferencia
                                <fo:inline font-weight="bold">
                                    <xsl:value-of select="ComprobanteNominasDiferidas/nominas/identificador" />
                                </fo:inline>
                                 ha sido efectuada exitosamente con cargo a la cuenta
                                <fo:inline font-weight="bold">
                                    ...
                                    <fo:table-body >
                                        <fo:table-row >
                                            ...
                                            <fo:table-row>
                                                ...
                                                <fo:table-cell border-color="black" border-left-style="solid" number-columns-spanned="1" border="0.5pt solid {$lineas}">
                                                    <fo:block font-size="9pt" text-align="center" font-stretch="condensed" space-before="1mm" color="{$txt}" margin-left="1mm">
                                                        <xsl:value-of select="ComprobanteNominasDiferidas/nominas/rutDestin" />
                                                    </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell border-color="black" border-left-style="solid" number-columns-spanned="1" border="0.5pt solid {$lineas}">
                                                    <fo:block font-size="9pt" text-align="left" font-stretch="condensed" space-before="1mm" color="{$txt}" margin-left="1mm">
                                                        <xsl:value-of select="ComprobanteNominasDiferidas/nominas/descripcionBanco" />
                                                    </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell border-color="black" border-left-style="solid" number-columns-spanned="1" border="0.5pt solid {$lineas}">
                                                    <fo:block font-size="9pt" text-align="right" font-stretch="condensed" space-before="1mm" color="{$txt}" margin-left="1mm">
                                                    <xsl:value-of select="ComprobanteNominasDiferidas/nominas/ctaDestino" />
                                                    </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell border-color="black" border-left-style="solid" number-columns-spanned="1" border="0.5pt solid {$lineas}">
                                                    <fo:block font-size="9pt" text-align="right" font-stretch="condensed" space-before="1mm" color="{$txt}" margin-left="1mm">
                                                    <xsl:value-of select="ComprobanteNominasDiferidas/nominas/montoTransfer" />
                                                    </fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                    </fo:table-body>
                        ...
                        <fo:block space-before="0cm" font-size="9pt" margin-left="0mm">
                            Recuerde imprimir o guardar este comprobante como respaldo. Ante cualquier consulta comunicarse con la Mesa de Ayuda al fono <xsl:value-of select="ComprobanteNominasDiferidas/nominas/fonoMesaAyuda"/> 
                        </fo:block>
                    </fo:block>
                </fo:flow>
            </fo:page-sequence>
