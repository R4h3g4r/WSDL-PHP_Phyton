                          ...
                          <fo:table-body>
								...
								<fo:table-row>
									...
									<fo:table-cell>
										...
										<fo:block font-size="10pt" margin-left="1.4cm" >
                                            <xsl:value-of select="Transferencia/tipoPago" />
                                        </fo:block>
									</fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                <fo:table-cell>
                                 ...
                                 <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                              <xsl:value-of select="Transferencia/tipoTransferencia" />
                                         </fo:block>
                                    </fo:table-cell>
                                 </fo:table-row>  
                                  <fo:table-row>
                                	<fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" hyphenate="true">
                                            <xsl:value-of select="Transferencia/msjeDestinatario" />
                                        </fo:block>
                                    </fo:table-cell>
									<fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                              <xsl:value-of select="Transferencia/rutDestinatario" />
                                         </fo:block>
                                 </fo:table-cell>
                                 </fo:table-row>  
                                 <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" hyphenate="true">
                                            <xsl:value-of select="Transferencia/nombreDest" />
                                         </fo:block>
                                 </fo:table-cell>
                                 <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                              <xsl:value-of select="Transferencia/ctaDest" />
                                         </fo:block>
                                    </fo:table-cell>
                                 </fo:table-row>  
                                  <fo:table-row>
                                	<fo:table-cell>
										...
										<fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                            <xsl:value-of select="Transferencia/bancoDest" />
                                        </fo:block>
									</fo:table-cell>
									<fo:table-cell>
								        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
										...
										<fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                                    <xsl:value-of select="Transferencia/ctaOrigen" />
                                         </fo:block>
                                 </fo:table-cell>
                                 </fo:table-row>  
                      ...
                      <fo:block font-size="5pt" space-after="0.5cm" space-before="1cm">
                            <fo:table width="16cm" >
                                ...
                                <fo:table-body>
                                    ...
                                    <xsl:for-each select="Transferencia/historial/datosListaEventos">
                                        <fo:table-row>
