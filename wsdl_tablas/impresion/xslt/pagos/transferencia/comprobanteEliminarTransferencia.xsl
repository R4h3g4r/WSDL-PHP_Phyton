              ...
              <fo:static-content flow-name="xsl-region-before" >
                        <fo:block >
                            ...
                            <fo:table-body>
                               ...
                               url('<xsl:value-of select="TransferenciaEliminada/rutaLogoCabecera" />')
                               </xsl:attribute>
                             </fo:external-graphic>
                       </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:external-graphic width="100pt">
                                            <xsl:attribute name="src">
                                               url('<xsl:value-of select="TransferenciaEliminada/rutaLogoSelloAgua" />')
                                            </xsl:attribute>
                                        </fo:external-graphic>
                                    </fo:table-cell>
                                </fo:table-row>
               ...
               <fo:static-content flow-name="xsl-region-after" margin-left="18.7cm" font-size="12pt" >
                ...
                <fo:flow flow-name="xsl-region-body">
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="1cm" font-size="10pt"  margin-left="1.4cm" >
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
						La transferencia&#160; <xsl:value-of select="TransferenciaEliminada/idTransferencia" /> &#160;ha sido eliminada exitosamente.
                     </fo:block>
                          ...
                          <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                                                    <xsl:value-of select="TransferenciaEliminada/nombreEmpresa" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold" >
                                        ...
                                        <fo:block font-size="10pt" margin-left="1.4cm">
                                            <xsl:value-of select="TransferenciaEliminada/rutEmpresa" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                             <xsl:value-of select="TransferenciaEliminada/nombreUsuario" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                            <xsl:value-of select="TransferenciaEliminada/rutUsuario" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                   <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                                            <xsl:value-of select="TransferenciaEliminada/ctaOrigen" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                 ...
                 <fo:block  margin-left="117mm"  width="200pt" height="200pt" space-before="0.5cm" >
                          ...
                          <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                                                    <xsl:value-of select="TransferenciaEliminada/idTransferencia" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold" >
                                        ...
                                        <fo:block font-size="10pt" margin-left="1.4cm">
                                            <xsl:value-of select="TransferenciaEliminada/rutDest" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                           $         <xsl:value-of select="TransferenciaEliminada/monto" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                            <xsl:value-of select="TransferenciaEliminada/tipoPago" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                   <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                                            <xsl:value-of select="TransferenciaEliminada/bancoDest" />
                                        </fo:block>
                                    </fo:table-cell>
                                   <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm">
                                              <xsl:value-of select="TransferenciaEliminada/ctaDest" />
                                         </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                   <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                                            <xsl:value-of select="TransferenciaEliminada/fecha" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
Recuerde imprimir o guardar este comprobante como respaldo. Ante cualquier consulta  comunicarse con la Mesa de Ayuda, al 600 224 4000.
                     </fo:block>
                    </fo:block>
                    </fo:block>
