                 ...
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="2cm" font-size="10pt"  margin-left="1.4cm" >
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                          Con fecha 
                          <xsl:value-of select="TransferenciaIngreso/fecha" /> - <xsl:value-of select="TransferenciaIngreso/hora" /> se ha realizado correctamente el ingreso de la siguiente transferencia:
                    </fo:block>
