			...
			<fo:page-sequence master-reference="pagina" initial-page-number="1" language="en" country="us">
				...
				<fo:static-content flow-name="xsl-region-after">
					...
					<fo:block font-size="9pt" font-weight="normal" space-after="1mm" text-align="left" color="{$txt}">
						Para Consultas o Comentarios Comuníquese al <xsl:value-of select="transferencia/fonoAtencionCanal"/>
					</fo:block>
						...
						<fo:table-row>
							<fo:table-cell>
								<fo:block font-size="12pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt}">
									Banco de Crédito e Inversiones, Rut 97006000-6, certifica que don(a) <xsl:value-of select="/transferencia/nombreEmpresa"/>, 
									Rut <xsl:value-of select="/transferencia/rutEmpresa"/>, 
									ha efectuado la transferencia Nro <xsl:value-of select="numeroTransferencia"/>, con el siguiente detalle:
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
					...
					<fo:table-body>
						<fo:table-row space-after="1mm">
							...
							<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left" hyphenate="true">
