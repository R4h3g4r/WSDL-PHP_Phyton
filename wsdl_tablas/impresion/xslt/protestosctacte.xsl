		...
		<fo:table-cell >
			...
			<!-- titulo -->
				<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
					Protestos, Retenciones, Dovoluciones, ONP
				</fo:block>
			<!-- titulo -->
...
<fo:table-column column-width="2cm" />                          
	...
	<xsl:for-each select="info/protestos/detalle-protesto">
...
<fo:table-column column-width="2cm" />
	...
	<xsl:for-each select="info/protestos/detalle-retencion">
	<fo:table-row text-align="right">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="fechaDeposito"/>
		</fo:block>
		</fo:table-cell>

		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="fechaLiberacion"/>
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="2cm" />  
	...
	<xsl:for-each select="info/protestos/detalle-devolucion">
	<fo:table-row text-align="right">
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="cuentaGirador"/>
		</fo:block>
		</fo:table-cell>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="motivoDevolucion"/>
		</fo:block>
		</fo:table-cell>
