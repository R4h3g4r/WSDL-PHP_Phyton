...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell padding="2pt" border="0.3pt solid #E2E2E2">
							<fo:block font-size="13pt" text-align="left" font-weight="bold" font-family="{$txt-font}" color="{$txt-azul-claro}">Área Central</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
										...
										<fo:table-row>
											...
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Calificación :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
	...
	<xsl:template name="oportunidadDeNegocio">
		...
		<fo:block font-weight="bold" font-size="9pt" text-align="left" font-family="{$txt-font}" color="{$txt-azul-claro}">Campañas Vigentes</fo:block>
		<fo:block font-size="7pt" text-align="left" font-family="{$txt-font}" color="{$txt-azul-claro}">
			<xsl:choose>
		...
		<fo:block space-before="0.3cm">
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell padding="2pt" border="0.3pt solid #E2E2E2">
							<fo:block font-size="13pt" text-align="left" font-weight="bold" font-family="{$txt-font}" color="{$txt-azul-claro}">Datos Básicos</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
										...
										<fo:table-row>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Razón Social :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
										...
										<fo:table-row>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Nombre de Fantasía :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
										...
										<fo:table-row>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Categoría  :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
										...
										<fo:table-row>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Naturaleza Jurídica  :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
										...
										<fo:table-row>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Ultima Modificación :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
										...
										<fo:table-row>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block>
													...
													</fo:external-graphic>Nº Di :</fo:block>
											</fo:table-cell>
											<fo:table-cell border="0.3pt solid #E2E2E2" padding-left="2pt" padding-top="2pt">
												<fo:block font-weight="bold">
