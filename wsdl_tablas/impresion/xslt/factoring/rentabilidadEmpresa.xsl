								...
								<fo:table-row>
									...
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
											<xsl:value-of select="rentabilidadEjecutivo/cabecera/fecha-impresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="rentabilidadEjecutivo/cabecera/nombre"/>
							</fo:block>
							<!-- nombre Ejecutivo -->
						</fo:table-cell>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
								...
								<fo:inline color="{$txt-azul-claro}">
									<xsl:value-of select="rentabilidadEjecutivo/cabecera/plataforma"/>
								</fo:inline>
							</fo:block>
							<!-- Plataforma -->
						</fo:table-cell>
...
<fo:instream-foreign-object>
    <xsl:value-of select="rentabilidadEjecutivo/imagen" disable-output-escaping="yes"/>
</fo:instream-foreign-object>
</fo:block>
					<!-- Separador -->
					<fo:block space-after="1mm">
...
<xsl:template name="tabla">
		<fo:block>
			<fo:table table-layout="fixed">
				...
				<fo:table-column column-width="2.76cm"/>
				<fo:table-column column-width="2.76cm"/>
				<fo:table-column column-width="2.76cm"/>
				<fo:table-column column-width="2.76cm"/>
				<fo:table-column column-width="2.76cm"/>
				...
				<xsl:for-each select="rentabilidadEjecutivo/tabla/fila">
				<fo:table-row>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-size="8pt" font-weight="normal" text-align="left" space-after="0.5mm" space-before="0.5mm">
								&#0160;<fo:inline text-decoration="underline"><xsl:value-of select="periodo"/></fo:inline>
							</fo:block>
						</fo:table-cell>
