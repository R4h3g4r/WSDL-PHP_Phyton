...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="contenido">
		...
		<!-- LISTADO DE LINEAS -->
		<!-- Detalle -->
		<fo:block font-size="3pt" space-after="1mm"
			text-align="right">
			<fo:table table-layout="fixed">
						...
						<fo:table-row>
							...
							<fo:table-cell
								...
								<fo:block font-weight="normal"
									...
									text-align="left">
									&#0160;
									<xsl:value-of select="estado-operacion" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell
								border="0.5pt solid {$lineas}">
								<fo:block font-weight="normal"
									...
									text-align="left">
									&#0160;
									<xsl:value-of select="estado-legal" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell
								border="0.5pt solid {$lineas}">
								<fo:block font-weight="normal"
									...
									text-align="left">
									&#0160;
									<xsl:value-of select="estado-verificacion" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell
								border="0.5pt solid {$lineas}">
							...
							<fo:table-cell
								...
								<fo:block font-weight="normal"
									...
									text-align="left">
									&#0160;
									<xsl:value-of select="estado-asistente" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell
								border="0.5pt solid {$lineas}">
