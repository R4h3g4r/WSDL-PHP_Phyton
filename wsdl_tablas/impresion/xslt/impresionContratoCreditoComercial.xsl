            ...
            <fo:table-body>
              ...
              <fo:table-row>
                <fo:table-cell padding="1mm">
                  ...
                  <fo:block text-align="justify" line-height="15pt" padding-after="10pt">
                      Los honorarios y gastos por las gestiones serán los siguientes, aplicados sobre el total de la deuda o cuota vencida: obligaciones hasta 10 unidades de fomento -UF--  9%; por la parte que exceda de 10 UF y hasta 50 UF, 6% y por la parte que exceda de 50 UF, 3%. Dichos porcentajes se aplicarán una vez transcurridos los primeros 15 días de atraso y podrán ser modificados anualmente en caso de créditos de consumo cuyo plazo de pago exceda de 1 año, siempre que tales cambios se avisen con una anticipación mínima de 2 períodos de pago.
                  </fo:block>
                  <fo:block text-align="justify" line-height="15pt" padding-after="10pt">
          ...
          <fo:table font-size="10pt" font-family="Arial, Helvetica, sans-serif" space-before.optimum="1pt" space-after.optimum="1pt">
            ...
            <fo:table-body>
              ...
              <fo:table-row>
                <fo:table-cell padding="1mm">
                  <fo:block text-align="justify" line-height="15pt" padding-after="10pt">
                      <fo:inline font-size="10pt" font-weight="bold">Uno) </fo:inline> El Cliente otorga  mandato al Banco de Crédito e Inversiones para que éste proceda a cargar en la
                      cuenta individualizada al final de este instrumento, el monto de las cuotas del crédito contratado. El Cliente 
                      asume la obligación de mantener fondos disponibles y suficientes en su cuenta, para cubrir los cargos. En 
                      caso contrario, el Cliente se obliga a pagar al Banco el importe de cada cuota adeudada hasta la total 
                      extinción de las obligaciones contraídas.
                  </fo:block>

                  <fo:block text-align="justify" line-height="15pt" padding-after="10pt">
                       En el ejercicio de este mandato, el cliente faculta al Banco de Crédito e Inversiones
                       para efectuar los cargos por los conceptos referidos en su cuenta, en el día de la fecha de vencimiento de la o las obligaciones respectivas.
                        En el evento que el cliente sea beneficiario de un Convenio de Pago de Remuneraciones a través de su cuenta, el cliente faculta al 
                        Banco de Crédito e Inversiones para cargar la cuenta por los conceptos referidos , en el día de pago de sus remuneraciones, aún cuando este día
              ...
              <fo:table-row>
                <fo:table-cell padding="1mm">
                  <fo:block text-align="left" padding-before="11pt">
                      El presente Anexo es parte integrante del Contrato de Crédito Comercial celebrado con esta misma fecha entre Banco de Crédito e Inversiones y don(ña) <fo:inline font-size="10pt" font-weight="bold"><xsl:value-of select="nombreCliente"/> </fo:inline>
                  </fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
