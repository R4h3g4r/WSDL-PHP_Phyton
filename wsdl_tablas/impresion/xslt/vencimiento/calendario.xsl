...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="bgcolorcalendariomenor">
		<xsl:value-of select="calendario/rutaImagen"/>diagoFull.gif</xsl:variable>
						...
						<fo:table table-layout="fixed" width="19cm">
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src"><xsl:value-of select="calendario/rutaImagen"/>logo-banca-privada.gif</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
					...
					<xsl:for-each select="calendario/semana">
						<fo:table-row text-align="right">
							...
							<xsl:if test="lunes/numeroActual = 'igual'">
								<xsl:if test="lunes/activo != 'activo'">
									<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolorcalendarioigual}">
										<fo:block font-weight="bold" color="{$txtDia}" padding-after="0.9mm" padding-before="0.1mm" margin="2pt 85pt 90pt 0pt" text-align="left" space-before="1.3mm" margin-left="0.1mm" margin-right="95pt" padding-bottom="0.2mm">														
								...
								<!--LUNES ACTIVO-->
								<xsl:if test="lunes/activo = 'activo'">
									<fo:table-cell border="1pt solid {$bgcolorgrisOscuro}" background-color="{$bgcolorgris}" border-right="2pt" border-bottom="3pt" >
										<fo:block font-weight="bold" color="{$lineasBlanco}" padding-after="0.6mm" padding-before="0.1mm" margin="2pt 85pt 90pt 0pt" text-align="left" space-before="0.1mm" margin-left="0.1mm" margin-right="95pt" padding-bottom="0.2mm" background-color="{$bgcolorgrisOscuro}">														
														&#xA0;&#xA0;<xsl:value-of select="lunes/numeroDia"/>
										</fo:block>
										...
										<fo:block text-align="right">
											<fo:leader color="{$bgcolortotal}" leader-pattern="rule" leader-length="105pt"/>
										</fo:block>
										<!--A RECIBIR Y A PAGAR-->
							...
							<xsl:if test="lunes/numeroActual = 'mayor'">
								<xsl:if test="lunes/activo != 'activo'">
									<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolorcalendariomayor}">
										<fo:block font-weight="bold" color="{$txtDia}" padding-after="0.6mm" padding-before="0.9mm" margin="2pt 85pt 90pt 0pt" text-align="left" space-before="0.9mm" margin-left="0.7mm" margin-right="95pt" padding-bottom="0.2mm">														
												&#xA0;&#xA0;<xsl:value-of select="lunes/numeroDia"/>
										</fo:block>
									</fo:table-cell>
								</xsl:if>
								<xsl:if test="lunes/activo = 'activo'">
									<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolorcalendariomayor}">
										<fo:block font-weight="bold" color="{$txtDia}" background-color="{$bgcolorgris}" padding-after="0.6mm" padding-before="0.9mm" margin="2pt 85pt 90pt 0pt" text-align="left" space-before="0.9mm" margin-left="0.7mm" margin-right="95pt" padding-bottom="0.2mm">														
												&#xA0;&#xA0;<xsl:value-of select="lunes/numeroDia"/>
										</fo:block>
										<xsl:if test="lunes/estadoNeto = 'positivo'">
											<!--VALOR NETO-->
							...
							<xsl:if test="martes/numeroActual = 'menor'">
								<fo:table-cell border="0.5pt solid {$lineas}" background-image="{$bgcolorcalendariomenor}">
									<fo:block font-weight="bold" color="{$txtDia}" padding-before="1mm" padding-after="15mm" text-align="left">&#xA0;<xsl:value-of select="martes/numeroDia"/>
									</fo:block>
								</fo:table-cell>
							</xsl:if>
							...
							<xsl:if test="miercoles/numeroActual = 'mayor'">
								...
								<xsl:if test="miercoles/activo = 'activo'">
									<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolorcalendariomayor}">
										...
										<xsl:if test="miercoles/estadoNeto = 'positivo'">
											<!--miercoles POSITIVO PERO FUTURO-->
											<!--VALOR NETO-->
											<fo:block space-before="1.5mm" font-weight="bold">
												<fo:list-item>
													<fo:list-item-label>
							...
							<xsl:if test="viernes/numeroActual = 'menor'">
								<fo:table-cell border="0.5pt solid {$lineas}" background-image="{$bgcolorcalendariomenor}">
									<fo:block font-weight="bold" color="{$txtDia}" padding-before="1mm" padding-after="15mm" text-align="left">&#xA0;<xsl:value-of select="viernes/numeroDia"/>
									</fo:block>
								</fo:table-cell>
							</xsl:if>
							<xsl:if test="viernes/numeroActual = 'igual'">
								...
								<xsl:if test="viernes/activo = 'activo'">
									<fo:table-cell border="1pt solid {$bgcolorgrisOscuro}" background-color="{$bgcolorgris}" border-right="2pt" border-bottom="3pt" >
										<fo:block font-weight="bold" color="{$lineasBlanco}" padding-after="0.6mm" padding-before="0.1mm" margin="2pt 85pt 90pt 0pt" text-align="left" space-before="0.9mm" margin-left="0.1mm" margin-right="95pt" padding-bottom="0.2mm" background-color="{$bgcolorgrisOscuro}">														
														&#xA0;&#xA0;<xsl:value-of select="viernes/numeroDia"/>
										</fo:block>
