...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:template name="bodyCotizacion">
                                          ...
                                          <fo:table-header>
                                            <fo:table-row text-align="center" border-top-style="solid" border-top-width="2px">
                                              ...
                                              <fo:table-cell text-align="center" font-weight="bold"
                                                    ...
                                                    border-bottom-style="solid" border-bottom-width="1px" 
                                                    padding-top="2px" padding-left="2px" padding-right="2px" padding-bottom="2px">
                                                <fo:block>Amortización (<xsl:if test="monedaCredito = '0999'">$</xsl:if><xsl:if test="monedaCredito = '0998'">UF</xsl:if>)</fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell text-align="center" font-weight="bold"
                                                    border-left-style="solid" border-left-width="1px" 
                                                    border-right-style="solid" border-right-width="1px" 
                                                    ...
                                                    border-bottom-style="solid" border-bottom-width="1px" 
                                                    padding-top="2px" padding-left="2px" padding-right="2px" padding-bottom="2px">
                                                <fo:block>Interés (<xsl:if test="monedaCredito = '0999'">$</xsl:if><xsl:if test="monedaCredito = '0998'">UF</xsl:if>)</fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell text-align="center" font-weight="bold"
                                                    border-left-style="solid" border-left-width="1px" 
                                                    border-right-style="solid" border-right-width="1px" 
                                                    ...
                                                    border-bottom-style="solid" border-bottom-width="1px" 
                                                    padding-top="2px" padding-left="2px" padding-right="2px" padding-bottom="2px">
                                                <fo:block>Comisión (<xsl:if test="monedaCredito = '0999'">$</xsl:if><xsl:if test="monedaCredito = '0998'">UF</xsl:if>)</fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell text-align="center" font-weight="bold"
                                                    border-left-style="solid" border-left-width="1px" 
                                                    border-right-style="solid" border-right-width="1px" 
        ...
        <xsl:if test="msjeCuoton != ''">
          ...
          <fo:block> </fo:block>
                  <fo:inline>o    Los valores indicados en la presente simulación de crédito, son sólo referenciales, el valor definitivo de la cuota quedará informado al otorgamiento del crédito.</fo:inline>
          <fo:block> </fo:block>
                  <fo:inline>o    La entrega de una cotización, queda sujeta a que el Banco evalúe previamente el riesgo comercial,  y se aprueben las condiciones para el otorgamiento.</fo:inline>
          <fo:block> </fo:block>                            
          ...
          <fo:block> </fo:block>
                  <fo:inline>o    Los gastos notariales corresponden a una estimación para una operación de crédito de consumo en Santiago, pudiendo variar para operaciones de regiones cuyos aranceles dependerán de la localidad que se realice la operación.</fo:inline>                                                        
          <fo:block> </fo:block>
                  <fo:inline>o    CAE (Carga Anual Equivalente): Es el indicador que, expresado en forma de porcentaje, revela el costo de un crédito en período anual, cualquiera que sea el plazo pactado para el pago de la obligación. La CAE contempla el tipo de interés, todos los gastos asociados al crédito y el plazo de la operación; y se calcula sobre base anual.</fo:inline>
          <fo:block> </fo:block>
                  <fo:inline>o    CTC (Costo Total del Crédito): Es el indicador que, expresado en una suma de dinero, da cuenta del monto total a pagar por el crédito solicitado. Se calcula sumando el monto del crédito, lo adeudado por tasa de interés y los gastos asociados al crédito.</fo:inline>
          <fo:block> </fo:block>
                  <fo:inline>o    CAE y el CTC, se calcula  de acuerdo a las fórmulas indicadas en el Decreto N°43 del Ministerio de Economía Fomento y Turismo que aprobó el reglamento sobre información al Consumidor de Créditos de Consumo.</fo:inline>
          <fo:block> </fo:block>
          <xsl:if test="producto = 'CON500'">
                  <fo:inline>o    Los Créditos Universales de consumo son créditos a tasa fija denominados en pesos, otorgados a personas naturales, que no requieren garantías reales.</fo:inline>                                                        
          <fo:block> </fo:block>
          </xsl:if>
