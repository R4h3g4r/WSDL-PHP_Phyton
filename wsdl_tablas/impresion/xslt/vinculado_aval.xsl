             ...
             <fo:flow flow-name="xsl-region-body">
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" border-left="0.5pt solid black" border-right="0.5pt solid black" font-family="Helvetica" font-size="11pt" font-weight="bold" text-align="left" background-color="#BDBDBD"><fo:leader leader-pattern="space" leader-length="1mm"/>COMUNICACIONES Y ENVÍO DE INFORMACIÓN</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table-column  border-bottom="0.5pt solid black" border-top="0.5pt solid black" border-left="0.5pt solid black"  border-right="0.5pt solid black"/>
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:block   font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" margin-left="1mm" margin-right="1mm">La información sobre la diversificación de esta corredora, de las entidades aseguradoras con que haya trabajado y de las pólizas de seguros para responder del cumplimiento de las obligaciones, se encuentra a su disposición en https://www.bci.cl/corredora-de-seguros/diversificacion-de-cartera</fo:block>
	...
	<fo:block border-left="0.5pt solid black" border-right="0.5pt solid black" font-family="Helvetica" font-size="11pt"  text-align="center" background-color="#BDBDBD">&#160;</fo:block>
          	  ...
          	  <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      ...
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" border-bottom="0.5pt solid black" font-family="Helvetica" font-size="11pt"   text-align="left"  margin-left="0mm" line-height="4.5mm">Cesantía Involuntaria (POL 1 2013 0122)</fo:block>
                            </fo:table-cell>
                            <fo:table-cell >
                      ...
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" border-bottom="0.5pt solid black" font-family="Helvetica" font-size="11pt"   text-align="left"  margin-left="0mm" line-height="4.5mm">Renta por Hospitalización (POL 3 2013 0502)</fo:block>
                            </fo:table-cell>
                            <fo:table-cell >
                                      <fo:block border-top="0.5pt solid black" border-bottom="0.5pt solid black" font-family="Helvetica" font-size="11pt"   text-align="center"  margin-left="0mm" line-height="4.5mm">15,0%</fo:block>
                            </fo:table-cell>
