									...
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src">
												<xsl:value-of select="detalle-consulta/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
											<xsl:value-of select="detalle-consulta/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
				...
				<fo:table-cell>
					...
					<!-- nombre cliente -->
						<fo:block font-size="9pt" font-weight="normal" space-after="1mm" text-align="left" color="{$txt}">
							...
							<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="detalle-consulta/ejecutivo"/></fo:inline>
						</fo:block>
					<!-- nombre cliente -->
				...
				<fo:table-cell>
					...
					<!-- rut cliente -->
						<fo:block font-size="10pt" font-weight="normal" space-after="1mm" text-align="right" color="{$txt}">
							...
							<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="detalle-consulta/oficina"/></fo:inline>
						</fo:block>
					<!-- rut cliente -->
					...
					<fo:table-row>
						<fo:table-cell padding-before="1mm">
							<fo:external-graphic height="1.2mm" width="1.2mm">
								<xsl:attribute name="src">
									<xsl:value-of select="detalle-consulta/rutaImagen"/>01-bullet2-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<xsl:for-each select="detalle-consulta/listado-impagos/documentos">
					<fo:table-row>
					...
					<fo:table-row>
						<fo:table-cell padding-left="2mm" padding-before="1mm" >
							<fo:external-graphic height="1mm" width="1mm">
								<xsl:attribute name="src">
									<xsl:value-of select="detalle-consulta/rutaImagen"/>01-bullet1-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
...
<!-- tabla A -->
	...
	<xsl:value-of select="detalle-consulta/rutaImagen"/>01-bullet1-rj.gif</xsl:attribute>
	</fo:external-graphic>&#0160;Ejecutivo :
	</fo:block>
	</fo:table-cell>

	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="detalle-consulta/ejecutivo"/></fo:block>
	</fo:table-cell>
	...
	<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="detalle-consulta/consulta"/></fo:block>
	</fo:table-cell>
...
<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="left" color="black">
	...
	&#0160;<fo:external-graphic><xsl:attribute name="src">
	<xsl:value-of select="detalle-consulta/rutaImagen"/>01-bullet1-rj.gif</xsl:attribute>
	</fo:external-graphic>&#0160;Consulta : 
	</fo:block>
	</fo:table-cell>

	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="detalle-consulta/consultaInicio"/> al <xsl:value-of select="detalle-consulta/consultaFinal"/></fo:block>
	</fo:table-cell>
