						...
						<fo:table table-layout="fixed">
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src"><xsl:value-of select="protestado/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
											<xsl:value-of select="protestado/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
				...
				<fo:table-cell>
					...
					<!-- nombre ejecutivo -->
						<fo:block font-size="9pt" font-weight="normal" space-after="1mm" text-align="left" color="{$txt}">
							...
							<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="protestado/ejecutivo"/></fo:inline>
						</fo:block>
					<!-- nombre ejecutivo -->
				...
				<fo:table-cell>
					...
					<!-- oficina ejecutivo -->
						<fo:block font-size="10pt" font-weight="normal" space-after="1mm" text-align="right" color="{$txt}">
							...
							<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="protestado/oficina"/></fo:inline>
						</fo:block>
					<!-- oficina ejecutivo -->
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/nombre"/>
							</fo:block>
							<!-- BANCA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/rut"/>
							</fo:block>
							<!-- SEGMENTO -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
								<xsl:call-template name="itemTitulo">
									<xsl:with-param name="titulo" select="'Cuenta :'"/>
								</xsl:call-template>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/ctaCargo"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/serialProtesto"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
							...
							<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
								<xsl:call-template name="itemTitulo">
									<xsl:with-param name="titulo" select="'Oficina Protesto :'"/>
								</xsl:call-template>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/descOficinaReceptora"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								$<xsl:value-of select="protestado/montoProtesto"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/fechaProtesto"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/codMotivoProtesto"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row height="{$alto-filas}">
						...
						<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
							<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="protestado/indEnvioBoletin"/>
							</fo:block>
							<!-- RENTA -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						<fo:table-cell padding-before="1mm">
							<fo:external-graphic height="1.2mm" width="1.2mm">
								<xsl:attribute name="src"><xsl:value-of select="protestado/rutaImagen"/>01-bullet2-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
					...
					<fo:table-row>
						<fo:table-cell padding-left="2mm" padding-before="1mm">
							<fo:external-graphic height="1mm" width="1mm">
								<xsl:attribute name="src"><xsl:value-of select="protestado/rutaImagen"/>01-bullet1-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
