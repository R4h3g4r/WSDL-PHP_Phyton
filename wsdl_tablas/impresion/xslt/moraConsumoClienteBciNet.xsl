...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<!-- Variables -->
	<xsl:template match="MoraConsumoTabla">
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								Ejecutivo: <xsl:value-of select="ejecConsulta"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
							<fo:block font-size="7pt" font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" margin-left="1mm" text-align="left">
								Rut
							</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
					...
					<xsl:when test="count(documentos/element) > 0">
						...
						<fo:table-row>
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="7pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="cliente" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right">
									<xsl:value-of select="deudaTotal" />&#0160;
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
									<xsl:if test="ctacte = 'true'">Sí</xsl:if>
									<xsl:if test="ctacte = 'false'">No</xsl:if>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
									<xsl:value-of select="diasConSNP" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right">
									<xsl:value-of select="montoSNP" />&#0160;
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
									<xsl:value-of select="productoMayor" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="right">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-size="8pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
									<xsl:if test="campanaRiesgo = 'true'">Sí</xsl:if>
									<xsl:if test="campanaRiesgo = 'false'">No</xsl:if>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
