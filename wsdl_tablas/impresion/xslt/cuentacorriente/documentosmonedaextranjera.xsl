...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src">
												<xsl:value-of select="documentos/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
										<xsl:value-of select="documentos/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="documentos/nombreCliente"/>
							</fo:block>
							<!-- nombre cliente -->
						</fo:table-cell>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
								...
								<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="documentos/rutCliente"/></fo:inline>
							</fo:block>
							<!-- rut cliente -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row >
						...
						<fo:table-cell >
							...
							<fo:block font-size="10pt" text-align="right" color="{$txt}">
								...
								<fo:inline font-weight="bold"><xsl:value-of select="documentos/nroCtaCte"/></fo:inline>
							</fo:block>
							<!-- nro tarjeta -->
						</fo:table-cell>
					</fo:table-row>
	...
	<fo:table-body>
		...
		<fo:table-cell>
			...
			<xsl:attribute name="src">
				<xsl:value-of select="documentos/rutaImagen"/>01-bullet1-rj.gif
			</xsl:attribute>
			</fo:external-graphic>
			&#0160;
			<fo:inline font-weight="normal" space-before="30pt">Ejecutvio: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="documentos/ejecutivo"/></fo:inline>
			</fo:block>
		...
		<fo:table-cell>
			...
			<fo:inline font-weight="bold"><xsl:value-of select="documentos/oficinaEjecutivo"/></fo:inline>
			</fo:block>
...
<fo:table-column column-width="2cm" />                            
	...
	<xsl:choose>
	<xsl:when test="count(documentos/listado-protestos) > 0">
		<xsl:for-each select="documentos/listado-protestos/listadoProtestos">
...
<!-- lista documentoss -->
<xsl:call-template name="indice">
		<xsl:with-param name="titulo" select="'Orden de NO Pago (ONP)'"/>
 </xsl:call-template>
	<!-- Separador -->
		<fo:block space-after="3mm">
		</fo:block>
...
<fo:table-column column-width="3cm" />
	...
	<xsl:choose>
	<xsl:when test="count(documentos/pago-listado) > 0">
		<xsl:for-each select="documentos/pago-listado/pagoListado">
		<fo:table-row text-align="right">
		<xsl:if test="position() mod 2 = 0">	
			<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}" number-columns-spanned="2">
			<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
			...
			<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
			<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
			&#0160;<xsl:value-of select="sucursalOrden"/>
			</fo:block>
			</fo:table-cell>

			<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
			<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
			&#0160;<xsl:value-of select="fechaOrden"/>
			</fo:block>
			</fo:table-cell>

			<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
			<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
			&#0160;<xsl:value-of select="glosaMotivo"/>
			</fo:block>
			</fo:table-cell>

			<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
			<fo:block font-weight="normal" padding-before="1mm" padding-after="1mm" text-align="left">
			&#0160;<xsl:value-of select="sucursalEliminacion"/>
			</fo:block>
			</fo:table-cell>
...
<!-- lista documentoss -->
	...
	<fo:table-cell padding-before="1mm">
		<fo:external-graphic>
				<xsl:attribute name="src">
					<xsl:value-of select="documentos/rutaImagen"/>01-bullet2-rj.gif
				</xsl:attribute>
		</fo:external-graphic>
	</fo:table-cell>
	<fo:table-cell>
