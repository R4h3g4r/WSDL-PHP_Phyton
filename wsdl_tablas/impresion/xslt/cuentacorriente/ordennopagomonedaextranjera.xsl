...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src">
												<xsl:value-of select="orden-no-pago/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
										<xsl:value-of select="orden-no-pago/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="orden-no-pago/nombreCliente"/>
							</fo:block>
							<!-- nombre cliente -->
						</fo:table-cell>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
								...
								<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="orden-no-pago/rutCliente"/></fo:inline>
							</fo:block>
							<!-- rut cliente -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row >
						...
						<fo:table-cell >
							...
							<fo:block font-size="10pt" text-align="right" color="{$txt}">
								...
								<fo:inline font-weight="bold"><xsl:value-of select="orden-no-pago/nroCtaCte"/></fo:inline>
							</fo:block>
							<!-- nro tarjeta -->
						</fo:table-cell>
					</fo:table-row>
	...
	<fo:table-body>
		...
		<fo:table-cell>
			...
			<xsl:attribute name="src">
				<xsl:value-of select="orden-no-pago/rutaImagen"/>01-bullet1-rj.gif
			</xsl:attribute>
			</fo:external-graphic>
			&#0160;
			<fo:inline font-weight="normal" space-before="30pt">Ejecutivo: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="orden-no-pago/ejecutivo"/></fo:inline>
			</fo:block>
		...
		<fo:table-cell>
			...
			<fo:inline font-weight="bold"><xsl:value-of select="orden-no-pago/oficinaEjecutivo"/></fo:inline>
			</fo:block>
...
<fo:table-column column-width="3cm" />
	...
	<xsl:choose>
	<xsl:when test="count(orden-no-pago/pago-listado) > 0">
		<xsl:for-each select="orden-no-pago/pago-listado/pagoListado">
...
<!-- lista orden-no-pagos -->
	...
	<fo:table-cell padding-before="1mm">
		<fo:external-graphic>
				<xsl:attribute name="src">
					<xsl:value-of select="orden-no-pago/rutaImagen"/>01-bullet2-rj.gif
				</xsl:attribute>
		</fo:external-graphic>
	</fo:table-cell>
	<fo:table-cell>
