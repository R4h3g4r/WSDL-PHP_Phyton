			...
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					<fo:table-row>
						...
						<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
								&#0160;Monto(<xsl:value-of select="mini-cartola/moneda"/>$)
							</fo:block>
						</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- SUCURSAL -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo1">
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block>
								<xsl:value-of select="$titulo"/>&#0160;<xsl:value-of select="mini-cartola/moneda"/>$ :
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
