...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<fo:table-body>
		...
		<fo:table-cell>
			...
			<xsl:attribute name="src">
				<xsl:value-of select="talonarios/rutaImagen"/>01-bullet1-rj.gif
			</xsl:attribute>
			</fo:external-graphic>
			&#0160;
			<fo:inline font-weight="normal" space-before="30pt">Ejecutivo: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="talonarios/ejecutivo"/></fo:inline>
			</fo:block>
		...
		<fo:table-cell>
			...
			<fo:inline font-weight="bold"><xsl:value-of select="talonarios/oficinaEjecutivo"/></fo:inline>
			</fo:block>
