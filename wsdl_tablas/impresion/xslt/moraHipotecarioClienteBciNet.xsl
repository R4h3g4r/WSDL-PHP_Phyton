			...
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
							<fo:block font-size="7pt" font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" margin-left="1mm" text-align="center">
								Gestión
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
						...
						<fo:table-row>
							...
							<xsl:if test="tieneGestion = 'true'">
								<fo:block font-size="7pt" font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
									<fo:inline font-family="ZapfDingbats" font-size="7pt">&#x2714;</fo:inline>
								</fo:block>
							</xsl:if>
