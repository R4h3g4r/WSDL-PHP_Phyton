            ...
            <fo:page-sequence master-reference="miCarta">
              ...
              <fo:table border-collapse="collapse" text-align="left" >
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" text-align="left" ><fo:leader leader-pattern="space" leader-length="2mm"/>Entidad Contratante: Banco Crédito e Inversiones</fo:block>
                            </fo:table-cell>
                            <fo:table-cell >
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" text-align="left" margin-left="2mm">Teléfono:<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/telefonoCliente" /></fo:inline></fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="justify">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" line-height="4.5mm" font-size="11pt" text-align="justify" margin-right="2mm" margin-left="1mm">Por el presente instrumento, solicito la incorporación del asegurable identificado anteriormente, a la póliza Colectiva respectiva de BCI Seguros Generales S.A., según producto identificado a continuación:</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
               </fo:table>
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    ...
                                    <fo:block font-family="Helvetica" font-size="11pt"   font-weight="bold" text-align="center" >Única UF</fo:block>
                            </fo:table-cell>
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt"   font-weight="bold" text-align="center" >Comisión de</fo:block>
                                    <fo:block font-family="Helvetica" font-size="11pt"   font-weight="bold" text-align="center" >Intermediación</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="center">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt"   text-align="center" >CESANTÍA INVOLUNTARIA</fo:block>
                            ...
                            <fo:table-cell >
                                    ...
                                    <fo:block font-family="Helvetica" font-size="11pt"   text-align="center" >crédito individualizado</fo:block>
                            </fo:table-cell>
                            <fo:table-cell >
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell  >
                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="left" margin-left="1mm" >Desde: la fecha del otorgamiento del crédito.</fo:block>
                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="left" margin-left="1mm" >Hasta: el día en que se produzca cualquiera de las dos circunstancias siguientes:</fo:block>
                                    ...
                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="left" margin-left="1mm" >2) Que se extinga el crédito que dio origen al seguro.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
               </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt"  line-height="4.5mm" text-align="justify" margin-right="2mm" margin-left="1mm"><fo:leader leader-pattern="space" leader-length="1mm"/>Autorizo que el monto de las primas correspondientes al seguro elegido, sea cargada en el pago del crédito solicitado, bajo el Nro. de Operación <fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/nroOperacion" /></fo:inline></fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
               </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" margin-left="1mm" margin-right="2mm"><fo:inline font-weight="bold">Periodo de actividad mínima para invocar al seguro:</fo:inline> 6 meses con contrato indefinido con un mismo empleador. <fo:inline font-weight="bold">Carencia:</fo:inline> 60 días desde la contratación del crédito o dos cuotas mensuales. Periodo de <fo:inline font-weight="bold">Cesantía/Incapacidad cubierto:</fo:inline> Cuatro cuotas mensuales. <fo:inline font-weight="bold">Edad de ingreso:</fo:inline> entre 18 y 64 años. <fo:inline font-weight="bold">Permanencia:</fo:inline> Hasta los 65 años 364 días.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
               </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" margin-right="2mm" ><fo:inline font-weight="bold">Trabajadores Independientes</fo:inline>   incapacidad temporal producida por una enfermedad de origen infeccioso o accidente que cause el otorgamiento de una licencia médica de reposo superior a 30 días. El número de cuotas a indemnizar se regirá de acuerdo a la tabla que se presenta a continuación:</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    ...
                                    <fo:block font-family="Helvetica" font-size="11pt"   text-align="left" >De 31 a 60 días <fo:leader leader-pattern="space" leader-length="3mm"/>: 1 cuota</fo:block>
                                    <fo:block font-family="Helvetica" font-size="11pt"   text-align="left" >De 61 a 90 días <fo:leader leader-pattern="space" leader-length="3mm"/>: 2 cuotas</fo:block>
                                    <fo:block font-family="Helvetica" font-size="11pt"   text-align="left" >De 91 a 120 días<fo:leader leader-pattern="space" leader-length="2mm"/>: 3 cuotas</fo:block>
                                    <fo:block font-family="Helvetica" font-size="11pt"   text-align="left" >Más de 121 días <fo:leader leader-pattern="space" leader-length="2mm"/>: 4 cuotas</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
            ...
            <fo:page-sequence master-reference="miCarta">
              ...
              <fo:table border-collapse="collapse" text-align="left"  >
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" font-family="Helvetica" font-size="11pt"  text-align="left" ><fo:inline text-decoration="underline">Antecedentes requeridos para la acreditación del siniestro y el pago de cuotas:</fo:inline></fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" margin-right="2mm">En caso de trabajador independiente: licencia médica con el número de días de reposo, copia de la documentación presentada al sistema de salud previsional, declaración jurada simple de su estado de salud. No se cubrirán las licencias médicas curativas extendidas con anterioridad a la contratación de la cobertura o derivadas de continuación de tratamiento, tampoco se cubren licencias médicas maternales ni licencias médicas por complicaciones de embarazos y tampoco por enfermedad de hijos menores de 1 año.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" margin-right="2mm">Clientes del banco BCI que habiendo jubilado no realizan actividad profesional documentada en contrato de trabajo o de prestación de servicios.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" text-align="justify" margin-right="2mm">Funcionarios de las Fuerzas Armadas, de Orden y Seguridad (Carabineros y Policía de Investigaciones).</fo:block>
                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" line-height="4.5mm" font-family="Helvetica" font-size="11pt" text-align="justify" margin-right="2mm" >Que la indemnización a que dé lugar la cobertura de <fo:inline font-weight="bold">Cesantía Involuntaria</fo:inline> será pagada íntegramente al Banco de Crédito de Inversiones. Acepto estas condiciones conforme a los términos prescritos en la Norma de Carácter General 124 de la S.V.S. del 22 de noviembre del 2001.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" margin-right="2mm" >  Del derecho a decidir sobre la contratación de los seguros y a la libre elección del intermediario y compañía aseguradora.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
              <fo:table border-collapse="collapse" text-align="left">
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            ...
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="11pt"   line-height="4.5mm" text-align="justify" margin-right="2mm" >Aceptar que esta solicitud, no otorga cobertura hasta haber sido aceptada por BCI Seguros Generales S.A. Que en caso que la tasa de desempleo de los últimos 12 meses móviles contados desde la fecha del mes anterior al de ocurrencia del siniestro, informada por el Instituto Nacional de Estadísticas (INE) sea superior al 10%, el monto asegurado será reducido a dos (2) cuotas de crédito como tope máximo de indemnización.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
              </fo:table>
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    ...
                                    <fo:block border-top="0.5pt solid black" border-left="0.5pt solid black" border-right="0.5pt solid black" font-family="Helvetica" font-size="11pt"   line-height="4.5mm" text-align="justify" ><fo:leader leader-pattern="space" />Autorizar al Banco, para remitir a Bci Seguros Generales S.A. y/o Bci Corredores de Seguros S.A. la información pertinente a los montos de los créditos; sus condiciones, estados de servicios de las deudas, montos o saldos insolutos adeudados y demás que fuere menester para dichas operaciones, según lo solicitaren dichas compañías.</fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
               </fo:table>
                      ...
                      <fo:table-row>
                            <fo:table-cell >
                               ...
                               <!-- <xsl:if test="certificado"> -->
                                   <fo:block border-top="0.5pt solid black" border-left="0.5pt solid black" border-right="0.5pt solid black" font-family="Helvetica" font-size="11pt"   font-weight="bold" line-height="4.5mm" text-align="left" >La presente solicitud de incorporación será aceptada por BCI Seguros Generales S.A. en forma inmediata y otorgará cobertura, una vez que la operación crediticia individualizada sea aceptada por el Banco de Crédito e Inversiones.</fo:block>
                               <!-- </xsl:if> -->
              ...
              <fo:table border-collapse="collapse" text-align="center" >
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" border-left="0.5pt solid black" border-right="0.5pt solid black" font-family="Helvetica" font-size="11pt"   font-weight="bold" text-align="center" >INFORMACION ARTICULOS 57 Y 58 DEL DL Nº 251</fo:block>
              ...
              <fo:table border-collapse="collapse" text-align="center" >
                  ...
                  <fo:table-body>
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block border-top="0.5pt solid black" border-left="0.5pt solid black" border-right="0.5pt solid black" font-family="Helvetica" font-size="11pt" line-height="4.5mm" text-align="justify" >BCI corredores de seguros S.A., Rut 87.826.800-8, en mi calidad de Corredor de seguros y en cumplimiento a la ley, informo que durante el año calendario anterior intermedié contratos de seguros con las siguientes Cías. de seguros: En Seguros Generales el 82.15% en BCI Seguros Generales S.A., el 7.29% con Aseguradora Magallanes S.A., el 2.01% con Cruz del Sur S.A., el 1.72% con Liberty Cia. de Seguros Generales y otras 6.83%; En Seguros de Vida, el 94.13% con BCI seguros de Vida S.A., el 3.19% en la Interamericana Vida S.A. y otras 6.83%. BCI Corredores de seguros S.A., se encuentra amparada por la Póliza de Seguros de Garantía Nº 196767-3 de BCI Seguros Generales S.A. y la Póliza de Responsabilidad Civil Nº 304-05-00011613 de Mapfre Seguros generales S.A.</fo:block>
                                     <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                            </fo:table-cell>
                      </fo:table-row>
                </fo:table-body>
