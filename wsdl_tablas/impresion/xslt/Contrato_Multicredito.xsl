        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
              ...
              <fo:table border-collapse="collapse" text-align="justify">
                 ...
                 <!-- <fo:table-column column-width="57.33mm" />-->
                  <fo:table-body>
                    ...
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm" >Cédula de Identidad Nº<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select='format-number(OperacionCredito/rutRepresentanteLegalBanco, "###.###.###","rut")' />-<xsl:value-of select="OperacionCredito/dvRepresentanteLegalBanco" /><!--<xsl:value-of select="OperacionCredito/rutRepresentanteLegal" />--></fo:inline><!--<fo:leader leader-length="5cm" leader-pattern="rule" rule-style="solid" rule-thickness="0.1mm" color="black"/>--><fo:leader leader-pattern="space" leader-length="1mm"/>en representación del BANCO DE CREDITO E INVERSIONES, en adelante el &quot;BANCO&quot;, se ha convenido celebrar el siguiente Contrato:</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">PRIMERO:</fo:inline> Por este instrumento el Banco otorga al Cliente un Bci Multicrédito, el cual permite al Cliente realizar avances de dinero en efectivo contra aquel, con abono en cuenta corriente o cuenta vista asociada al CLIENTE y que éste defina a dicho propósito. El pago de cada avance, se concretará a través de un crédito en cuotas fijas, cuyo número de cuotas fijará el Cliente. El Cupo disponible para avances, variará según la aprobación vigente en el &quot;Margen de Endeudamiento Global&quot; que se otorgue al Cliente, el cual creará, renovará y/o modificará el BANCO sin previo aviso al Cliente, como asimismo la acción que corresponda al cierre del Bci Multicrédito.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">SEGUNDO:</fo:inline> Los curses de Avances, que corresponden a un Crédito de consumo cuota fija- tasa fija, serán abonados en la <fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/tipoCargo" /></fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/><!--cuenta corriente / cuenta vista -->del CLIENTE Nº<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/nroCuentaCliente" /></fo:inline><!--<fo:leader leader-length="5.5cm" leader-pattern="rule" rule-style="solid" rule-thickness="0.1mm" color="black"/>-->,<fo:leader leader-pattern="space" leader-length="1mm"/>y el pago de las cuotas, serán cargadas a la <!--cuenta corriente / cuenta vista / tarjeta de crédito--><fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/tipoCargo" /></fo:inline><!--<fo:leader leader-length="4.5cm" leader-pattern="rule" rule-style="solid" rule-thickness="0.1mm" color="black"/>--><fo:leader leader-pattern="space" leader-length="1mm"/>Nº<fo:leader leader-pattern="space" leader-length="1mm"/><xsl:value-of select="OperacionCredito/nroCuentaCargo" /><!--<fo:leader leader-length="7.5cm" leader-pattern="rule" rule-style="solid" rule-thickness="0.1mm" color="black"/>--><fo:leader leader-pattern="space" leader-length="1mm"/>El número de cuotas y días de cargo de las cuotas, los determinará el Cliente al momento de solicitar el avance. Los impuestos, derechos o gastos que se devenguen con ocasión de cada avance generado, serán de cargo exclusivo del CLIENTE y formarán parte del crédito, el cual será distribuido dentro de las cuotas determinadas por el CLIENTE. El CLIENTE fija como día de cargo de las cuotas el día<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/diaCuentaCargo" /></fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/>de cada mes, pudiendo redefinir el día de cargo al momento de solicitar el avance.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">TERCERO:</fo:inline> En el caso de no estar vigente la cuenta o tarjeta de crédito de cargo, al momento del pago de la cuota de un avance, el CLIENTE deberá solicitar a la Sucursal una cuponera de crédito, para el pago de las cuotas pendientes.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">CUARTO:</fo:inline> El CLIENTE podrá solicitar el curse de avances a través de la página Web del BANCO, canal de atención telefónica, sucursal o cualquier otro canal que en el futuro disponga el BANCO para el uso de este producto. El CLIENTE libera de toda responsabilidad al BANCO en el caso que no se encuentre disponible u operativo alguno de estos canales.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">QUINTO:</fo:inline> El CLIENTE otorga mandato al BANCO o a quien éste último delegue, a fin de que a su nombre y representación, acepte letras de cambio, suscriba y/o complete pagarés, y reconozca deudas a beneficio del BANCO, por los montos en capital, intereses, costas, comisiones y demás gastos que se originen con motivo del o de los créditos que sean concedidos por el BANCO con ocasión de los curses de avances realizados a través del Bci Multicrédito. Este mandato tendrá plena aplicación aún el caso que el Bci Multicrédito ya no se encuentre vigente, pero exista saldo deudor con el BANCO por tal concepto. EL CLIENTE además, libera al BANCO de la obligación de rendir cuenta de su gestión. Declara el CLIENTE estar en conocimiento que no le es permitido revocar el presente mandato mercantil, por interesar su ejecución al BANCO mandatario. El presente mandato, en particular en lo concerniente a la facultad para suscribir y completar el pagaré, está concebido además, para ejecutarse después de la muerte del mandante con arreglo a lo previsto en el artículo 2.169 del Código Civil.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="right" >CONTINUA EN PÁGINA SIGUIENTE</fo:block>
                  </fo:flow>
            </fo:page-sequence>
            ...
            <fo:page-sequence master-reference="miCarta">
                  <fo:flow flow-name="xsl-region-body">
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">SEXTO:</fo:inline> El CLIENTE declara conocer y aceptar que existen recargos por concepto de la cobranza extrajudicial de créditos impagos, incluyendo honorarios a partir de la fecha que se indica más adelante, los cuales serán cobrados por la &quot;Compañía de Normalización de Créditos-Normaliza S.A.&quot; o por aquella que el BANCO designare en su oportunidad, la que actuará en nombre y en representación e interés del BANCO en las gestiones de cobranza extrajudicial.</fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm">La cobranza extrajudicial se efectuará en horario de 8:00 a 20:00 horas.</fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm">Declaro conocer, y desde luego acepto, que para que la Empresa designada al efecto pueda realizar la cobranza extrajudicial es imprescindible que el BANCO suministre a dicha empresa, antecedentes tanto respecto de los créditos morosos de sus deudores y otros que no estando en dicha condición estén asociados a éstos, como de los antecedentes comerciales de los deudores, tales como, nombres y apellidos, cédula nacional de identidad, rol único tributario, domicilios, direcciones y teléfonos, etcétera.</fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm">Los honorarios y gastos por las gestiones de cobranza ascenderán a los porcentajes que seguidamente se indican, aplicados sobre el total de la deuda o la cuota vencida según el caso, conforme a la siguiente escala progresiva: Obligaciones hasta 10 unidades de fomento, 9%, por la parte que exceda de 10 unidades de fomento y hasta 50 unidades de fomento, 6% y por la parte que exceda de 50 unidades de fomento, 3%. Los porcentajes indicados se aplicarán una vez transcurridos los primeros quince días de atraso.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm">Las tarifas anteriores podrán ser modificadas, siempre que tales cambios se avisen con una anticipación mínima de dos períodos de pago. Formalizo el presente instrumento considerando que las tarifas indicadas se basan en la fiel interpretación de la reglamentación legal vigente y en cumplimiento a lo dispuesto en la Ley 19.659 y demás normativa aplicable.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm"><fo:inline font-weight="bold">SEPTIMO:</fo:inline> El deudor podrá anticipar el pago de las obligaciones contraídas con arreglo al presente contrato, en forma total o parcial, debiendo pagar el capital más los intereses estipulados, hasta el vencimiento del plazo pactado a menos que el Banco renuncie parcial o totalmente a este plazo. Con todo, tratándose de una obligación cuyo importe en capital a la fecha de emisión del presente instrumento, fuere igual o inferior al equivalente en pesos moneda nacional de UF 5.000, el deudor deberá pagar el capital reajustado o no, según se hubiere pactado reajustabilidad más los intereses calculados hasta la fecha de pago efectivo y una comisión de prepago que ascenderá al valor de un mes de intereses (en operaciones no reajustables) o de un mes y medio de intereses (en operaciones reajustables), según la tasa de interés pactada, calculada sobre el capital que se prepaga en conformidad a lo establecido en el artículo 10 de la ley 18.010.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" line-height="4.5mm">EL CLIENTE declara aceptar todas las condiciones y parámetros definidos en este contrato.</fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                    <fo:block><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
