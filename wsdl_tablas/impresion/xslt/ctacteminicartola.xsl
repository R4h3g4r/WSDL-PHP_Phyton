...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src">
												<xsl:value-of select="minicartola/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
										<xsl:value-of select="minicartola/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
	...
	<xsl:template name="contenido">
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								<xsl:value-of select="minicartola/nombreCliente"/>
							</fo:block>
							<!-- nombre cliente -->
						</fo:table-cell>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
								...
								<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="minicartola/rutCliente"/></fo:inline>
							</fo:block>
							<!-- rut cliente -->
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row >
						...
						<fo:table-cell >
							...
							<fo:block font-size="10pt" text-align="right" color="{$txt}">
								...
								<fo:inline font-weight="bold"><xsl:value-of select="minicartola/nroCtaCte"/></fo:inline>
							</fo:block>
							<!-- nro tarjeta -->
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:block font-size="9pt" text-align="left" color="{$txt}">
			...
			<fo:inline font-weight="bold"><xsl:value-of select="minicartola/ejecutivo"/>&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;</fo:inline>
			<fo:inline font-weight="normal" space-before="30pt">Oficina: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="minicartola/oficinaEjecutivo"/></fo:inline>
		</fo:block>
		<!-- ejecutivo -->
		...
		<!-- ejecutivo -->
		<fo:block font-size="9pt" text-align="left" space-after="2mm">
			<fo:table table-layout="fixed">
					...
					<fo:table-row>
						<fo:table-cell padding-before="1mm">
							<fo:external-graphic height="1.2mm" width="1.2mm">
								<xsl:attribute name="src">
									<xsl:value-of select="mini-cartola/rutaImagen"/>01-bullet2-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="9pt" text-align="left" color="{$txt}">
								<fo:inline font-weight="normal" space-before="30pt">Ejecutivo:</fo:inline>
								<fo:inline font-weight="bold"><xsl:value-of select="mini-cartola/ejecutivoMinicartola"/>&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;</fo:inline>
								<fo:inline font-weight="normal" space-before="30pt">Oficina: </fo:inline>
								<fo:inline font-weight="bold"><xsl:value-of select="mini-cartola/oficinaMinicartola"/></fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
		...
		<!-- condicion mostrar detalle -->
		<xsl:choose>
		<xsl:when test="$detalle='S'">
		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<xsl:choose>
					<xsl:when test="count(minicartola/ultimos-18-movimientos) > 0">
						<xsl:for-each select="minicartola/ultimos-18-movimientos/movimiento">
						<fo:table-row>
		...
		<fo:block space-after="0.1mm">
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/saldoDisponible"/>
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/saldoContable"/>
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm"  font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/saldoContable9AM"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/retenciones"/>
						</fo:block>
					<!-- SUCURSAL -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/chequesYCargos"/>
						</fo:block>
					<!-- DIRECCION PARTICULAR -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/depositosYAbonos"/>
						</fo:block>
					<!-- FONO PARTICULAR -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/protestos"/>
						</fo:block>
					<!-- FONO COMERCIAL -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/aclaraciones"/>
						</fo:block>
					<!-- CELULAR -->
					</fo:table-cell>
		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<xsl:choose>
					<xsl:when test="count(minicartola/titulares) > 0">
						<xsl:for-each select="minicartola/titulares/titular">
						<fo:table-row>
							<fo:table-cell border="0.5pt solid {$lineas}">
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- BANCA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Otros Bancos con Presencia Plaza $:'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/otrosBancosConPresenciaPlaza"/>
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/retencionBci"/>
						</fo:block>
					<!-- SEGMENTO -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<!-- RENTA -->
						<fo:block font-size="{$size-fuente-margen}" text-align="left" color="{$txt}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Otros Bancos sin Presencia Plaza $:'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/otrosBancosSinPresenciaPlaza"/>
						</fo:block>
					<!-- RENTA -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/cajerosAutomaticos"/>
						</fo:block>
					<!-- SUCURSAL -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/disponibleLineaSobregiro"/>
						</fo:block>
					<!-- DIRECCION PARTICULAR -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/fechaApertura"/>
						</fo:block>
					<!-- FONO PARTICULAR -->
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/saldoPromActual"/>
						</fo:block>
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}" background-color="{$bgcolor}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/saldoPromAnterior"/>
						</fo:block>
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/totalDepTrimAct"/>
						</fo:block>
					</fo:table-cell>
		...
		<fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block font-size="9pt" padding-before="1mm" padding-after="1mm" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							<xsl:value-of select="minicartola/periodo"/>
						</fo:block>
					<!-- BANCA -->
					</fo:table-cell>
		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:choose>
					<xsl:when test="count(minicartola/detalle-cheques) > 0">
						<xsl:for-each select="minicartola/detalle-cheques/cheques">
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell padding-before="1mm">
							<fo:external-graphic height="1.2mm" width="1.2mm">
								<xsl:attribute name="src">
									<xsl:value-of select="minicartola/rutaImagen"/>01-bullet2-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
					...
					<fo:table-row>
						<fo:table-cell padding-left="2mm" padding-before="1mm" >
							<fo:external-graphic height="1mm" width="1mm">
								<xsl:attribute name="src">
									<xsl:value-of select="minicartola/rutaImagen"/>01-bullet1-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
