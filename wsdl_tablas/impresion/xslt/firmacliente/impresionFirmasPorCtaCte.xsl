...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format"	xmlns:xs="http://www.w3.org/2001/XMLSchema"	xmlns:fn="http://www.w3.org/2005/02/xpath-functions" xmlns:xdt="http://www.w3.org/2005/02/xpath-datatypes" xmlns:xf=" http://www.ecrion.com/xf/1.0 - http://www.ecrion.com/xf/1.0 ">
      <xsl:template match="ApoderadosCuenta">
      <fo:root>
		     ...
		     <fo:block>
				<fo:table font-size="7pt" table-layout="fixed" width="100%" >
					...
					<fo:table-body>
								...
								<fo:table>
					    			...
					    			<fo:table-row>
										<fo:table-cell text-align="start">
										  <fo:block font-weight="bold" font-size="12pt">Consulta Firma por Cuenta</fo:block>
										</fo:table-cell>
					  ...
					  <fo:table-row>
						<fo:table-cell text-align="start"  padding="1pt">
						  <fo:block font-weight="bold" >Cuenta : <xsl:value-of select="encabezado/numeroCuenta"/></fo:block>
						</fo:table-cell>
					  </fo:table-row>
					  <fo:table-row>
						<fo:table-cell text-align="start"  padding="1pt">
						  <fo:block font-weight="bold" >Rut Cliente : <xsl:value-of select="encabezado/rutCliente"/></fo:block>
						</fo:table-cell>
					  </fo:table-row>
					  <fo:table-row>
						<fo:table-cell text-align="start"  padding="1pt">
