							...
							<fo:table>
								...
								<fo:table-body>
									<fo:table-row height="20mm">
										<fo:table-cell display-align="center" padding-left="10mm" padding-right="2mm" background-color="#747578">
										...
										<fo:table-cell display-align="center" padding-left="2mm" padding-right="2mm" background-color="#747578">
											<fo:block border-right-width="0.5pt" text-align="left">
												<fo:external-graphic vertical-align="middle">
													<xsl:attribute name="src">
					                                <xsl:value-of select="urlImagenLogoPremier" />
					                            </xsl:attribute>
												</fo:external-graphic>
											</fo:block>
										</fo:table-cell>
