							...
							<fo:table>
								...
								<fo:table-body>
									<fo:table-row height="10mm">
										<fo:table-cell padding-left="2mm" padding-right="2mm" padding-top="5mm">
											<fo:block border-right-width="0.5pt" text-align="left" font-size="12pt">
												<fo:inline color="#8eadb7">Estimado(a) <xsl:value-of select="nombre" /></fo:inline>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding-left="2mm" padding-right="2mm">
											<fo:block border-right-width="0.5pt" text-align="left" vertical-align="middle">
												<fo:external-graphic>
													<xsl:attribute name="src">
					                                <xsl:value-of select="urlImagenLogoNova" />
					                            </xsl:attribute>
												</fo:external-graphic>
											</fo:block>
										</fo:table-cell>
									...
									<fo:table-row height="10mm">
										<fo:table-cell number-columns-spanned="2">
											<fo:block border-right-width="0.5pt" text-align="left" vertical-align="middle" font-size="9pt" space-before="5mm">
												<fo:external-graphic>
													<xsl:attribute name="src">
													...
													<fo:table-row font-size="12pt" text-align="justify">
														<fo:table-cell>
															<fo:block line-height="2">
																En Bci Nova estamos siempre comprometidos con informarlo de manera oportuna, ágil y segura. Es por eso que le confirmamos que con fecha
																...
																<fo:table width="170mm" border="0pt solid" display-align="center">
																	...
																	<fo:table-body>
																		...
																		<fo:table-row text-align="justify">
																			...
																			<fo:table-cell>
																				<fo:block>
																					Banco Bci Nova sólo pagará depósitos a plazo en su fecha de vencimiento.
																				</fo:block>
																			</fo:table-cell>
																		</fo:table-row>
											...
											<fo:table width="170mm" border="0pt solid" display-align="center" table-layout="fixed">
												...
												<fo:table-body>
													<fo:table-row font-size="12pt" text-align="justify">
														<fo:table-cell>
															<fo:block color="#8eadb7">
																Lo invitamos a seguir confiando en Bci e invirtiendo en Depósitos a Plazo u otros instrumentos de inversión cuyos detalles puede revisar visitando nuestra Red de Sucursales Bci Nova o en BciNova.cl. Para consultas, comuníquese con su Ejecutivo de Inversiones, llame al 600 824 24 24, opción 7 ó escriba a
																<fo:inline font-weight="bold">equipoinversiones@bci.cl</fo:inline>
															</fo:block>
															<fo:block space-before="10mm" color="#8eadb7">
