...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xhtml="http://www.w3.org/1999/xhtml" exclude-result-prefixes="xhtml">
  <xsl:variable name="bgcolordestacado">#B8CCE4</xsl:variable>
  <xsl:variable name="bordercolordestacado">#0000FF</xsl:variable>
  <xsl:variable name="colortextodestacado">#0000FF</xsl:variable>
  <xsl:variable name="borderwidth">0.3pt</xsl:variable>
...
<xsl:template match="/">
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xml.apache.org/fop/extensions">
      <fo:layout-master-set>
        <fo:simple-page-master margin-right="1.29cm" margin-left="1.30cm" margin-bottom="0.97cm"
          margin-top="0.97cm" font-size="8pt" page-width="21.59cm" page-height="27.94cm" master-name="principal">
          <fo:region-body margin-bottom="1.5cm" margin-top="1cm" />
          <fo:region-before extent="10cm" />
          <fo:region-after extent="6cm" />
        </fo:simple-page-master>
      </fo:layout-master-set>
      <fo:page-sequence master-reference="principal" language="en" hyphenate="true">
          ...
          <fo:block font-size="8pt">
            <fo:table table-layout="fixed">
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell>
                    <fo:external-graphic content-width="30.96mm" vertical-align="middle" height="2cm">
                      <xsl:attribute name="src"><xsl:value-of select="cotizacion/ruta-imagen" />logo_bci_460x250.jpg
											</xsl:attribute>
                    </fo:external-graphic>
                  </fo:table-cell>
                  <fo:table-cell>
                    <fo:block vertical-align="middle">
                      <fo:table table-layout="fixed">
                        ...
                        <fo:table-body>
                          <fo:table-row>
                            <fo:table-cell>
                              <fo:block color="{$colortextodestacado}">Oficina:</fo:block>
                            </fo:table-cell>
                            <fo:table-cell>
                              <fo:block color="{$colortextodestacado}">
                                <xsl:value-of select="/root/cotizacion/datos-cabecera/oficina" />
                              </fo:block>
                            </fo:table-cell>
                          </fo:table-row>
                          <fo:table-row>
                            <fo:table-cell>
                              <fo:block color="{$colortextodestacado}">Ejecutivo:</fo:block>
                            </fo:table-cell>
                            <fo:table-cell>
                              <fo:block color="{$colortextodestacado}">
                                <xsl:value-of select="/root/cotizacion/datos-cabecera/ejecutivo" />
                              </fo:block>
                            </fo:table-cell>
                          </fo:table-row>
                          <fo:table-row>
                            <fo:table-cell>
                              <fo:block color="{$colortextodestacado}">Fecha de simulación:</fo:block>
                            </fo:table-cell>
                            <fo:table-cell>
                              <fo:block color="{$colortextodestacado}">
                                <xsl:value-of select="/root/cotizacion/datos-cabecera/fecha-cotizacion" />
                              </fo:block>
                            </fo:table-cell>
                          </fo:table-row>
                        </fo:table-body>
        ...
        <fo:static-content flow-name="xsl-region-after">
          <fo:block font-size="6pt" space-before="0.5cm" space-after="2.5mm">
            <xsl:for-each select="/root/cotizacion/textos-legales/texto">
              <fo:block>
                <xsl:value-of select="." />
              </fo:block>
            </xsl:for-each>
          </fo:block>
          <fo:block font-size="6pt" space-before="2.5mm" space-after="2.5mm">
            <xsl:for-each select="/root/cotizacion/textos-productos/texto">
              <fo:block>
                <xsl:value-of select="." />
              </fo:block>
            </xsl:for-each>
          ...
          <fo:block font-size="6pt" space-before="2.5mm" space-after="2.5mm">
            <xsl:for-each select="/root/cotizacion/textos-descuentos/texto">
              <fo:block>
                <xsl:value-of select="." />
              </fo:block>
            </xsl:for-each>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-size="8pt">
            <xsl:call-template name="titulo1" />
            <xsl:if test="count(/root/cotizacion/productos-individuales-contratados) > 0">
              <xsl:call-template name="productos-individuales-contratados" />
            </xsl:if>
            
            <xsl:if test="count(/root/cotizacion/plan-contratado-vigente) > 0">
              <xsl:call-template name="plan-contratado-vigente" />
            </xsl:if>
            
            <xsl:if test="count(/root/cotizacion/plan-contratado-antiguo) > 0">
              <xsl:call-template name="plan-contratado-antiguo" />
            </xsl:if>
            
            <xsl:if test="count(/root/cotizacion/incorpora-nuevos-Productos) > 0">
              <xsl:call-template name="incorpora-nuevos-Productos" />
            </xsl:if>
            
            <xsl:if test="count(/root/cotizacion/solicita-productos-individuales) > 0">
              <xsl:call-template name="solicita-productos-individuales" />
            </xsl:if>
            
            <xsl:if test="count(/root/cotizacion/plan-principal) > 0">
              <xsl:call-template name="plan-principal" />
            </xsl:if>
            
            <xsl:if test="count(/root/cotizacion/planes-secundarios) > 0">
              <xsl:call-template name="titulo2" /> 
              <xsl:call-template name="planes-secundarios" />
            </xsl:if>
           	    
          </fo:block>
	  
	   <fo:block break-after="page" font-size="8pt"/>
  ...
  <xsl:template name="titulo1">
    <fo:block>
      <fo:block color="{$colortextodestacado}" text-align="center" space-before="2cm" space-after="5mm">
        SIMULACIÓN DE PLAN DE CUENTA CORRIENTE Y PRODUCTOS INDIVIDUALES
      </fo:block>
    </fo:block>
  </xsl:template>
  <xsl:template name="titulo2">
    <fo:block>
      <fo:block color="{$colortextodestacado}" text-align="center" space-before="1cm" space-after="5mm">
        OFERTAS DE PLANES
      </fo:block>
    </fo:block>
  </xsl:template>
  <xsl:template name="productos-individuales-contratados">
    <fo:block>
      <fo:table table-layout="fixed" space-after="5mm">
        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell background-color="{$bgcolordestacado}" padding-before="0.1cm" padding-after="0.1cm"
              border="{$borderwidth} solid {$bordercolordestacado}" color="{$colortextodestacado}">
              <fo:block>&#0160; Contratado actualmente en BCI</fo:block>
            </fo:table-cell>
            <fo:table-cell number-columns-spanned="2" border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block />
            </fo:table-cell>
          </fo:table-row>
          <xsl:for-each select="/root/cotizacion/productos-individuales-contratados/producto">
            <fo:table-row>
              <fo:table-cell  padding-before="0.1cm" padding-after="0.1cm" number-columns-spanned="2" border-left="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
              ...
              <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" border-right="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                </fo:block>
              </fo:table-cell>
          ...
          <fo:table-row>
            <fo:table-cell  number-columns-spanned="3" border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block>
              </fo:block>
            </fo:table-cell>
          </fo:table-row>
  ...
  <xsl:template name="plan-contratado-vigente">
    <fo:block>
      <fo:table table-layout="fixed" space-after="5mm">
        <fo:table-column column-width="5cm"  />
        <fo:table-column column-width="4cm" />
        ...
        <fo:table-body>
          <fo:table-row>
            ...
            <fo:table-row>
              <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" border-left="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                  <xsl:value-of select="/root/cotizacion/plan-contratado-vigente/nombrePlan" />
                  &#0160;
                </fo:block>
              </fo:table-cell>
              <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" number-columns-spanned="2"  border-right="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                  <xsl:value-of select="/root/cotizacion/plan-contratado-vigente/costoPlan" />
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
            <fo:table-row>
              <fo:table-cell  padding-before="0.1cm" padding-after="0.1cm" number-columns-spanned="3" border-left="{$borderwidth} solid {$bordercolordestacado}" border-right="{$borderwidth} solid {$bordercolordestacado}" >
                <fo:block>
                  &#0160;
                  <xsl:value-of select="/root/cotizacion/plan-contratado-vigente/glosaProductos" />
                  &#0160;
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
  ...
  <xsl:template name="plan-contratado-antiguo">
    <fo:block>
      <fo:table table-layout="fixed" space-after="5mm">
        <fo:table-column column-width="5cm"  />
        <fo:table-column column-width="4cm" />
          ...
          <fo:table-row>
            ...
            <fo:table-row>
              <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" border-left="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                  <xsl:value-of select="/root/cotizacion/plan-contratado-antiguo/nombrePlan" />
                  &#0160;
                </fo:block>
              </fo:table-cell>
              <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" number-columns-spanned="2"  border-right="{$borderwidth} solid {$bordercolordestacado}">
  ...
  <xsl:template name="incorpora-nuevos-Productos">
    <fo:block>
      <fo:table table-layout="fixed" space-after="5mm">
        <fo:table-column column-width="5cm"  />
        <fo:table-column column-width="4cm" />
        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell background-color="{$bgcolordestacado}" padding-before="0.1cm" padding-after="0.1cm"
              border="{$borderwidth} solid {$bordercolordestacado}" color="{$colortextodestacado}">
              <fo:block>&#0160; Nuevos Productos</fo:block>
            </fo:table-cell>
            <fo:table-cell number-columns-spanned="2" border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block />
            </fo:table-cell>
            ...
            <fo:table-row>
              <fo:table-cell number-columns-spanned="3" padding-before="0.1cm" padding-after="0.1cm" border-right="{$borderwidth} solid {$bordercolordestacado}" border-left="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                  <xsl:value-of select="/root/cotizacion/incorpora-nuevos-Productos/glosaNuevosProductos" />
                  &#0160;
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
  ...
  <xsl:template name="solicita-productos-individuales">
    <fo:block>
      <fo:table table-layout="fixed" space-after="5mm">
        <fo:table-column column-width="5cm" />
        <fo:table-column column-width="4cm" />
        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell background-color="{$bgcolordestacado}" padding-before="0.1cm" padding-after="0.1cm"
              border="{$borderwidth} solid {$bordercolordestacado}" color="{$colortextodestacado}">
              <fo:block>&#0160; Productos Individuales </fo:block>
            </fo:table-cell>
            <fo:table-cell number-columns-spanned="2" border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block />
            </fo:table-cell>
          </fo:table-row>
          <xsl:for-each select="/root/cotizacion/solicita-productos-individuales/producto">
            <fo:table-row>
              <fo:table-cell  padding-before="0.1cm" padding-after="0.1cm" number-columns-spanned="2" border-left="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
  ...
  <xsl:template name="plan-principal">
    <fo:block>
      <fo:table table-layout="fixed" space-after="5mm">
        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm"  number-columns-spanned="2" background-color="{$bgcolordestacado}"
              border="{$borderwidth} solid {$bordercolordestacado}" color="{$colortextodestacado}">
              <fo:block>
                &#0160;
                <xsl:value-of select="/root/cotizacion/plan-principal/nombre" />
              </fo:block>
            </fo:table-cell>
            <fo:table-cell border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block />
            </fo:table-cell>
          </fo:table-row>
          <fo:table-row>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm"  border-left="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block>&#0160;Incluye:</fo:block>
            </fo:table-cell>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm"  number-columns-spanned="2"
              border-right="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block>
                <xsl:value-of select="/root/cotizacion/plan-principal/detalle" />
              </fo:block>
            </fo:table-cell>
          </fo:table-row>
          <fo:table-row>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm"  border-left="{$borderwidth} solid {$bordercolordestacado}"
              border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block>&#0160;Costo:</fo:block>
            </fo:table-cell>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm"  number-columns-spanned="2" border-right="{$borderwidth} solid {$bordercolordestacado}"
              border-bottom="{$borderwidth} solid {$bordercolordestacado}">
              <fo:block>
                <xsl:value-of select="/root/cotizacion/plan-principal/costo" />
              </fo:block>
            </fo:table-cell>
          </fo:table-row>
        </fo:table-body>
  ...
  <xsl:template name="planes-secundarios">
    <fo:block>
      <fo:table table-layout="fixed" space-before="5mm">
        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm"  background-color="{$bgcolordestacado}"
              border="{$borderwidth} solid {$bordercolordestacado}" color="{$colortextodestacado}"
              text-align="center">
              <fo:block>Oferta de Planes </fo:block>
            </fo:table-cell>
            <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" color="{$colortextodestacado}" border="{$borderwidth} solid {$bordercolordestacado}"
              text-align="center">
              <fo:block>Costo Mantención</fo:block>
            </fo:table-cell>
          </fo:table-row>
          <xsl:for-each select="/root/cotizacion/planes-secundarios/producto">
            <fo:table-row>
              <fo:table-cell padding-before="0.1cm" padding-after="0.1cm" border="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                  <xsl:value-of select="nombre" />
                  &#0160;
              ...
              <fo:table-cell text-align="center" padding-before="0.1cm" padding-after="0.1cm"  border="{$borderwidth} solid {$bordercolordestacado}">
                <fo:block>
                  &#0160;
                  <xsl:value-of select="costo-real" />
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
          </xsl:for-each>
...
<xsl:template match="table">
  <xsl:apply-templates select="caption"/>
  <fo:table width="100%" table-layout="fixed" space-before="5mm"><xsl:call-template name="common-atts"/>
    <xsl:apply-templates select="colgroup|col"/>
...
<xsl:template match="xhtml:th|th">
  <fo:table-cell margin-left="0.1cm"  font-size="8pt"  background-color="{$bgcolordestacado}" padding-before="0.1cm" padding-after="0.1cm"
              border="{$borderwidth} solid {$bordercolordestacado}" color="{$colortextodestacado}"><xsl:call-template name="common-atts"/>
    <xsl:if test="@colspan">
...
<xsl:template match="xhtml:td|td">
  <fo:table-cell font-size="8pt" padding-after="0.1cm" padding-before="0.1cm"  border="{$borderwidth} solid {$bordercolordestacado}"><xsl:call-template name="common-atts"/>
    <xsl:if test="@colspan">
      <xsl:attribute name="number-columns-spanned">&#0160; <xsl:value-of select="@colspan"/></xsl:attribute>
    </xsl:if>
    <xsl:if test="@rowspan">
...
<xsl:template match="xhtml:h5|h5">
  <fo:block color="{$colortextodestacado}" text-align="center" space-before="1cm" space-after="5mm" font-size="8pt">
    <xsl:apply-templates/>
  </fo:block>
</xsl:template>
