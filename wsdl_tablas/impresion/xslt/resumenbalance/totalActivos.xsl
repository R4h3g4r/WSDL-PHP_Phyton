							...
							<fo:table-body>
								<fo:table-row>
										...
										<fo:block background-color="#F0F0F0">
											<fo:inline  font-weight="bold"  start-indent="4pt" text-align="left">Total Activos:</fo:inline>	
										</fo:block>
									   </fo:table-cell>  
									   <fo:table-cell  text-align="right">
										<fo:block background-color="#F0F0F0">
											<fo:inline  font-weight="bold"  start-indent="4pt" text-align="left"><xsl:value-of select="resumenBalance/EnvoltorioBalance/actTotalActivos" /></fo:inline>
										</fo:block>
									   </fo:table-cell> 									    
								</fo:table-row>								
							</fo:table-body>
