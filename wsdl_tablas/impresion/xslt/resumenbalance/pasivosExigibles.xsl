								...
								<fo:table-row>
									<fo:table-cell padding="2pt">
										<fo:block text-align="left">
											<fo:inline start-indent="4pt"  font-weight="bold">TOTAL PASIVOS EXIGIBLES</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>	
							</fo:table-body>
							...
							<fo:table-body>
								<fo:table-row>
										...
										<fo:block background-color="#F0F0F0">
											<fo:inline start-indent="4pt">Total Pasivos Exigibles: </fo:inline>	
										</fo:block>
									   </fo:table-cell>  
									   <fo:table-cell text-align="right">
										<fo:block background-color="#F0F0F0">
											<fo:inline start-indent="4pt"><xsl:value-of select='resumenBalance/EnvoltorioBalance/pasPasivoExigible' /></fo:inline>
										</fo:block>
									   </fo:table-cell> 									    
								</fo:table-row>										
							</fo:table-body>
