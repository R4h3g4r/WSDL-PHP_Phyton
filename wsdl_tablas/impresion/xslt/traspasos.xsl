...
<!-- Separador -->
		...
		<xsl:call-template name="subTitulo">
			<xsl:with-param name="titulo" select="'Traspaso Programado de Fondos'"/>
		</xsl:call-template>
...
<fo:table-column column-width="4cm" />
	...
	<xsl:for-each select="info/detalleTraspaso/detalle-traspaso">
