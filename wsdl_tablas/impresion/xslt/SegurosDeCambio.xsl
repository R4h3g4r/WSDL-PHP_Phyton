							...
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="11pt">
									<fo:block text-align="justify" line-height="15pt">
										...
										todos domiciliados en esta ciudad <fo:inline><xsl:apply-templates select="domicilioCliente" /></fo:inline>, en adelante "Cliente", se ha convenido el 
							...
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="11pt">
									...
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">
										...
										de arbitraje a futuro cuyo cumplimiento se pacte por compensación, se entiende la cantidad de Moneda Nacional, que resulte de multiplicar las siguientes 
									...
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">	
										...
										Dólares que corresponda a la otra Moneda Extranjera prevista en este Contrato, según la Paridad Referencial vigente en Fecha de Pago o de la de Liquidación Anticipada, según corresponda. 
									</fo:block>
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">
					...
					<fo:table font-size="10pt" font-family="serif" space-before.optimum="1pt" space-after.optimum="1pt">
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="11pt">
									<fo:block  text-align="justify" line-height="15pt">
										En la operación de compraventa a futuro de Moneda Extranjera, el vendedor se compromete a entregar la Moneda Extranjera 
