...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
   ...
   <!-- <xsl:param name="IMG_URL"/> -->
    ...
    <xsl:template match="Certificado_PrepagoParcial">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="miCarta" page-height="11.000in" page-width="8.500in" margin-top="20.000px" margin-bottom="90.000px" margin-right="5.000px" margin-left="5.000px">
              ...
              <fo:table-cell text-align="center" padding-top="5pt" padding-left="15pt" padding-right="10pt" padding-bottom="15pt">
                                ...
                                <fo:table-cell text-align="start">
                                  <fo:block>
                                    <fo:table>
                                      ...
                                      <fo:table-column column-width="11%" column-number="10"/>
                                      <fo:table-header>
		       ...
		       <fo:inline font-weight="bold">&#x00A0;</fo:inline>    
                ...
                <fo:block color="rgb(0,0,0)" text-align="justify" margin-bottom="8pt" font-size="9pt" font-family="Helvetica"> 
                    <fo:block text-align="justify" color="rgb(0,0,0)">
                ...
                <fo:block color="rgb(0,0,0)" text-align="justify" margin-bottom="8pt" font-size="9pt" font-family="Helvetica"> 
                    <fo:block text-align="left" color="rgb(0,0,0)">
                       <fo:inline><xsl:value-of select="textolegalmedia"/></fo:inline>
                    </fo:block>
                </fo:block>                  
                <fo:block color="rgb(0,0,0)" text-align="justify" margin-bottom="8pt" font-size="9pt" font-family="Helvetica"> 
                    <fo:block text-align="left" color="rgb(0,0,0)">
