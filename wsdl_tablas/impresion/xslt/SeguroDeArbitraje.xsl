							...
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="11pt">
									<fo:block text-align="justify" line-height="15pt">
										...
										, entre, por una parte, <fo:inline><xsl:apply-templates select="glosaBanco" /></fo:inline>,  
										R.U.T.<fo:inline><xsl:apply-templates	select="rutBanco" /></fo:inline>, representado por la(s)
										persona(s) que suscribe(n) y se individualiza(n) al final,todos domiciliados en esta ciudad,
										<fo:inline><xsl:apply-templates select="domicilioBanco" /></fo:inline>, 
										en adelante "Banco" y, por la otra, <fo:inline><xsl:apply-templates select="nombreCliente" /></fo:inline>
										<xsl:text>&#160;</xsl:text><xsl:text>&#160;</xsl:text><fo:inline> R.U.T <xsl:apply-templates select="rutCliente"/></fo:inline>, 
										representado por la(s) persona(s) que se suscribe(n) y se individualiza(n) al final, todos domiciliados
										en esta ciudad, Direccion, <fo:inline><xsl:apply-templates select=" ciudad" /></fo:inline>, 
										en adelante "Cliente", se ha convenido el Contrato Forward que más adelante se indica, el cual se
										regirá por las Condiciones generales de Contratos de Derivados en el	Mercado Local suscrito y vigente
										entre ambas partes,documento que, para todos los efectos, se entiende formar parte integrante del presente instrumento:
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="11pt">
									...
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">	
										b) Por Precio Pactado se entiende la cantidad en pesos moneda corriente nacional, de Unidades de Fomento o de Dólares fijada por las partes como precio
										 de compra de la cantidad de moneda Extranjera objeto de venta en este Contrato. 
									</fo:block>
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">	
										c) Precio Referencial de Mercado para las operaciones de compraventa de moneda extranjera dólar de los Estados Unidos de América, se entiende la cantidad en pesos, 
										moneda corriente nacional, resultante de multiplicar el Tipo de Cambio Referencial estipulado en el Contrato, vigente a la Fecha de Pago o Liquidación Anticipada, según corresponda,
										 por el monto de la Moneda Extranjera objeto de este Contrato. 
									</fo:block>
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">
										d) Por Precio Referencial de Mercado para las operaciones de compraventa de Moneda Extranjera distinta al Dólar o para las operaciones de arbitraje 
										a futuro cuyo cumplimiento se pacte por compensación, se entiende la cantidad de Moneda Nacional, que resulte de multiplicar las siguientes dos cantidades: (i) la cantidad 
										de Dólares que corresponde al monto total de la otra Moneda Extranjera prevista en este Contrato, según la Paridad Referencial, (ii) por el tipo de Cambio Referencial estipulado por 
										las partes vigentes a la Fecha de Pago o de Liquidación Anticipada, según corresponda. 
									</fo:block >
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">	
										e) Por Precio Referencial de Mercado para las operaciones de arbitraje a futuro, cuyo cumplimiento se pacte por entrega, se entiende la cantidad de Dólares que 
										corresponda a la otra Moneda Extranjera prevista en este Contrato, según la Paridad Referencial vigente en la fecha de pago o de Liquidación Anticipada, según corresponda. 
									</fo:block>
									<fo:block text-align="justify" line-height="15pt" padding-after="10pt">
										f) Por Tipo de Cambio de Contrato se entiende la cantidad de pesos, moneda corriente nacional, o de Unidades de Fomento, necesarias para comprar una unidad de 
										moneda extranjera, al valor estipulado por las partes en los respectivos Contratos. 
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
					...
					<fo:table-column column-width="10.5cm"/>
						<fo:table-body>
							<fo:table-row>
								...
								<fo:table-cell padding="1mm" padding-before="10pt">
									<fo:block text-align="left">
										<fo:inline>:<xsl:apply-templates select="tipTransc"/></fo:inline>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="6pt">
									<fo:block text-align="left">
										<fo:inline>2. Fecha de Pago </fo:inline>
									</fo:block> 	
								</fo:table-cell>
								<fo:table-cell padding="1mm" padding-before="10pt">
									<fo:block text-align="left">
							...
							<fo:table-row>
								...
								<fo:table-cell padding="1mm" padding-before="10pt">
									<fo:block text-align="left">
										<fo:inline>:<xsl:apply-templates select="tipoCambioContrato"/></fo:inline>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell padding="1mm" padding-before="10pt">
									<fo:block text-align="left">
										<fo:inline>:<xsl:apply-templates select="precioPactado"/></fo:inline>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
					...
					<fo:table font-size="10pt" font-family="serif" space-before.optimum="1pt" space-after.optimum="1pt">
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell padding="1mm" padding-before="11pt">
									<fo:block  text-align="justify" line-height="15pt">
										En la operación de compraventa a futuro de Moneda Extranjera, el vendedor se compromete a entregar la Moneda Extranjera vendida
										 y el comprador a pagar el precio convenido, en pesos moneda corriente nacional o en Unidades de Fomento,
									...
									<fo:block ext-align="justify" line-height="15pt">	
										En todo caso, si la modalidad de cumplimiento de un Contrato fuere la compensación, se aplicará lo previsto en la sección 
										IV siguiente, párrafo ii). 
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell>
									<fo:block  padding-before="15pt" padding-after="10pt">
										El comprador y el vendedor deberán cumplir este Contrato en la Fecha de Pago de acuerdo a la modalidad 
										prevista en la sección II precedente, pudiendo ser alguna de las que se indican
										 a continuación: 
									</fo:block>
									...
									<fo:block padding-after="10pt">	
										...
										Pactado y el Precio Referencial de Mercado acordado por las partes, vigente a la Fecha de Pago de este 
							...
							<fo:table-row>
								<fo:table-cell>
									<fo:block  padding-before="15pt" padding-after="15pt">
										El presente contrato se firma en dos ejemplares de idéntico tenor y fecha, quedando uno en poder de 
										cada parte. A menos que se exprese lo contrario en este instrumento, los términos en mayúsculas tendrán 
										el significado que para ellos se señala en las Condiciones Generales 
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
