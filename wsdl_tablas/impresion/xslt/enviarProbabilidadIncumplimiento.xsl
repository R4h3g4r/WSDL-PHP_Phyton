		...
		<fo:block>
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">Envío de Probabilidad de Incumplimiento (PI)</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
				...
				<fo:table-body>
					<fo:table-row>
						...
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block text-align="left" font-weight="bold" font-size="8pt" space-before="{$espacio-texto-celda-top}">
								<fo:inline color="{$txt-azul-oscuro}">
									<xsl:value-of select="/info/pIUno"/>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block text-align="left" font-weight="bold" font-size="8pt" space-before="{$espacio-texto-celda-top}">
								<fo:inline color="{$txt-azul-oscuro}">
									<xsl:value-of select="/info/pICinco"/>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block text-align="left" font-weight="bold" font-size="9pt" space-before="{$espacio-texto-celda-top}">
								<fo:inline color="{$txt-azul-oscuro}">
									<xsl:value-of select="/info/claPorModelo"/>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolor}">
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Contribución Relativa :</fo:inline>
								<fo:inline font-size="9pt" font-weight="normal">Valores Relativos contribuyen a disminuir el riesgo, variables con valores </fo:inline>
								<fo:block text-align="center" font-weight="normal">positivos incrementan el riesgo.</fo:block>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
