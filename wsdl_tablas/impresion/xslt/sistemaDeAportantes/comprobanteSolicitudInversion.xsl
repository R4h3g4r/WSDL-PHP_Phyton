...
usted prefiera optar por la custodia de estos por parte de la Sociedad Administradora.
		...
		<fo:block padding-before="3mm" text-align="justify" font-size="10pt">
			...
			y que respecto al régimen tributario al que desea acoger las cuotas 		
		
			<xsl:if test="sistemaDeAportantes/documento/op57Bis = 'X'"> 
					se aplicará
			</xsl:if>
			<xsl:if test="sistemaDeAportantes/documento/claus57Bis = 'X'"> 
					no se aplicará
			</xsl:if>
			el beneficio tributario del artículo 57 bis de la ley de 
			Impuesto a la Renta.
		</fo:block>
...
<metaInformation>
<scenarios ><scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\sistemaDeAportantes" htmlbaseurl="" outputurl="" processortype="internal" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator=""/></scenarios><MapperMetaTag><MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/><MapperBlockPosition></MapperBlockPosition><TemplateContext></TemplateContext><MapperFilter side="source"></MapperFilter></MapperMetaTag>
</metaInformation>
-->