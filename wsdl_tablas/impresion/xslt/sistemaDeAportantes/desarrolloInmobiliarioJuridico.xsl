...
<fo:inline font-weight="bold">&#x201C;<xsl:value-of select="sistemaDeAportantes/contrato/nombreCortoFilial"/>&#x201D;</fo:inline>, por una parte, y, por la otra, la sociedad
...
expresan en Cuotas de Participación, en adelante también como las <fo:inline font-weight="bold">&#x201C;Cuotas&#x201D;</fo:inline>, nominativas, unitarias, de
...
<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						...
						<fo:table-cell>
						<fo:block>
							A) <fo:inline text-decoration="underline">Remuneración Fija.</fo:inline>
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
...
<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						...
						<fo:table-cell>
						<fo:block>
							B) <fo:inline text-decoration="underline">Remuneración Variable</fo:inline>.
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						...
						<fo:table-cell>
						<fo:block>
							A) <fo:inline text-decoration="underline">Gastos Ordinarios:</fo:inline>
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
		...
		<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						...
						<fo:table-cell>
						<fo:block>
B) <fo:inline text-decoration="underline">Gastos Extraordinarios:</fo:inline>
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
		...
		<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						...
						<fo:table-cell>
						<fo:block>
C) <fo:inline text-decoration="underline">Gastos de liquidación del Fondo</fo:inline>, incluida la remuneración del liquidador.
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
