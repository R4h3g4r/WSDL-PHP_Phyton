...
<fo:table table-layout="fixed">
				...
				<fo:table-body>					
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block text-align="left" padding-before="5mm">
							: <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/calleApoderado2"/> - <xsl:value-of select="sistemaDeAportantes/contrato/numCalleApoderado2"/></fo:inline>
							</fo:block>
						</fo:table-cell>								
					</fo:table-row>
					<fo:table-row>
