...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="encabezado">
		...
		<fo:block font-size="14pt" text-align="center" font-weight="bold" padding-before="5mm" text-decoration="underline">
	...
	<xsl:template name="cuerpo">
		...
		En Santiago de Chile, a <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/dia"/></fo:inline> 
		de <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/mes"/></fo:inline> de <xsl:value-of select="sistemaDeAportantes/contrato/anio"/>, entre &#x201C;BCI Administradora General de
...
domicilio para estos efectos en <xsl:value-of select="sistemaDeAportantes/contrato/ciudadRep"/>, <xsl:value-of select="sistemaDeAportantes/contrato/direccionRep"/>, 
<xsl:value-of select="sistemaDeAportantes/contrato/comunaRep"/>, en adelante también como la
&#x201C;<xsl:value-of select="sistemaDeAportantes/contrato/nombreCortoFilial"/>&#x201D;, por una parte, y, por la otra, la sociedad
<fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/nombreCliente"/></fo:inline>, Rol Único Tributario número
<fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/rutCliente"/></fo:inline>, representada por don/doña
<fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/nombreApoderado"/></fo:inline>, nacionalidad <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/nacionalidadApoderado"/></fo:inline>,
estado civil <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/estadoCivilApoderado"/></fo:inline>, 
profesión u oficio <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/profesionApoderado"/></fo:inline>, cédula nacional
de identidad número <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/rutApoderado"/></fo:inline>, con domicilio para estos efectos en la ciudad
<fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/ciudadApoderado"/></fo:inline>, comuna de <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/comunaApoderado"/></fo:inline>, 
calle <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/calleApoderado"/></fo:inline>, Nº <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/numCalleApoderado"/></fo:inline>
;en adelante también como el &#x201C;Aportante&#x201D; se ha convenido el siguiente contrato de suscripción de cuotas, en adelante
también como el &#x201C;Contrato&#x201D;:
		</fo:block>
...
igual valor y características, que no pueden ser rescatadas antes de la liquidación del Fondo.
		...
		<fo:block padding-before="3mm" text-align="justify">
<fo:inline font-weight="bold" text-decoration="underline">CUARTO:</fo:inline> Por este acto, el Aportante suscribe la cantidad de <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/cantCuotas"/></fo:inline> 
Cuotas del Fondo, del total de Cuotas que se acordó emitir, suscripción que es aceptada por el representante de la Sociedad
Administradora.
		</fo:block>
...
la décimo octava notaría de Santiago de don Patricio Zaldívar Mackenna. La personería de don/doña
___________________________________________ para actuar como representante legal de la sociedad
consta en ____________________________________________
la cual se inserta a la presente.
		</fo:block>
...
BCI Administradora General de Fondos S.A.
		...
		<fo:block padding-before="1cm" text-align="justify"  font-weight="bold">
Aportante persona jurídica: <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/nombreCliente"/></fo:inline>
</fo:block>
		
		<fo:block padding-before="7mm" text-align="left">
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						<fo:table-cell>
						<fo:block  font-weight="bold">Apoderado
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
						<fo:block  font-weight="bold"> 1
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
						<fo:block  font-weight="bold">Apoderado
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>					
					...
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block text-align="left" padding-before="5mm">
							: <fo:inline text-decoration="underline"><xsl:value-of select="sistemaDeAportantes/contrato/calleApoderado"/> - <xsl:value-of select="sistemaDeAportantes/contrato/numCalleApoderado"/></fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
						<fo:block text-align="left" padding-before="5mm">
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>								
						<fo:table-cell>
						<fo:block padding-before="2cm" text-align="center">
						________________________________
							</fo:block>
