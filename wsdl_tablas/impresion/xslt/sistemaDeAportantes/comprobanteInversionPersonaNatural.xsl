...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="cuerpo">
		...
		<fo:block padding-before="7mm" text-align="left" font-size="10pt">
		Estimado Aportante :
		</fo:block>
...
usted prefiera optar por la custodia de estos por parte de la Sociedad Administradora.
		...
		<fo:block padding-before="1mm" text-align="justify" font-size="10pt">
			<fo:table table-layout="fixed">
				<fo:table-column column-width="2cm"/>
				<fo:table-column column-width="2cm"/>
				<fo:table-column column-width="15cm"/>
...
adquiridos.
		...
		<fo:block padding-before="3mm" text-align="justify" font-size="10pt">
		Favor indicar su elección respecto del régimen tributario al que desea acoger las Cuotas:
		</fo:block>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>					
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block text-align="center">
							<xsl:value-of select="sistemaDeAportantes/documento/op57Bis"/>
							</fo:block>
						</fo:table-cell>	
						<fo:table-cell>
							<fo:block text-align="left">
							Instrumento o valor de ahorro acogido a la letra A del artículo 57 bis de la Ley de Impuesto a la
Renta, con derecho a rebajar impuestos al ahorrar y con la obligación de reintegrar impuestos
cuando corresponda, por las cantidades retiradas por las cifras o saldos de ahorro netos
negativos o determinados.
							</fo:block>
						</fo:table-cell>					
					</fo:table-row>
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block text-align="center" padding-before="-15mm">
							_______
							</fo:block>
						</fo:table-cell>	
						<fo:table-cell>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>					
					<fo:table-row>	
						...
						<fo:table-cell>
							<fo:block text-align="center">
							<xsl:value-of select="sistemaDeAportantes/documento/clau57Bis"/> 
							</fo:block>
						</fo:table-cell>	
						<fo:table-cell>
							<fo:block text-align="left">
							No aplicaré beneficio tributario del artículo 57 bis de la Ley de Impuesto a la Renta.
							</fo:block>
						</fo:table-cell>					
					</fo:table-row>		
					<fo:table-row>	
		...
		<fo:block padding-before="1.5cm" text-align="justify" font-size="10pt">
			<fo:table table-layout="fixed">
