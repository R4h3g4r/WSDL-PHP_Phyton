        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
           ...
           <fo:flow flow-name="xsl-region-body" font-size="10pt" font-family="Helvetica">
            ...
            <fo:table border-collapse="collapse" text-align="right">
                          ...
                          <fo:table-cell text-align="left">
                                  <fo:block >
                                    <fo:external-graphic height="15mm" width="30mm" vertical-align="middle">
                                      ...
                                      <xsl:value-of select="OperacionCredito/logoBciCanal"/>
                                      </xsl:attribute>
                                    </fo:external-graphic>
                                  </fo:block>
                          </fo:table-cell>
              ...
              <fo:block font-family="Helvetica" line-height="4.5mm" font-size="11pt" text-align="justify" >Yo:<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/nombreCompletoAval" /></fo:inline></fo:block>
              <xsl:if test="OperacionCredito/moneda != '$'">
                      <fo:block font-family="Helvetica" line-height="4.5mm" font-size="11pt" text-align="left" >C.I. N°:<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select='format-number(OperacionCredito/rutAval, "###.###.##0","rut")' /></fo:inline>-<fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/dvAval" /></fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/>declaro por este acto, haber tomado conocimiento de mi calidad de <fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold">AVAL, FIADOR y CODEUDOR SOLIDARIO,</fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/>de la deuda por UF<fo:leader leader-pattern="space" leader-length="1mm"/><xsl:value-of select='format-number(OperacionCredito/montoCredito, "###.###.##0,00","decimal")' /><fo:leader leader-pattern="space" leader-length="1mm"/>suscrita por<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/nombreCompletoCliente" /></fo:inline></fo:block>
              </xsl:if>
              
              <xsl:if test="OperacionCredito/moneda != 'UF'">       
              <fo:block font-family="Helvetica" line-height="4.5mm" font-size="11pt" text-align="left" >C.I. N°:<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select='format-number(OperacionCredito/rutAval, "###.###.##0","rut")' /></fo:inline>-<fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/dvAval" /></fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/>declaro por este acto, haber tomado conocimiento de mi calidad de <fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold">AVAL, FIADOR y CODEUDOR SOLIDARIO,</fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/>de la deuda por $<fo:leader leader-pattern="space" leader-length="1mm"/><xsl:value-of select='format-number(OperacionCredito/montoCredito, "###.###.##0","decimal")' /><fo:leader leader-pattern="space" leader-length="1mm"/>suscrita por<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/nombreCompletoCliente" /></fo:inline></fo:block>        
              </xsl:if>
              <fo:block font-family="Helvetica" line-height="4.5mm" font-size="11pt" text-align="left" >RUT N°:<fo:leader leader-pattern="space" leader-length="1mm"/><fo:inline font-weight="bold"><xsl:value-of select='format-number(OperacionCredito/rutCliente, "###.###.##0","rut")' /></fo:inline>-<fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/dvCliente" /></fo:inline><fo:leader leader-pattern="space" leader-length="1mm"/>para con el Banco (Bci; Bci-Nova)<fo:leader leader-pattern="space" leader-length="1mm"/></fo:block>
