...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<fo:table-cell>
										<fo:external-graphic>
											<xsl:attribute name="src">
												<xsl:value-of select="probabilidad-incumplimiento/rutaImagen"/>02-logo-bci.gif
											</xsl:attribute>
										</fo:external-graphic>
									</fo:table-cell>
									<fo:table-cell padding-before="1cm">
										<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="right" color="{$txt}">
										<xsl:value-of select="probabilidad-incumplimiento/fechaImpresion"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
	...
	<xsl:template name="contenido">
		...
		<fo:block font-size="9pt" text-align="left" color="{$txt}">
			...
			<fo:inline font-weight="bold"><xsl:value-of select="probabilidad-incumplimiento/ejecutivo"/>&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;</fo:inline>
			<fo:inline font-weight="normal" space-before="30pt">Oficina: </fo:inline>
			<fo:inline font-weight="bold"><xsl:value-of select="probabilidad-incumplimiento/oficina"/></fo:inline>
		</fo:block>
		<!-- ejecutivo -->
		...
		<fo:block font-size="8pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<xsl:choose>
					<xsl:when test="count(probabilidad-incumplimiento/probabilidadIncumplimiento) > 0">
						<xsl:for-each select="probabilidad-incumplimiento/probabilidadIncumplimiento/listado-probabilidad-incumplimiento">
							<xsl:choose>
								<xsl:when test="vigencia = 'S'">
							<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt}" padding-before="2mm" padding-after="1mm" text-align="left">
										<xsl:value-of select="dividendoImpagoMinimo"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt}" padding-before="2mm" padding-after="1mm" text-align="left">
										<xsl:value-of select="dividendoImpagoMaximo"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="left">
										<xsl:value-of select="valorProbabilidadDeIncumplimiento"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</xsl:when>
					...
					<fo:table-row>
						<fo:table-cell padding-before="1mm">
							<fo:external-graphic height="1.2mm" width="1.2mm">
								<xsl:attribute name="src">
									<xsl:value-of select="probabilidad-incumplimiento/rutaImagen"/>01-bullet2-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
					...
					<fo:table-row>
						<fo:table-cell padding-left="2mm" padding-before="1mm" >
							<fo:external-graphic height="1mm" width="1mm">
								<xsl:attribute name="src">
									<xsl:value-of select="probabilidad-incumplimiento/rutaImagen"/>01-bullet1-rj.gif
								</xsl:attribute>
							</fo:external-graphic>
						</fo:table-cell>
						<fo:table-cell>
