				...
				<fo:table-cell >
					...
					<!-- titulo -->
						<fo:block font-size="12pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							Cálculo de Renta Líquido Mensual
						</fo:block>
					<!-- titulo -->
		...
		<fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row font-size="{$size-titulo-tabla}" height="{$alto-filas}" text-align="left" padding-bottom="2mm">
					<fo:table-cell border="0.5pt solid {$lineas}" padding-top="{$espacio-texto-celda-top}" number-columns-spanned="{$num_cols}">
					<!-- PRODUCTO -->
						<fo:block background-color="{$bgcolor}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Renta Líquida Mensual'"/>
							</xsl:call-template>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
				...
				<!-- LIQUIDACION DE SUELDO-->
				<fo:table-row font-size="{$size-fuente-margen}" height="{$alto-filas}" text-align="left" padding-top="2mm" padding-bottom="2mm" background-color="{$bgcolor}" >
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-texto-celda-top}">
						<fo:block color="{$txt}">
							Subtotal Líquido Fijo
						</fo:block>
					</fo:table-cell>
			...
			<fo:table-body>
				...
				<fo:table-row font-size="{$size-fuente-margen}" height="{$alto-filas}" text-align="left" padding-top="2mm" padding-bottom="2mm">
					...
					<xsl:for-each select="calculo/liquidaciones/liquidacion">
						...
						<!-- PRODUCTO -->
							<fo:block color="{$txt}">
								<xsl:value-of select="ajustes/totales/totalFijos"/>
							</fo:block>
						</fo:table-cell>
					</xsl:for-each>
				...
				<fo:table-row font-size="{$size-fuente-margen}" height="{$alto-filas}" text-align="left" padding-top="2mm" padding-bottom="2mm" background-color="{$bgcolor}">
					...
					<xsl:for-each select="calculo/liquidaciones/liquidacion">
						...
						<!-- PRODUCTO -->
							<fo:block color="{$txt}">
								<xsl:value-of select="ajustes/totales/totalVariables"/>
							</fo:block>
						</fo:table-cell>
					</xsl:for-each>
		...
		<fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row font-size="{$size-titulo-tabla}" height="{$alto-filas}" text-align="left" padding-top="2mm" padding-bottom="2mm">
					...
					<!-- PRODUCTO -->
						<fo:block color="{$txt}">
							<xsl:value-of select="calculo/totalBoletasHonorarios"/>
						</fo:block>
					</fo:table-cell>
