...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="selloBCI"><xsl:value-of select="removerRol/rutaImagen"/>rolesyusuarios/images/sello_bci.gif</xsl:variable>
<xsl:variable name="exito"><xsl:value-of select="removerRol/rutaImagen"/>rolesyusuariosComprobantes/exito.gif</xsl:variable>

<xsl:variable name="check"><xsl:value-of select="removerRol/rutaImagen"/>rolesyusuariosComprobantes/check.gif</xsl:variable>	
<xsl:variable name="check2"><xsl:value-of select="removerRol/rutaImagen"/>rolesyusuariosComprobantes/check2.gif</xsl:variable>	
	<xsl:template match="/">
...
<fo:block font-weight="bold"  color="white"  padding-after="10mm"  padding-before="5mm" >
		Operación Exitosa.
	</fo:block>
	<fo:block color="white" space-after="2mm" font-size="10pt">
Se ha enviado una copia de este comprobante al correo electrónico del titular de la Cuenta
</fo:block>
</fo:table-cell>
</fo:table-row>
</fo:table-body>
...
<!-- Columna que contiene el sello BCI -->
	...
	<fo:table-body>
		...
		<fo:block space-after="2mm" />
					...
					&#0160;&#0160;Comprobante Nº: &#0160;&#0160;&#0160;&#0160;<xsl:value-of select="removerRol/numeroComprobante"/>&#0160;&#0160;&#0160;&#0160;&#0160;
		...
		<fo:block font-weight="bold"  text-align="left">
					...
					<xsl:value-of select="removerRol/fecha" />&#0160;&#0160;&#0160;&#0160;	 <xsl:value-of select="removerRol/hora" />
...
Usuario:&#0160;	<xsl:value-of select="removerRol/nombrePersona"/>

</fo:block>

</fo:table-cell>
<fo:table-cell>
<fo:block>  asociado a rut
<xsl:value-of select="removerRol/rut"/>
</fo:block>
</fo:table-cell>
...
<fo:table-row >
	...
	<fo:block space-after="20mm" />
		...
		&#0160;&#0160;&#0160;&#0160;
		&#0160;&#0160;&#0160;&#0160;Nombre de Rol: &#0160;&#0160;
		<xsl:value-of select="removerRol/nombreRol" /> &#0160; Asociado a  &#0160;&#0160;
		<xsl:value-of select="removerRol/rut" />
		<fo:block space-after="2.5mm" />
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="removerRol/listaPrivilegiosBasicos">
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="removerRol/listaPrivilegiosDelegables">
