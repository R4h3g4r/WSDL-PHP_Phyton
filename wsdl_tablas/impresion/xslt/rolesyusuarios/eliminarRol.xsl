...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="selloBCI"><xsl:value-of select="eliminarRol/rutaImagen"/>rolesyusuarios/images/sello_bci.gif</xsl:variable>
<xsl:variable name="exito"><xsl:value-of select="eliminarRol/rutaImagen"/>rolesyusuariosComprobantes/exito.gif</xsl:variable>

<xsl:variable name="check"><xsl:value-of select="eliminarRol/rutaImagen"/>rolesyusuariosComprobantes/check.gif</xsl:variable>	
<xsl:variable name="check2"><xsl:value-of select="eliminarRol/rutaImagen"/>rolesyusuariosComprobantes/check2.gif</xsl:variable>	
	<xsl:template match="/">
...
<!-- Columna que contiene el sello BCI -->
	...
	<fo:table-body>
		...
		<fo:block space-after="2mm" />
					...
					&#0160;&#0160;&#0160;&#0160;&#0160;&#0160;<xsl:value-of select="eliminarRol/numeroComprobante"/>&#0160;&#0160;&#0160;&#0160;&#0160;
		...
		<fo:block font-weight="bold"  text-align="left">
					...
					<xsl:value-of select="eliminarRol/fecha" />&#0160;&#0160;&#0160;&#0160;	 <xsl:value-of select="eliminarRol/hora" />
...
<fo:table-row >
	...
	<fo:block space-after="20mm" />
		...
		&#0160;&#0160;&#0160;&#0160;
		&#0160;&#0160;&#0160;&#0160;Nombre de Rol: &#0160;&#0160;
		<xsl:value-of select="eliminarRol/nombreRol" /> &#0160; Asociado a  &#0160;&#0160;
		<xsl:value-of select="eliminarRol/rut" />
		<fo:block space-after="2.5mm" />
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="eliminarRol/listaPrivilegiosBasicos">
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="eliminarRol/listaPrivilegiosDelegables">
...
<fo:table-body>
<xsl:for-each select="eliminarRol/usuarios">
