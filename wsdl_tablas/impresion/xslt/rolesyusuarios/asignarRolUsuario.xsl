...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="selloBCI"><xsl:value-of select="asignarRolUsuario/rutaImagen"/>rolesyusuarios/images/sello_bci.gif</xsl:variable>
<xsl:variable name="exito"><xsl:value-of select="asignarRolUsuario/rutaImagen"/>rolesyusuariosComprobantes/exito.gif</xsl:variable>

<xsl:variable name="check"><xsl:value-of select="asignarRolUsuario/rutaImagen"/>rolesyusuariosComprobantes/check.gif</xsl:variable>	
<xsl:variable name="check2"><xsl:value-of select="asignarRolUsuario/rutaImagen"/>rolesyusuariosComprobantes/check2.gif</xsl:variable>	
...
<!-- Columna que contiene el sello BCI -->
	...
	<fo:table-body>
		...
		<fo:block space-after="2mm" />
					...
					&#0160;&#0160;Comprobante Nº: &#0160;&#0160;&#0160;&#0160;<xsl:value-of select="asignarRolUsuario/numeroComprobante"/>&#0160;&#0160;&#0160;&#0160;&#0160;
		...
		<fo:block font-weight="bold"  text-align="left">
					...
					<xsl:value-of select="asignarRolUsuario/fecha" />&#0160;&#0160;&#0160;&#0160;	 <xsl:value-of select="asignarRolUsuario/hora" />
...
<fo:table-row >
	...
	<fo:block space-after="20mm" />
		...
		&#0160;&#0160;&#0160;&#0160;
		&#0160;&#0160;&#0160;&#0160;Nombre de Rol: &#0160;&#0160;
		<xsl:value-of select="asignarRolUsuario/nombreRol" /> &#0160; Asociado a  &#0160;&#0160;
		<xsl:value-of select="asignarRolUsuario/rut" />
		<fo:block space-after="2.5mm" />
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="asignarRolUsuario/listaPrivilegiosBasicos">
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="asignarRolUsuario/listaPrivilegiosDelegables">
	...
	<!-- fin iteracion de privilegios -->
		...
		<fo:block space-after="10mm" />
				<fo:table table-layout="fixed" width="15cm" border-bottom="1px solid"  >
...
<fo:table-cell>
	<fo:block space-after="5mm" />
<fo:block margin-left="20px" background-color="darkgray" text-align="center" color="white" >
Usuarios
<fo:block space-after="2mm" />
</fo:block>
...
<fo:table-row>
<fo:table-cell>
<fo:block margin-left="20px" background-color="darkgray" space-after="2mm" padding-before="5.9mm" />
</fo:table-cell>
<fo:table-cell>
<fo:block  background-color="#333" space-after="2mm" text-align="center" padding-before="1mm" color="white">
Nombre
</fo:block>
</fo:table-cell>

<fo:table-cell>
<fo:block  background-color="darkgray" space-after="2mm" text-align="center" padding-before="1mm" color="white">
Rut
</fo:block>
</fo:table-cell>
</fo:table-row>
<xsl:for-each select="asignarRolUsuario/usuarios">
<xsl:if test="nombrePersona!='' and rutUsuario!=''">
<fo:table-row >
<fo:table-cell>
<fo:block margin-left="20px" background-image="url({$check2})" background-repeat="no-repeat" padding-before="10mm">
