...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
   ...
   <xsl:variable name="exito"><xsl:value-of select="crearRol/rutaImagen"/>rolesyusuariosComprobantes/exito.gif</xsl:variable>

    <xsl:variable name="check"><xsl:value-of select="crearRol/rutaImagen"/>rolesyusuariosComprobantes/check.gif</xsl:variable>	
    <xsl:variable name="check2"><xsl:value-of select="crearRol/rutaImagen"/>rolesyusuariosComprobantes/check2.gif</xsl:variable>	
	<xsl:template match="/">
...
<fo:table-row >
	...
	<fo:block space-after="20mm" />
		...
		&#0160;&#0160;&#0160;&#0160;
		&#0160;&#0160;&#0160;&#0160;Nombre de Rol: &#0160;&#0160;
		<xsl:value-of select="crearRol/nombreRol" /> &#0160; Asociado a  &#0160;&#0160;
		<xsl:value-of select="crearRol/rut" />
		<fo:block space-after="2.5mm" />
		</fo:block>
		</fo:table-cell>
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="crearRol/listaPrivilegiosBasicos">
...
<fo:table-column column-width="10cm"  />
	...
	<xsl:for-each select="crearRol/listaPrivilegiosDelegables">
...
<fo:block  >
<fo:block space-after="5mm" />
<xsl:value-of select="crearRol/nombrePersona" />
</fo:block>
</fo:table-cell>
...
<fo:table-cell>
<fo:block  >
<xsl:value-of select="crearRol/realizadoPorRol"/>
</fo:block>
</fo:table-cell>
</fo:table-row>
</fo:table-body>
