	                    ...
	                    <fo:table table-layout="fixed" width="100%">
	                      ...
	                      <fo:table-body>
	                          ...
	                          <fo:table-cell  text-align="left"  padding-top="2mm" padding-left="3mm" border-bottom="0.25pt solid #5885AC"   border-top="0.25pt solid #5885AC"  border-left="0.25pt solid #5885AC" border-right="0.25pt solid #5885AC">
	                            <fo:block font-weight="bold" color="#70A0C1" line-height="5mm" font-size="13pt"><fo:leader leader-pattern="space" leader-length="1mm" />IV. Volúmenes Esperados (Movimientos Mensuales).</fo:block>
	                          </fo:table-cell>
	                        </fo:table-row>
	      								</fo:table-body>
	                    </fo:table>
