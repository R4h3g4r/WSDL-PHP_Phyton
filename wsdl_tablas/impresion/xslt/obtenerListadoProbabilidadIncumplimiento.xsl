		...
		<fo:block>
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">Obtener Probabilidad de Incumplimiento (PI)</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
...
<fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							&#0160;<xsl:value-of select="Info/Colaborador/CodOficina"/>
						</fo:block>
					</fo:table-cell>
				...
				<fo:table-row height="{$alto-filas}">
					...
					<fo:table-cell border="0.5pt solid {$lineas}" padding-left="{$espacio-texto-celda-left}" padding-top="{$espacio-celda-top}">
						<fo:block font-size="{$size-fuente-margen}" font-weight="bold" text-align="left" color="{$txt-azul-claro}">
							&#0160;<xsl:value-of select="Info/Colaborador/tipoBanca"/>
						</fo:block>
					</fo:table-cell>
		...
		<fo:block>
			<xsl:call-template name="subTitulo">
				<xsl:with-param name="titulo" select="'Probabilidad Imcumplimientos (PI) '"/>
			</xsl:call-template>
			<fo:table table-layout="fixed" space-before="3mm">
				...
				<fo:table-body>
					...
					<xsl:for-each select="Info/BalancesCliente/BalancesCliente">
						<fo:table-row>
							...
							<xsl:call-template name="celda">
								<xsl:with-param name="texto" select="tipBalance"/>
							</xsl:call-template>
							<xsl:call-template name="celda">
								<xsl:with-param name="texto" select="estadoBal"/>
							</xsl:call-template>
						</fo:table-row>
					</xsl:for-each>
				</fo:table-body>
