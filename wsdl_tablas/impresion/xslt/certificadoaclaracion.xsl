...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="contenido">
		...
		<fo:block font-size="8pt" text-align="left" font-family="Courier">
			<fo:inline font-weight="normal">Señores </fo:inline>			
		</fo:block>
		<fo:block font-size="8pt" text-align="left" font-family="Courier">
		...
		<fo:block font-size="8pt" txt-align="left" font-family="Courier">
			<fo:inline font-weight="normal">Ponemos en su conocimiento que el(los) documento(s) detallado(s) a continuación,</fo:inline>
		</fo:block>
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row >
						...
						<fo:table-cell>
							<fo:block font-size="8pt" text-align="left" font-family="Courier">
								<fo:inline font-weight="bold">Pág. Nro.</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="8pt" text-align="left" font-family="Courier">
								<fo:inline font-weight="bold">Nóm. Nro.</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
		...
		<fo:block font-size="8pt" txt-align="left" font-family="Courier">
			<fo:inline font-weight="normal">Sirvase efectuar la(s) aclaración(es) correspondiente(s)</fo:inline>
		</fo:block>
		...
		<fo:block font-size="8pt" txt-align="left" font-family="Courier">
			<fo:inline font-weight="normal">Banco de Crédito e Inversiones</fo:inline>
		</fo:block>
