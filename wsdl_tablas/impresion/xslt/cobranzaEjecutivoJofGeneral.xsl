...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="contenido">
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="normal" space-after="1mm" text-align="left" color="{$txt-azul-claro}">
								...
								<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="cobranza/usuario"/></fo:inline>
							</fo:block>
							<!-- nombre cliente -->
						</fo:table-cell>
						<fo:table-cell>
							...
							<fo:block font-size="10pt" font-weight="normal" space-after="1mm" text-align="right" color="{$txt}">
								...
								<fo:inline color="{$txt-azul-claro}"><xsl:value-of select="cobranza/oficina"/></fo:inline>
							</fo:block>
							<!-- rut cliente -->
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:block space-after="1.9mm">
		</fo:block>
		
		
		<xsl:if test="cobranza/mostrarFiltroOficina = 'SI'">
																...
																<fo:table-body>
																	<fo:table-row display-align="center">
																		...
																		border-end-width="0.25pt">
																		 ...
																		 space-after="0.5mm"
																		 space-before="0.5mm">																		 
																		     <xsl:value-of select="cobranza/oficinaSeleccionada"/>
																		</fo:block>
																		</fo:table-cell>																		
																	</fo:table-row>
																</fo:table-body>
		...
		<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:for-each select="cobranza/lista-ejecutivos">					
						<fo:table-row display-align="center">
							<fo:table-cell border-color="{$lineas}" border-style="solid"
							margin-left="2.0px"
							border-before-width="0.25pt"
		...
		<xsl:if test="cobranza/mostrarProductos = 'SI'">
				...
				<fo:table-body>
					<fo:table-row display-align="center">
						<fo:table-cell >
							<!-- titulo -->
							<fo:block font-size="11pt" font-weight="bold" text-align="left" space-after="1.5mm">
								Por Ejecutivo &gt;&gt; <xsl:value-of select="cobranza/codigoEjecutivo"/>
							</fo:block>
							<!-- titulo -->
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:for-each select="cobranza/lista-productos">					
						<fo:table-row display-align="center">
							<fo:table-cell border-color="{$lineas}" border-style="solid"
							margin-left="2.0px"
							border-before-width="0.25pt"
				...
				<fo:table-body>
					<fo:table-row display-align="center">
						<fo:table-cell >
							<!-- titulo -->
							<fo:block font-size="11pt" font-weight="bold" text-align="left" space-after="1.5mm">
								Por Ejecutivo &gt;&gt; <xsl:value-of select="cobranza/codigoEjecutivo"/> &gt;&gt; <xsl:value-of select="cobranza/nombreProducto"/>
							</fo:block>
							<!-- titulo -->
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:for-each select="cobranza/lista-clientes">					
						<fo:table-row display-align="center">
							<fo:table-cell border-color="{$lineas}" border-style="solid"
							margin-right="2.0px"
							border-before-width="0.25pt"
