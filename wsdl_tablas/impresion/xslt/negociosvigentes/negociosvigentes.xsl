				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
							...
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-protestos,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-protestos-acl,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>							
						</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" text-align="center">
										&#0160;<xsl:value-of select="cupoOrigen"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						<fo:table-row>
							...
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-utilizado,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-cupo-original,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
							...
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-colocacion-actual,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-colocacion-monto,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
							...
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-colocacion-me-actual,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-colocacion-me-original,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
							...
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-multilinea-actual,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-multilinea-original,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-hipotecario-actual,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
							<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-hipotecario-original,"###.###.##0","decimal")'/>
							</fo:block>
							</fo:table-cell>
					</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
										&#0160;<xsl:value-of select="margenLegal"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-margen-legal,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-ultimo-cobro,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-saldo-real,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-ultimo-pago,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-monto-vencimiento,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" text-align="center">
										&#0160;<xsl:value-of select="ultimoCobro"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-factoring-monto-actual,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-factoring-monto-original,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>												
					</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" text-align="center">
										&#0160;<xsl:value-of select="ingresoMes"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-cobnac-monto-actual,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-cobnac-monto-ingmes,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>												
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-acumulado-mes,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-transporte-factura,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
										&#0160;<xsl:value-of select="cupoMaximo"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
										&#0160;<xsl:value-of select="montoActual"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-bancredito-monto-actual,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
				...
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-row>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
										&#0160;<xsl:value-of select="montoInforme"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-monto-informado,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-me-monto-actual,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>							
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-uso-mes,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
...
<xsl:if test="count(negocios-vigentes/cajaDeSeguridad) > 0">
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-valor-caja,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>						
					</fo:table-row>
					</fo:table-body>
			...
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					...
					<fo:table-body>
						...
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-banleasing-actual,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>
					</fo:table-row>
					</fo:table-body>
		...
		<xsl:if test="count(negocios-vigentes/rsgForward) > 0">
			<!-- rsgForward -->
			<fo:block font-size="7pt" space-after="1mm" text-align="right">
				<fo:table table-layout="fixed" >
					<fo:table-column column-width="2cm" />
					...
					<fo:table-body>
						...
						<xsl:for-each select="negocios-vigentes/rsgForward/listado-rsgForward">
						<fo:table-row>
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
										&#0160;<xsl:value-of select="operacion"/>
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" text-align="center">
										&#0160;<xsl:value-of select="rel"/>
																...
																<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
										&#0160;<xsl:value-of select="vencimientoMaximo"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" margin-right="1mm" text-align="center">
								...
								<fo:table-cell border="0.5pt solid {$lineas}">
									<fo:block font-weight="normal" color="{$txt-azul-claro}" padding-before="1mm" padding-after="1mm" text-align="center">
										&#0160;<xsl:value-of select="montoOriginal"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-cell background-color="{$txt-celeste}" number-columns-spanned="6" border="0.5pt solid {$lineas}">
						<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="right">
							Número de Rsg Forwards :&#0160;&#0160;&#0160;&#0160;<xsl:value-of select="negocios-vigentes/cantidad-rsgForward"/>
						</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-rsgForward-montoActual,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>
						<fo:table-cell background-color="{$txt-celeste}" border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="center">
								<xsl:value-of select='format-number(negocios-vigentes/suma-rsgForward-montoOriginal,"###.###.##0","decimal")'/>
						</fo:block>
						</fo:table-cell>												
					</fo:table-row>
					</fo:table-body>
