...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
   ...
   <!-- <xsl:param name="IMG_URL"/> -->
    ...
    <xsl:template match="mandato_canales_indirectos">
            ...
            <fo:page-sequence master-reference="miCarta">
              ...
              <fo:table border-collapse="collapse" text-align="left" >
                  ...
                  <fo:table-body> 
                      ...
                      <fo:table-row>
                            <fo:table-cell >
                                    <fo:block font-family="Helvetica" font-size="12pt" text-align="justify" margin-left="1mm" margin-right="2mm" line-height="8mm">Confiero poder al Banco de Crédito e Inversiones, para que con cargo al crédito que me cursará por la suma total de $ <fo:inline font-weight="bold"><xsl:value-of select='format-number(OperacionCredito/montoCreditoEnPesos, "###.###.##0","decimal")' /></fo:inline>, en mi nombre y representación pague a Incentivos y Promociones Limitada, R.U.T. N° 77.247.680-9, la suma de $ <fo:inline font-weight="bold"><xsl:value-of select='format-number(OperacionCredito/montoCreditoEnPesos, "###.###.##0","decimal")' /> (<xsl:value-of select="OperacionCredito/montoCreditoManoEscrita"/> pesos)</fo:inline>, correspondiente al precio del producto <fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/descripcionProductoCredicompra"/></fo:inline>, que he comprado a la mencionada empresa. La boleta o factura que emita la sociedad vendedora a mi nombre, constituye suficiente rendición de cuentas de la gestión del banco.
</fo:block>
								<fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                            </fo:table-cell>
                      </fo:table-row>                                                                                                                                            
