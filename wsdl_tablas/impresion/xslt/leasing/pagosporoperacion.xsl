		...
		<fo:block font-size="5pt" space-after="1mm">
			...
			<fo:table-body>
				...
				<fo:table-cell>
					...
					<!-- nombre cliente -->
						<fo:block font-size="9pt" font-weight="normal" space-after="1mm" text-align="left" color="{$txt}">
							<fo:inline color="{$txt}"><xsl:value-of select="leasing/nombre"/></fo:inline>
						</fo:block>
					<!-- nombre cliente -->
					...
					<fo:table-row>
						<fo:table-cell>
							...
							<xsl:call-template name="subTitulo">
								<xsl:with-param name="titulo" select="'Pagos Por Operación'"/>
							</xsl:call-template>
								<fo:block space-after="2mm">
								</fo:block>
						</fo:table-cell>
		...
		<fo:block font-size="7pt" space-after="1mm" text-align="right">
			<fo:table table-layout="fixed" >
				...
				<fo:table-body>
					...
					<xsl:for-each select="leasing/pagos-por-operacion/pagos">
					<fo:table-row>
						...
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
								&#0160;<xsl:value-of select="pagoParcial"/>
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="normal" color="{$txt}" padding-before="1mm" padding-after="1mm" text-align="center">
								&#0160;<xsl:value-of select="estadoFacturacion"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					</xsl:for-each>
...
<!-- tabla A -->
	...
	<xsl:value-of select="leasing/rutaImagen"/>01-bullet1-rj.gif</xsl:attribute>
	</fo:external-graphic>&#0160;Número : </fo:block>
	</fo:table-cell>

	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="leasing/numero"/></fo:block>
	</fo:table-cell>
	...
	&#0160;<fo:external-graphic><xsl:attribute name="src">
	<xsl:value-of select="leasing/rutaImagen"/>01-bullet1-rj.gif</xsl:attribute>
	</fo:external-graphic>&#0160;Tipo Operación : </fo:block>
	</fo:table-cell>

	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="leasing/tipoOperacion"/></fo:block>
	</fo:table-cell>
...
<fo:block font-size="9pt" font-weight="bold" space-after="1mm" text-align="left" color="black">
	...
	&#0160;<fo:external-graphic><xsl:attribute name="src">
	<xsl:value-of select="leasing/rutaImagen"/>01-bullet1-rj.gif</xsl:attribute>
	</fo:external-graphic>&#0160;Fecha : </fo:block>
	</fo:table-cell>

	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="leasing/fecha"/></fo:block>
	</fo:table-cell>
	...
	&#0160;<fo:external-graphic><xsl:attribute name="src">
	<xsl:value-of select="leasing/rutaImagen"/>01-bullet1-rj.gif</xsl:attribute>
	</fo:external-graphic>&#0160;Estado : </fo:block>
	</fo:table-cell>

	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="leasing/estado"/></fo:block>
	</fo:table-cell>
