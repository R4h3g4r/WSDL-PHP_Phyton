                                  ...
                                  <fo:table-column column-width="118mm"/>
                                    <fo:table-body>
                                      <fo:table-row>
                                        ...
                                        <fo:table-cell >
                                              <fo:block font-family="Helvetica" font-size="11pt" text-align="left" >Nº OPERACIÓN<fo:leader leader-pattern="space" leader-length="5.7mm"/>: <fo:leader leader-pattern="space" leader-length="3mm"/><fo:inline font-weight="bold"><xsl:value-of select="OperacionCredito/nroOperacion" /></fo:inline></fo:block>
                                    ...
                                    <fo:table-body>
                                        <fo:table-row>
                                              <fo:table-cell >
                                                    ...
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="justify" >Faculto expresamente al BANCO DE CREDITO E INVERSIONES para cargar en mi cuenta corriente las sumas adeudadas provenientes del préstamo solicitado incluyendo capital, intereses y gastos, si no fueren cancelados a su respectivo vencimiento, como así también para aplicar a su pago cualquier crédito a mi favor que exista en el BANCO, ya sean saldos en mi cuenta corriente, depósitos a la vista, depósitos a plazo, valores en custodia, etc. Asimismo declaro bajo juramento que todos los antecedentes presentados son fidedignos y que conozco el texto del artículo 160 de la Ley General de Bancos.</fo:block>
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                ...
                                <fo:table border-collapse="collapse" >
                                    ...
                                    <fo:table-body>
                                        <fo:table-row>
                                              <fo:table-cell >
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="justify" >Asimismo, por el presente instrumento, faculto al BANCO DE CREDITO E INVERSIONES, de manera irrevocable, para que, en conformidad a lo previsto en el artículo 11 de la Ley sobre Letra de Cambio y Pagaré, complete el pagaré que documente esta solicitud de crédito, la totalidad de las menciones exigidas por la Ley, fijando en él mi obligación de pagar la cantidad de dinero solicitada en este acto o aquella en que en definitiva apruebe el BANCO al dorso de esta solicitud, si dicha cantidad fuere diferente. Libero al BANCO DE CREDITO E INVERSIONES de la obligación de rendir cuenta de este cometido, como asimismo de toda responsabilidad que pudiera derivar del ejercicio del mismo. Con el propósito de actualizar y verificar periódicamente el estado y vigencia de las garantías constituidas, autorizo al Banco desde ya para requerir los certificados y anotaciones pertinentes ante los Conservadores de Bienes Raíces u oficinas del Registro Civil que correspondan, siendo de mi cargo los gastos, derechos y tarifas correspondientes, pudiendo adicionar tales gastos en las cuotas o dividendos del o los crédito(s) que mediante el presente instrumento solicito o en el futuro solicite, sin perjuicio de hacerlo mediante el cargo respectivo en cualquier cuenta corriente o cuenta vista que mantuviere en el BANCO, para lo cual desde ya lo autorizo y otorgo mi consentimiento. Tratándose de créditos a más de un año plazo, faculto al Banco irrevocablemente en los términos del artículo 241 del Código de Comercio para que, actuando a través de uno o más apoderados, en mi (nuestro) nombre y representación proceda a suscribir una o más hojas de renovación o prórroga del o los pagaré(s) en que se documente la respectiva operación de crédito, sin notificación al mandante, determinando el nuevo vencimiento, forma de pago y la nueva tasa de interés que regirá en ese período. El término de la(s) renovación(es) será igual al estipulado en la presente solicitud, en su caso, pudiendo el mandante reducir o aumentar dicho plazo en no más de 10 días y la tasa de interés será la que el BANCO DE CREDITO E INVERSIONES aplique en general a esta clase de operaciones el día de la prórroga, y que en todo caso no podrá ser superior a la tasa máxima convencional que corresponda. El BANCO DE CREDITO E INVERSIONES estará revestido de las facultades para autocontratar.</fo:block>
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="justify" >En todo caso, el BANCO DE CREDITO E INVERSIONES queda liberado de toda responsabilidad en caso de no ejercer este mandato. En ningún caso el otorgamiento de este mandato constituye la concesión de espera(s) ni el otorgamiento de plazo(s) adicional(es) alguno(s) para servir la(s) obligación(es) o puede interpretarse como el ejercicio de un derecho para el deudor a prorrogar el plazo de vencimiento de esta obligación, quedando el BANCO en completa libertad para resolver a su arbitrio, si ejerce o no la facultad conferida. Asimismo, la circunstancia de obrar conforme a dicha potestad no podrá ser inferida como la obligación de volver a ejercerla en el próximo vencimiento.</fo:block>
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="justify" >Asimismo reconozco (reconocemos) haber recibido por parte del Banco de Crédito e Inversiones información detallada de las comisiones que el Banco cobra por concepto de otorgamiento de crédito y procesos asociados a éste, como en el caso de reprogramación, prórroga, y reestructuración entre otros. Acepto (aceptamos) desde ya que estos valores sean cargados en mi (nuestra) cuenta corriente, de darse cualquiera de las situaciones o procesos antes señalados o cualesquiera de aquellos que me (nos) han sido informados. En caso de no poseer cuenta corriente la comisión correspondiente la pagaré(mos) por Caja.</fo:block>
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="justify" >Declaro haber recibido información detallada y aceptar que existen recargos en caso de mora o simple retardo en el pago de la obligación de crédito de dinero de que da cuenta la presente solicitud y además por concepto de la cobranza extrajudicial de créditos impagos, incluyendo honorarios, a partir de la fecha que se indica más adelante, los cuales serán cobrados por la</fo:block>
                                              </fo:table-cell>
                                        </fo:table-row>
                                  </fo:table-body>
                                 </fo:table>
                                ...
                                <fo:table border-collapse="collapse" >
                                    ...
                                    <fo:table-body>
                                        <fo:table-row>
                                              <fo:table-cell >
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
                                                    <fo:block  font-family="Helvetica" font-size="11pt"  text-align="justify" >"Compañía de Normalización de Créditos-Normaliza S.A." o por aquella que el BANCO designare en su oportunidad la que actuará en nombre y en representación e interés del BANCO en las gestiones de cobranza extrajudicial.</fo:block>
                                                    <fo:block ><fo:leader leader-pattern="space" leader-length="17cm"/></fo:block>
