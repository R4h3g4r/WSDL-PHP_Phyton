...
<xsl:template match="Resumen">
	...
	<xsl:template name="temp_datosPrimas">
			...
			<fo:table-row>
				<fo:table-cell text-align="right" border-top-style="solid" border-width="0.1pt" border-left-style="solid" border-right-style="solid" border-bottom-style="solid" border-color="#DCDCDC" number-columns-spanned="6">
					<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" font-weight="bold">
						<xsl:text>Total Cobros</xsl:text>
					</fo:block>
				</fo:table-cell>

				<fo:table-cell text-align="right" display-align="before" border-style="solid" border-width="0.1pt" border-left-style="solid" border-right-style="solid" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="totalesIvaPersona"/>
							</fo:block>
						</fo:table-cell>
