			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Nº Protesto:'"/>
							</xsl:call-template>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Fecha Aclaración:'"/>
							</xsl:call-template>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
					...
					<fo:table-row>
						<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolor}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Oficina Aclaración:'"/>
							</xsl:call-template>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolor}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
			...
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolor}">
							<xsl:call-template name="itemTitulo">
								<xsl:with-param name="titulo" select="'Envía Boletín:'"/>
							</xsl:call-template>
						</fo:table-cell>
						<fo:table-cell border="0.5pt solid {$lineas}" background-color="{$bgcolor}">
							<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
