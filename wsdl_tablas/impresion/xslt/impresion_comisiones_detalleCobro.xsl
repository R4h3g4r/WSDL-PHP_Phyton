...
<xsl:template match="DetalleCobro">
	...
	<xsl:template name="temp_datosPrimas">
			...
			<fo:table-row>
				<fo:table-cell text-align="start" display-align="before" border-top-style="solid" border-left-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" number-columns-spanned="2"> 
				...
				<fo:table-cell text-align="start" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" number-columns-spanned="4">  
					<fo:block white-space-collapse="true" text-align="center"  color="#0360A2" font-size="11.0pt" font-weight="bold">
			...
			<fo:table-row>
				<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
						...
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="estadoVariableEmpresa"/>
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="estadoVariablePersona"/>
							</fo:block>
						</fo:table-cell>
				...
				<fo:table-cell text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.0pt" border-color="#DCDCDC">
					<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="8.0pt" font-weight="bold">
						<xsl:text></xsl:text>
					</fo:block>
				</fo:table-cell>
				...
				<fo:table-row>
				<fo:table-cell text-align="right" display-align="before" border-left-style="solid" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC" number-columns-spanned="2" padding-left="8pt" border-right-style="solid" >
			  ...
			  <fo:table-cell text-align="right" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" border-right-style="solid" >
							<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="totalNetoVariableEmpresa"/>
							</fo:block>
						</fo:table-cell>
						
				<fo:table-cell text-align="center" display-align="before" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC" border-right-style="solid" >
					<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="5.0pt" font-weight="bold">
						<xsl:text></xsl:text>
					</fo:block>
				</fo:table-cell>
				...
				<fo:table-cell text-align="right" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" border-right-style="solid" >
							<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="totalNetoVariablePersona"/>
							</fo:block>
				</fo:table-cell>
				<fo:table-cell text-align="center" display-align="before" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC" border-right-style="solid" >
					<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="5.0pt" font-weight="bold">
		...
		<fo:table-row>
				<fo:table-cell text-align="right" display-align="before" border-left-style="solid" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC" border-bottom-style="solid" number-columns-spanned="2" border-right-style="solid" >
					<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="9.0pt" font-weight="bold">
			  ...
			  <fo:table-cell text-align="right" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" border-bottom-style="solid" border-right-style="solid" >
				...
				<fo:table-cell text-align="center" display-align="before" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC" border-bottom-style="solid" border-right-style="solid" >
					<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="5.0pt" font-weight="bold">
						<xsl:text></xsl:text>
					</fo:block>
				</fo:table-cell>
			...
			<fo:table-row>
			  ...
			  <fo:table-cell text-align="right" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" border-bottom-style="solid" border-right-style="solid" >
							<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="totalVariableEmpresa"/>
							</fo:block>
						</fo:table-cell>
				...
				<fo:table-cell text-align="right" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" border-bottom-style="solid" border-right-style="solid" >
							<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="8.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="totalVariablePersona"/>
							</fo:block>
				</fo:table-cell>
				<fo:table-cell text-align="center" display-align="before" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC" border-bottom-style="solid" border-right-style="solid" >
					<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="5.0pt" font-weight="bold">
