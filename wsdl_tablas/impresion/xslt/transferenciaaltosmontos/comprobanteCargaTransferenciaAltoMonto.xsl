...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="all-pages" page-width="210mm" page-height="297mm" margin-top="20mm">
               ...
               <fo:static-content flow-name="xsl-region-after" margin-left="18.7cm" font-size="12pt" >
                ...
                <fo:flow flow-name="xsl-region-body">
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="1cm" font-size="10pt"  margin-left="1.4cm" font-weight="bold">
                           Estimado Cliente:
                    </fo:block>
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                          Con fecha 
                          <xsl:value-of select="ComprobanteCarga/fechaEnvio" /> a las <xsl:value-of select="ComprobanteCarga/horaEnvio" /> hrs. 
                          se ha cargado correctamente
                    </fo:block>
                    <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                          la siguiente nómina de pago:
                    </fo:block>
                 <fo:block  margin-left="117mm"  width="200pt" height="200pt" space-before="1cm" >
                          ...
                          <fo:table-body>
								...
								<fo:table-row>
									<fo:table-cell>
										...
										<fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                                    <xsl:value-of select="ComprobanteCarga/rutEmpresa" />                                         </fo:block>
									</fo:table-cell>
									<fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                            Razón Social  &#160;
								...
								<fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                                    <xsl:value-of select="ComprobanteCarga/rutUsuario" />                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                            Nombre Usuario &#160;
            		...
            		<fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                                    <xsl:value-of select="ComprobanteCarga/nombreNomina" />
                                         </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
