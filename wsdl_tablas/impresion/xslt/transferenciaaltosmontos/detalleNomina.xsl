    ...
    <xsl:template match="DetalleNomina/detalle">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="default-page" initial-page-number="1" format="1">
              <fo:static-content flow-name="xsl-region-before" margin-left="16cm" font-size="12pt" font-family="Arial">
                        <fo:block>
                        ...
                        <fo:block font-size="5pt" space-after="0.5cm" space-before="1cm">
                            <fo:block>
                                ...
                                <fo:table width="19cm" background-color="#F0F0F0">
                                    ...
                                    <fo:table-body>
                                         <fo:table-row>
                                            <fo:table-cell number-columns-spanned="13" background-color="#C8C8C8" color="#FFFFFF">
                                                <fo:block font-weight="bold" font-size="12pt" font-family="Arial">
                                        ...
                                        <fo:table-row>
                                            <fo:table-cell number-columns-spanned="13"  background-color="#FFFFFF">
                                                <fo:block font-size="10pt" color="{$txt}" font-family="Arial">
                                                    <xsl:text>&#160;</xsl:text>
                                                </fo:block>
                                            </fo:table-cell>
