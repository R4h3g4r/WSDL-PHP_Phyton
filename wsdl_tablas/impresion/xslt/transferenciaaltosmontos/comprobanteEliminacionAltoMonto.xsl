              ...
              <fo:static-content flow-name="xsl-region-before" >
                        <fo:block >
                            ...
                            <fo:table-body>
                               ...
                               url('<xsl:value-of select="NominaEliminada/rutaLogoCabecera" />')
                               </xsl:attribute>
                             </fo:external-graphic>
                       </fo:table-cell>
                                </fo:table-row>
                 ...
                 <fo:block    background-position="center"  margin-left="117mm"  > 
                  <fo:block space-before="2cm" font-size="10pt"  margin-left="1.4cm" font-weight="bold">
                     ...
                     <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" >
                        Se ha eliminado correctamente la nómina N° <fo:inline font-weight="bold" ><xsl:value-of select="NominaEliminada/idTransferencia" /></fo:inline>
                     </fo:block>
                        ...
                        <fo:table-column column-width="12cm"/>
                          ...
                          <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block font-size="10pt" margin-left="1.4cm" font-weight="bold" >
                                            <xsl:value-of select="NominaEliminada/rutEmpresa" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm">
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm"  font-weight="bold">
                                                    <xsl:value-of select="NominaEliminada/nombreEmpresa" />
                                         </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                <fo:table-cell>
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold" >
                                            <xsl:value-of select="NominaEliminada/rutUsuario" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block space-before="5mm" font-size="10pt" margin-left="1.4cm" >
                                        ...
                                        <fo:block space-before="0cm" font-size="10pt" margin-left="1.4cm" font-weight="bold">
                                             <xsl:value-of select="NominaEliminada/nombreUsuario" />
                                         </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
