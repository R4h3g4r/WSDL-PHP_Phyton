                 ...
                 <fo:block margin-left="40mm"  width="200pt" height="100pt" >
                        ...
                        <fo:table-column column-width="25cm"/>
                          <fo:table-body>
                             <fo:table-row>
                                <fo:table-cell>
                                  <fo:block font-weight="bold" margin-left="70mm"  font-size="12pt" color="{$txt}" font-family="Arial">
                                  Historial de Nómina
                                  </fo:block>    
                               </fo:table-cell>
                             </fo:table-row>
                      ...
                      <fo:block margin-left="0mm" font-weight="bold" text-align="left" font-size="10pt" color="{$txt}" font-family="Arial" space-after="5mm"> 
                    		Datos de Nómina
                    	</fo:block>
                                  ...
                                  <fo:table-body>
                                    <fo:table-row margin-left="0mm">
                                        <fo:table-cell>
                                          ...
                                          <fo:block font-weight="bold" font-size="10pt" color="{$txt}" font-family="Arial">
                                ...
                                <fo:table-body>
                                    <fo:table-row>
                                        <fo:table-cell number-rows-spanned="1" border="0.5pt solid {$lineas}">
                                            <fo:block font-size="8pt" font-family="Arial" text-align="center" font-stretch="condensed" space-after="1mm" space-before="1mm" color="{$txt}" margin-left="1mm">
                                                Evento
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell number-rows-spanned="1" border="0.5pt solid {$lineas}">
                                            <fo:block font-size="9pt" font-family="Arial" text-align="center" font-stretch="condensed" space-after="1mm" space-before="1mm" color="{$txt}" margin-left="1mm">
                                                Fecha y Hora
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell number-rows-spanned="1" border="0.5pt solid {$lineas}">
                                    ...
                                    <xsl:for-each select="detalle/historial">
                                        <fo:table-row>
                                         <fo:table-cell border-left-style="solid" number-columns-spanned="1" border="0.5pt solid {$lineas}">
                                                <fo:block font-size="8pt" font-family="Arial" text-align="center" font-stretch="condensed" space-before="1mm" color="{$txt}" margin-left="1mm">
