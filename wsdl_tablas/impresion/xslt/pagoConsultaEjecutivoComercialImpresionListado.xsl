                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="Times" text-align="left" font-size="9pt" line-height="4mm">
                        ...
                        <fo:block>
                            ...
                            <!-- En caso de no encontrarse pago consulta a Tercero -->  
							<xsl:choose>
								<xsl:when test="pagoATercero = ''"> 
									<fo:table-row>
                                    	<fo:table-cell color="#000000">
                                            <fo:block>
                                                Ejecutivo : <xsl:value-of select="ejeSuplente"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                                    	<fo:table-cell pcolor="#000000">
                                            <fo:block >
                                                Fecha : <xsl:value-of select="fechaImpresion"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                   	<fo:table-row>
                            ...
                            <!-- Fin caso de encontrarse pago consulta a Tercero -->  
                           	
                           	<!-- En caso de encontrarse pago consulta a Tercero -->    
							<xsl:otherwise>
                                    <fo:table-row>
                                    	<fo:table-cell color="#000000">
                                            <fo:block>
                                    ...
                                    <fo:table-row>
	                                    	<fo:table-cell color="#000000">
	                                            <fo:block>
	                                                Ejecutivo Suplente : <xsl:value-of select="ejeSuplente"/>
	                                            </fo:block>
	                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                               ...
                               <!-- Fin caso encontrarse pago consulta a Tercero -->        
                                </fo:table-body>
                            </fo:table>
                        </fo:block>
                        </fo:block>
                                ...
                                <fo:table-body>
                                    <fo:table-row font-weight="bold"  background-color="#E1E1E1">
                                        <fo:table-cell border="0.1pt solid black">
                                            <fo:block padding-left="1mm" text-align="center">
                                                Cuenta
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell border="0.1pt solid black">
