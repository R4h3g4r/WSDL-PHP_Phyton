...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <xsl:template name="rut" >
        ...
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
           &#8226; Calificación Aprobada en esta ficha: <xsl:value-of select="/informeGeneral/datosCalificaciones/calificacionAnalista"/>
        </fo:block>
        ...
        <xsl:choose>
           <xsl:when test="informeGeneral/datosCalificaciones/estadoCalificacion = 'Aprobada'">
             <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
                  &#8226; Calificación vigente al crear la ficha:&#0160;<xsl:value-of select="informeGeneral/datosCalificaciones/calificacionActualVisacion"/>
             </fo:block>
          </xsl:when>
          <xsl:otherwise>
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
           &#8226; Calificación actual:&#0160;<xsl:value-of select="informeGeneral/datosCalificaciones/calificacionActualVisacion"/>
        </fo:block>
          </xsl:otherwise>
        </xsl:choose>
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}"  >
       ...
       <!--  INICIO choose Finanzas y Proyecto -->
         <xsl:choose>
         <xsl:when test="(informeGeneral/estrategia/proyectosRG = 'NO')">
                  <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}" space-after="5mm" > 
             &#8226; Proyecto:&#0160;<xsl:value-of select="informeGeneral/estrategia/proyectosRG" /> 
                  </fo:block>
             </xsl:when>
         <xsl:when test="(informeGeneral/estrategia/proyectosRG = 'SI')">
                  <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}" space-after="5mm"> 
                  &#8226; Proyecto:&#0160;<xsl:value-of select="informeGeneral/estrategia/proyectosRG" /> 
                  </fo:block>
         </xsl:when>
         <xsl:when test="(informeGeneral/estrategia/finanzasRG = 'NO')">
             <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}" space-after="5mm"> 
             &#8226; Finanzas:&#0160;<xsl:value-of select="informeGeneral/estrategia/finanzasRG" /> 
                  </fo:block>
         </xsl:when>
         <xsl:when test="(informeGeneral/estrategia/finanzasRG = 'SI')">
             <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}" space-after="5mm"> 
             &#8226; Finanzas:&#0160;<xsl:value-of select="informeGeneral/estrategia/finanzasRG" /> 
                  </fo:block>
         </xsl:when>
       ...
       <fo:block text-align="left" margin-left="280pt" padding-top="-59pt" font-size="10pt" color="{$txt-azul-claro}">
         ...
         <xsl:choose>
           <xsl:when test="informeGeneral/datosCalificaciones/estadoCalificacion = 'Aprobada'">
               <fo:block text-align="left" margin-left="280pt" font-size="10pt" color="{$txt-azul-claro}">
                 &#8226; Fecha de calificación vigente al crear la ficha: &#0160; <xsl:value-of select="informeGeneral/datosCalificaciones/fechaCalifActual"/>
               </fo:block>
          </xsl:when>
          <xsl:otherwise>
        <fo:block text-align="left" margin-left="280pt" font-size="10pt" color="{$txt-azul-claro}">
        ...
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
         ...
         <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
           &#8226; Score: &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160; &#0160;&#0160; &#0160;&#0160;&#0160; &#0160; &#0160;    
           <xsl:choose>
           	<xsl:when test="(informeGeneral/datosCalificaciones/score > 0)">
           		<xsl:value-of select="informeGeneral/datosCalificaciones/score"/>
           	</xsl:when>
           </xsl:choose>    
        </fo:block>
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
        ...
        <fo:block space-after="5mm" space-before="-3mm" color="{$txt-azul-claro}">___________________________________________________________________________</fo:block>
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
           &#8226; Calificación Aprobada: &#0160; &#0160; <xsl:value-of select="informeGeneral/datosCalificaciones/calificacionAnalista"/>
        </fo:block>
        <fo:block text-align="left" font-size="10pt" color="{$txt-azul-claro}">
           &#8226; Argumentación:
        </fo:block>
        <fo:table table-layout="fixed" width="17.6cm" >
           ...
           <fo:table-body padding-top="1pt" wrap-option="wrap" hyphenate="true">
               <fo:table-row>
                   <fo:table-cell>
                       <fo:block text-align="justify" font-size="10pt" color="{$txt-azul-claro}">
                           <fo:inline><xsl:value-of select="informeGeneral/datosCalificaciones/calificacionPropuesta/argumentoEjecutivo"/></fo:inline>
                       </fo:block>
                   </fo:table-cell>
               </fo:table-row>
           </fo:table-body>
        ...
        <fo:block space-after="5mm" space-before="-3mm" color="{$txt-azul-claro}">___________________________________________________________________________</fo:block>
    <xsl:if test="informeGeneral/estrategia/cartera1RG != ' '">
       ...
       <fo:table font-size="10.00pt" table-layout="fixed">
            ...
            <fo:table-body border-color="{$txt-azul-claro}" font-size="10pt" text-align="left">
                <xsl:for-each select="informeGeneral/estrategia/cartera1RG">
                   <fo:table-row border="0.5pt solid" >
                     <fo:table-cell border="1pt">
                        ...
                        <fo:block margin-left="5pt" border="1pt" color="{$txt-azul-claro}" text-align="left">
                           &#8226; <xsl:value-of select="preguntacartera1RG" /> 
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
                </xsl:for-each>
       ...
       <xsl:if test="informeGeneral/estrategia/cartera2RG != ' '">
        <fo:block text-align="left" font-weight="bold" font-size="12pt" color="{$txt-azul-claro}">
        ...
        <fo:table font-size="10.00pt" table-layout="fixed">
            <fo:table-column column-width="200mm"/>
            <fo:table-body border-color="{$txt-azul-claro}" font-size="10pt" text-align="left">
                <xsl:for-each select="informeGeneral/estrategia/cartera2RG">
                   <fo:table-row border="0.5pt solid" >
                     <fo:table-cell border="1pt">
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                        <fo:block margin-left="5pt" border="1pt" color="{$txt-azul-claro}" text-align="left">
                           &#8226; <xsl:value-of select="preguntacartera2RG" /> 
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
                </xsl:for-each>
        ...
        <fo:block space-after="5mm" space-before="-3mm" color="{$txt-azul-claro}">___________________________________________________________________________</fo:block>      
         ...
         <xsl:if test="informeGeneral/estrategia/antecedentesRG != ' '">
       ...
       <!-- Tabla para preguntas de antecedentes clientes: Paso 3  -->
        ...
        <fo:table font-size="10.00pt" table-layout="fixed">
            ...
            <fo:table-body border-color="{$txt-azul-claro}" font-size="10pt" text-align="left">
                ...
                <xsl:for-each select="informeGeneral/estrategia/antecedentesRG">
                 <xsl:if test="respuestaRG != 'SR'">
                   <fo:table-row border="0.5pt solid" >
                     <fo:table-cell border="1pt">
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                        <fo:block font-size="10pt" margin-left="10pt" border="1pt" color="{$txt-azul-claro}" text-align="left">
                           <xsl:value-of select="preguntaRG" /> 
                        </fo:block>
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                    </fo:table-cell>
                    <fo:table-cell border="1pt">
                    ...
                    <fo:table-cell border="1pt">
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                        <fo:block font-size="10pt" border="1pt" color="{$txt-azul-claro}" text-align="left">
                            <xsl:value-of select="respuestaRG" />
                        </fo:block>
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                    </fo:table-cell>
                </fo:table-row>
      ...
      <!-- Antecedentes Financieros -->
       <xsl:if test="informeGeneral/estrategia/antFinancierosRG != ' '">
        <fo:block text-align="left" font-weight="bold" font-size="12pt" color="{$txt-azul-claro}">
           Antecedentes Financieros  
        </fo:block>
        <fo:block space-after="5mm" space-before="-3mm" color="{$txt-azul-claro}">___________________________________________________________________________</fo:block>
        ...
        <fo:table font-size="10.00pt" table-layout="fixed">
            ...
            <fo:table-body border-color="{$txt-azul-claro}" font-size="10pt" text-align="left">
                  <xsl:for-each select="informeGeneral/estrategia/antFinancierosRG"> 
                   <xsl:if test="descripComboRG != ''"> 
                   <fo:table-row border="0.5pt solid" >
                     <fo:table-cell border="1pt">
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                        <fo:block font-size="10pt" margin-left="10pt" border="1pt" color="{$txt-azul-claro}" text-align="left">
                            <xsl:value-of select="nombreComboRG" /> 
                        </fo:block>
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                    </fo:table-cell>
                    <fo:table-cell border="1pt">
                    ...
                    <fo:table-cell border="1pt">
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                        <fo:block font-size="10pt" border="1pt" color="{$txt-azul-claro}" text-align="left">
                            <xsl:value-of select="descripComboRG" /> 
                        </fo:block>
                        <fo:block space-after="3mm" space-before="-1mm" color="{$txt-azul-claro}"></fo:block>
                    </fo:table-cell> 
                 </fo:table-row>
