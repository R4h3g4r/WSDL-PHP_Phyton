		...
		<fo:block>
			<fo:table table-layout="fixed">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-size="15pt" font-weight="bold" text-align="left" color="{$txt-azul-claro}">Detalle Pérdida Esperada (PE)</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
				...
				<fo:table-body>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'PE % Banco:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/PEPorcentajeBanco"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/PELeasing"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'Origen:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/origen"/>
								</fo:block>
							</fo:table-cell>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/PEPorcentajeLeasing"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'PE Total:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/PETotal"/>
								</fo:block>
							</fo:table-cell>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
								<fo:block text-align="left" font-size="10pt" space-before="{$espacio-texto-celda-top}">
									<fo:inline color="{$txt-azul-oscuro}">
										<xsl:call-template name="vineta-roja">
											<xsl:with-param name="texto" select="'Clasificación Super:'"/>
										</xsl:call-template>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/clasificacionSuper"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/PEPorcentajeTotal"/>
								</fo:block>
							</fo:table-cell>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/fuenteDatos"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
			               ...
			               border-left-width="thin" border-left-color="{$borde-tabla}" border-right-style="solid" border-right-width="thin" border-right-color="{$borde-tabla}">
							...
							<fo:table-cell border="0.5pt solid {$lineas}">
								<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
									&#0160;<xsl:value-of select="info/PEBanco"/>
								</fo:block>
							</fo:table-cell>
