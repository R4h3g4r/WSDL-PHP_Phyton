									 ...
									 <fo:table-cell>
										...
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
											        <fo:inline font-size="11pt">                
																	          En ________________________, a _____ de ___________________ de ________  , entre el Banco de Crédito e Inversiones, RUT. N° 97.006.000-6, 
																	     ...
																	     R.U.T. N° &#0160; <xsl:value-of select="lineaEmergencia/rutCliente"/>, representada por don(ña)____________________________, Cédula de Identidad 
																	     N° ___________________, y por don(ña) ____________________________ Cédula de Identidad N° ___________________, todos domiciliados en 
																	     ...
																	     de Línea de Crédito de Emergencia, también llamada a efectos de este contrato como "LCE".
											         </fo:inline>
										</fo:block>
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
													<fo:inline font-size="11pt">
                                      ...
                                      <fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
                                            		<fo:inline font-size="11pt">
																	  ...
																	  LCE registrare saldos deudores, el Banco abonará total o parcialmente y de manera automática la citada LCE, con cargo a las señaladas disponibilidades.
													 </fo:inline>
                                       </fo:block>
                                       <fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
										<fo:inline font-size="11pt">                
                                       ...
                                       <fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
										...
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
											<fo:inline font-size="11pt">                
																	    10. El Cliente otorga mandato al Banco, para que éste, actuando en su nombre y representación, 
										...
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
											<fo:inline font-size="11pt"> 	
																	     El cliente reconoce que el presente mandato se otorga en interés del Banco y subsistirá aún después del 
																	     término de la presente Línea. El Cliente faculta al Banco para delegar el presente mandato en los mismos 
																	     términos, en la sociedad Servicios de Normalización y Cobranza - Normaliza S.A., filial del Banco, o en aquella  otra persona natural 
																	     o jurídica que el Banco determine.
										...
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
											<fo:inline font-size="11pt">                
																	    12. El Cliente declara conocer que la LCE está afecta a comisiones, las que el Banco podrá calcular y determinar
																		sobre la base de parámetros objetivos de segmentación y de acuerdo a su política de créditos, tarifas que se
																		contienen en el documento que en este mismo acto se le proporciona, declarando recibirlo a su entera
																		satisfacción. Las modificaciones que el Banco decida implantar al régimen de comisiones, ciñéndose al
																		procedimiento anteriormente citado, y que impliquen aumento de costos, serán comunicadas anticipadamente al
																		Cliente dentro del plazo que al efecto indiquen las normas de la Superintendencia de Bancos e Instituciones
																		Financieras. Aquellas modificaciones que impliquen disminución o eliminación de comisiones vigentes se
																		aplicarán sin comunicación previa. Con todo, cualquiera sea la modalidad o periodicidad de pago de las referidas
																		comisiones, en caso de cierre o término de uno o más de los productos contratados, el Banco siempre tendrá el
																		derecho de cobrar el total de las comisiones devengadas del respectivo período, independientemente del plazo
																		estipulado para hacerlo, encontrándose facultado el Banco para cargar tales comisiones
																		en la respectiva cuenta corriente, cuenta vista, línea de crédito o en cualquier tarjeta de crédito de que el Cliente
										...
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
											<fo:inline font-size="11pt">                
																		...
																		efectuarán a la dirección de correo electrónico que el cliente indica al final de este contrato. En su defecto, se
																		remitirán por escrito al último domicilio que tenga registrado en el Banco, ya sea por carta o en los estados de
										...
										<fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always">
											<fo:inline font-size="11pt">                
																	    Declaración del cliente: Es voluntad del Cliente que toda comunicación o aviso a que el Banco se encuentre obligado con
																	    motivo de lo establecido en este contrato, le sea remitido a la dirección de correo electrónico registrada en el Banco.
											</fo:inline>
										</fo:block>
									    ...
									    <fo:block space-before="1.3cm" space-after="0.5cm" font-size="11pt">
									    	<fo:table table-layout="center">
									    		...
									    		<fo:table-body>
									    			...
									    			<fo:table-row>
									    				<fo:table-cell number-columns-spanned="2">
									    					<fo:block text-align="center">Banco Crédito Inversiones</fo:block>
									    				</fo:table-cell>
									    			</fo:table-row>
									    		</fo:table-body>
									    	</fo:table>
