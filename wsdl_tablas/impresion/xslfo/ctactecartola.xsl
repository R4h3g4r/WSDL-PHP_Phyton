...
<!-- Movimientos de Su Cuenta -->
	<xsl:call-template name="subTitulo">
		<xsl:with-param name="titulo" select="'Movimientos de Su Cuenta'"/>
 	</xsl:call-template>
<!-- Movimientos de Su Cuenta -->
...
<xsl:template name="ladoizquierdo">
	...
	&#0160;<xsl:value-of select="info/saldoDisponible"/></fo:block>
	</fo:table-cell>
	...
	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="info/saldoContable"/></fo:block>
	</fo:table-cell>
	...
	<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="info/totalRetenciones"/></fo:block>
	</fo:table-cell>
	...
	<fo:table-cell border="0.5pt solid {$lineas}">
	<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
	&#0160;<xsl:value-of select="info/sobregiroDisponible"/>
	</fo:block>
	</fo:table-cell>
...
<xsl:template name="ladoderecho">
	...
	<fo:table-body>
		...
		<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
		<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="info/fechaUltimaCartola"/></fo:block>
		</fo:table-cell>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="info/folioUltimaCartola"/>
		</fo:block>
		</fo:table-cell>
		...
		<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
		<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="info/saldoUltimaCartola"/>
		</fo:block>
		</fo:table-cell>
		...
		<fo:table-cell border="0.5pt solid {$lineas}">
		<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="info/depositosYAbonos"/>
		</fo:block>
		</fo:table-cell>
		...
		<fo:table-cell background-color="{$bgcolor}" border="0.5pt solid {$lineas}">
		<fo:block font-weight="bold" color="{$txt-azul-oscuro}" padding-before="1mm" padding-after="1mm" text-align="left">
		&#0160;<xsl:value-of select="info/chequesYcargos"/>
		</fo:block>
		</fo:table-cell>
