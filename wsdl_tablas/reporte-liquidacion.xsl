            ...
            <fo:layout-master-set><!-- A4-portrait -->
                ...
                <fo:page-sequence master-reference="Letter">
                    <fo:flow flow-name="xsl-region-body">
						...
						<fo:block space-before="30" space-after="30">
	                        <fo:table>
	                       		<fo:table-body>
								     <fo:table-row >
								      	<fo:table-cell >
	                        				<fo:block text-align="right">Numero Operación</fo:block>
	                        			</fo:table-cell>
                        ...
                        <fo:block>
                        	Comunicamos a usted(es) el detalle de la oepración de la referencia
                        </fo:block>
                        
                        <fo:block font-style="backslant" line-height="5">                        
                       	...
                       	<fo:table>
                       		<fo:table-body>
							     <fo:table-row >
							        ...
							        <fo:table-cell>
							        	<fo:block font-size="10" text-align="right">
							        		<xsl:value-of select="root/montoOrigen"/>
							        	</fo:block>
							        </fo:table-cell>
							     </fo:table-row >
						     </fo:table-body>
                        ...
                        <fo:table>
                       		<fo:table-body>
							     <fo:table-row >
							        ...
							        <fo:table-cell>
							        	<fo:block  font-size="10" text-align="right">
							        		<xsl:value-of select="root/montoDestino"/>
							        	</fo:block>
							        </fo:table-cell>
							     </fo:table-row >
						     </fo:table-body>
					     ...
					     <xsl:if test="count(root/firmas/*) > 0" >
					     	<fo:block font-style="backslant" line-height="5">
					     	 ...
					     	 <fo:table width="300px">
					     	 <fo:table-header>
					     	 	<fo:table-row>
					     	 		<fo:table-cell>
					     	 			<fo:block space-after="20">Nombre</fo:block>
					     	 		</fo:table-cell>
					     	 		<fo:table-cell>
					     	 			<fo:block space-after="20">Apellido</fo:block>
					     	 		</fo:table-cell>
					     	 		<fo:table-cell>
					     	 			<fo:block space-after="20">Fecha</fo:block>
					     	 		</fo:table-cell>
					     	 	</fo:table-row>
					     	 </fo:table-header>
                       		<fo:table-body>
