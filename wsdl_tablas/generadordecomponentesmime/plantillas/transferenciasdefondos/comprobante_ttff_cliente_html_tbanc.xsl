...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <body>
	...
	<table width="616" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		<td style="font-size:12px; font-weight:bold; padding-left:20px; font-family:Tahoma, Geneva, sans-serif; padding-top:10px; padding-bottom:10px;">Estimado(A) : <xsl:value-of select="nombre-cliente" /></td>
	  </tr>
	  <tr>
		<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#f2f2f2; border:solid 1px #e3e3e3; height:40px; color:#333333; font-family:Tahoma, Geneva, sans-serif; font-size:12px;">
		  <tr>
			<td style="padding-left:20px;"> <xsl:value-of select="cabecera0.1" />&#160;<strong>
			<xsl:call-template name="FormatDate">
               <xsl:with-param name="DateTime" select="fecha-abono"/>		  
            </xsl:call-template></strong> <xsl:value-of select="cabecera2.1" />&#160;<strong>Nº <xsl:value-of select="cuenta-origen" /></strong>
			</td>
			</tr>
		</table></td>
	  </tr>
	  ...
	  <tr>
		<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="border: solid 1px #CCC;">
		 ...
		 <xsl:variable name="montoMuestra"><xsl:value-of select="monto"/></xsl:variable>
			<td width="49%" height="30" align="right" bgcolor="#c2c2c2"><strong>Monto transferido: </strong></td>
			<td width="4%" bgcolor="#c2c2c2"> </td>
			<td width="47%" bgcolor="#c2c2c2"> <strong>$<xsl:value-of select="translate($montoMuestra,',','.')"  /></strong></td>
		  </tr>		
		  <tr>
	 		<td width="49%" height="30" align="right" bgcolor="#e3e3e3">Nombre del Destinatario: </td>
			<td width="4%" bgcolor="#e3e3e3"> </td>
			<td width="47%" bgcolor="#e3e3e3"><strong><xsl:value-of select="nombre-destinatario" /></strong></td>
		  </tr>

		  <tr>
			<td height="30" align="right" bgcolor="#f2f2f2"><p>Banco de destino:</p></td>
			<td bgcolor="#f2f2f2"> </td>
			<td bgcolor="#f2f2f2"> <xsl:value-of select="banco-destino" /> </td>
		  </tr>
		  
		  <tr>
			<td height="30" align="right" bgcolor="#e3e3e3"><p>Cuenta de destino:</p></td>
			<td bgcolor="#e3e3e3"> </td>
			<td bgcolor="#e3e3e3"> <xsl:value-of select="cuenta-destino" /> </td>
		  </tr>
		  
		  <tr>
			<td height="30" align="right" bgcolor="#f2f2f2"><p>Fecha de abono:</p></td>
			<td bgcolor="#f2f2f2"> </td>
			<td bgcolor="#f2f2f2">
			<xsl:call-template name="FormatDate">
               <xsl:with-param name="DateTime"  select="fecha-abono" />
		   ...
		   <tr>
			...
			<td bgcolor="#e3e3e3"> </td>
			<td bgcolor="#e3e3e3"> <xsl:value-of select="comentario" /> </td>
		  </tr>
		  
		   <tr>
			<td height="30" align="right" bgcolor="#f2f2f2"><p>Número de operación:</p></td>
			<td bgcolor="#f2f2f2"> </td>
