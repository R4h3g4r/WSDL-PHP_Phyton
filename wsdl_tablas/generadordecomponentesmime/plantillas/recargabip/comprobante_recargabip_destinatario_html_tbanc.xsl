...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <body>
	...
	<table width="616" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		<td style="font-size:12px; font-weight:bold; padding-left:20px; font-family:Tahoma, Geneva, sans-serif; padding-top:10px; padding-bottom:10px;"><xsl:value-of select="cabecera1" />&#160;<xsl:value-of select="nombre-beneficiario" /></td>
	  </tr>
	  <tr>
		  ...
		  <tr>
			...
			<xsl:value-of select="cabecera2" />&#160;<strong>
				<xsl:call-template name="FormatDate">
					<xsl:with-param name="DateTime" select="fecha-transaccion"/></xsl:call-template>
				 </strong>&#160;<xsl:value-of select="cabecera3" />
			</td>
			</tr>
		</table></td>
	  </tr>
	  ...
	  <tr>
		<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="border: solid 1px #CCC;">
		 ...
		 <tr>
			<td width="49%" height="30" align="right" bgcolor="#e3e3e3"><p><strong>Tarjeta Bip!:</strong></p></td>
			<td width="4%" bgcolor="#e3e3e3"></td>
			<td width="47%" bgcolor="#e3e3e3"> <strong><xsl:value-of select="num-tarjeta-bip" /></strong> </td>
		  </tr>		
		  <tr>
	 		<td width="49%" height="30" align="right" bgcolor="#c2c2c2"><p><strong>Monto de Recarga: </strong></p></td>
			<td width="4%" bgcolor="#c2c2c2"></td>
			<td width="47%" bgcolor="#c2c2c2"><strong>$<xsl:value-of select="monto" /></strong></td>
		  </tr>
		  
		  <tr>
			<td height="30" align="right" bgcolor="#e3e3e3"><p>Número de Comprobante:</p></td>
			<td bgcolor="#e3e3e3"></td>
			<td bgcolor="#e3e3e3"><xsl:value-of select="num-comprobante" /></td>
		  </tr>
		  <tr>
			<td height="30" align="right" bgcolor="#f2f2f2"><p>Comentario:</p></td>
			<td bgcolor="#f2f2f2"> </td>
			<td bgcolor="#f2f2f2"> <xsl:value-of select="comentario" /> </td>
		  </tr>
		  </table>
	   </td>
	  </tr>
	  ...
	  <tr>
		<td style="font-size:10px; color:#999999; padding-left:20px; padding-right:20px;">
			...
			<br /><xsl:value-of select="pie-tbanc6" />	</td>
	  </tr>
	</table>
