...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="comprobante">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body bgcolor="#bababa" style="margin: 0px;">
				<table width="100%" cellspacing="0" border="0" bgcolor="#bababa">
					<tr>
						<td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table width="100%" cellpadding="0"  cellspacing="0"
                                            border="0" bgcolor="#1e1e1e">
                                            <tr>
                                                <td height="20" align="left" style="display:block;">
                                                    <img
                                                        src="http://www.bci.cl/medios/2012/empresarios/images/mailing/top_header-tbanc.gif"
                                                            ...
                                                            <td>
                                                                ...
                                                                <table width="100" border="0" align="right"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <img
                                                                                src="http://www.bci.cl/medios/2012/empresarios/images/mailing/logo-tbanc.gif"
                                                                                width="82" height="48" style="display:block;" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <table width="386" border="0" align="left"
                                                                    ...
                                                                    <tr>																																				
																			<td width="386" height="45" style="">
																				<span
																					style="font-family:Arial, Helvetica, sans-serif; font-size:30px; color:#fff;"><xsl:value-of select="titulo1" /></span>
																				<br></br>
																				<span
																					style="font-family:Arial, Helvetica, sans-serif; font-size:20px; color:#999;"><xsl:value-of select="titulo2" /></span>
																			</td>																		
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td height="3" align="left" bgcolor="#e32518"></td>
                                            </tr>
                                        </table>
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td width="" align="left" valign="top">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    cellpadding="0"
                                                                    style="font-family: Helvetica, Arial, sans-serif; font-size:12px; color:#666; line-height:130%;">
                                                                    <tr>
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="2"  height="30" >
																						...
																						<strong style="font-size:14px;color:#666; font-weight:normal;line-height:105%;">
                                                                            ...
                                                                            <table width="130%" border="0" cellspacing="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td width="4%" align="left" valign="top">
                                                                                        <img
                                                                                            src="http://www.bci.cl/medios/2012/empresarios/images/mailing/footer-barra_tbanc.gif"
                                                                        ...
                                                                        <td width="142" align="center" valign="top">
                                                                            <img
                                                                                src="http://www.tbanc.cl/medios/imag/mailings/2014/julio/mail_tercera_clave.jpg"
                                        ...
                                        <table width="100%" border="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <img
                                                        src="http://www.tbanc.cl/medios/imag/mailings/2014/junio/cuenta_corrienteTB_ban.jpg"
                                                        width="100%" />
                                                </td>
                                            </tr>
                                        </table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="left" valign="top">
                                                                            <table width="100%" border="0" cellspacing="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        style="color:#ffffff; font-size:10px; font-family:Helvetica,Arial,sans-serif; margin-top:0; margin-bottom:15px; padding-top:0;padding-bottom:15px; ">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td width="171" align="center">
                                                                            <img
                                                                                src="http://www.bci.cl/medios/2012/empresarios/images/mailing/icon-facebook_tbanc.gif"
                                                                                width="171" height="33" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top">
                                                                            <img
                                                                                src="http://www.bci.cl/medios/2012/empresarios/images/mailing/icon-twitter_tbanc.gif"
                                                                                width="171" height="33" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
