...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="500" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;" >
  ...
  <tr>
     <td colspan="8" valign="top" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;">
     ...
     <table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       <tr>
         <td bgcolor="#FFFFFF" style="text-align:right; font-family:Arial, Helvetica, sans-serif;"></td>
       </tr>
       <tr>
         <td bgcolor="#FFFFFF">&#160; </td>
       </tr>
       <tr>
         <td bgcolor="#FFFFFF" style="font-weight:bold; font-size:12px; font-family:Arial, Helvetica, sans-serif;">Estimado Cliente <xsl:value-of select="nombreCliente" />:</td>
       </tr>
       <tr>
         <td bgcolor="#FFFFFF">&#160; </td>
       </tr>
       <tr>
         ...
         <p>Se ha generado con éxito su <strong>solicitud N° <xsl:value-of select="numeroEventoSolicitudInformacion" /></strong>. Lo contactaremos dentro de las próximas 48 horas. Podrá realizar seguimiento a esta solicitud a través de la opción  Servicio al Cliente Bci, ingresando con su rut y clave a www<span style="letter-spacing:-1px;">. </span>bci<span style="letter-spacing:-1px;">. </span>cl.</p>
         <br />
         <p> </p>
