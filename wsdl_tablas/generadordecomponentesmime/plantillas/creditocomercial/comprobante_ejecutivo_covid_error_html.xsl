                ...
                <table cellpadding="0" cellspacing="0" style="background:#e2e8ea;width:100%;font-family: sans-serif;font-size: 13px;padding-bottom: 30px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" style="width:620px;border-collapse:collapse;margin-bottom: 29px; margin-top: 10px; border-bottom: 7px solid #ED0C19">
                                <tbody>
                                    <tr>
                                        <td>
                                            <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" style="width:400px;border-collapse:collapse;margin-bottom: 29px; margin-top: 29px;">
                                                ...
                                                <tr>
                                                    <xsl:if test="(datosCorreo/tipoError = '' )">
                                                    </xsl:if>

                                                    <xsl:if test="(datosCorreo/tipoError = '1' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Cliente sin margen para la línea COVID-19
                                                        </td>
                                                    </xsl:if>

                                                    <!--<xsl:if test="(datosCorreo/tipoError = '2' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Cliente sin margen para la línea de Reprogramación (COVID-19)
                                                        </td>
                                                    </xsl:if>
                                                    <xsl:if test="(datosCorreo/tipoError = '3' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Cliente no cuenta con IVAS necesarios para la Elegibilidad(FOGAPE) del producto COVID-19
                                                        </td>
                                                    </xsl:if>
                                                    <xsl:if test="(datosCorreo/tipoError = '4' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Cliente no registra disponible en FOGAPE para el curse de crédito COVID-19
                                                        </td>
                                                    </xsl:if> -->
                                                    <xsl:if test="(datosCorreo/tipoError = '5' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Cliente no tiene mandato firmado para cursar en línea crédito COVID-19
                                                        </td>
                                                    </xsl:if>
                                                    ...
                                                    <!--<xsl:if test="(datosCorreo/tipoError = '6' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            CURSE SIN ABONAR - COVID-19
                                                        </td>
                                                    </xsl:if>
                                                    <xsl:if test="(datosCorreo/tipoError = '7' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            CURSE SIN ABONAR - REPROGRAMACIÓN (COVID-19)
                                                        </td>
                                                    </xsl:if>
                                                    <xsl:if test="(datosCorreo/tipoError = '8' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Formalización y Abono no pudo ser realizado en línea
                                                        </td>
                                                    </xsl:if>-->
                                                    <xsl:if test="(datosCorreo/tipoError = '9' )">
                                                        <td style="font-size: 26px; font-weight: bold;  color: #37474F; ">
                                                            <img style="vertical-align: middle; height: 22px; margin-right: 10px;" src="https://bci.modyocdn.com/uploads/83d89761-48bf-4c96-87fa-8debc6d374bd/original/error-habilitador.png" />
                                                            Cliente ya cuenta con una formalización COVID-19
                                                        </td>
                                                    </xsl:if>
                                                    ...
                                                    <!-- <td>
                                                            <table align="center" style="max-width: 150px;">
                                                                ...
                                                                <tr>
                                                                    <td style="font-size: 20px; text-align: center; font-weight: 100">Covid-19 <xsl:if test="(datosCorreo/reprogramacion = '1')"> + Reprogramación</xsl:if>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td> -->
