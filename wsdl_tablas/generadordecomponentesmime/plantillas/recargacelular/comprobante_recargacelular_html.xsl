		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<table width="500" border="0" cellpadding="0" cellspacing="0"
					style="font:normal 12px Arial, Helvetica, sans-serif;border:solid 1px #CCC;padding:10px">
					<tr>
						<xsl:choose>
					...
					<tr>
						<td style="padding-top:10px;padding-bottom:10px;vertical-align:top;padding-right:10px;font-size:12px; ">
							...
							<p> <xsl:value-of select="cabecera2" />&#160;<xsl:value-of select="fecha-recarga" />&#160;<xsl:value-of select="cabecera3" /></p>
							<table border="0" align="left" cellpadding="0" cellspacing="0"
								style="font:normal 12px Arial, Helvetica, sans-serif;width:490px; color:#333333;">
								<tr bgcolor="#E5E5E5">
									<th align="right" valign="top" style="border:1px solid #fff; padding:2px 4px; width:50%; font-weight:normal;">
										<strong>Identificador:</strong>
									</th>
									<th align="left" valign="top" style="border:1px solid #fff; padding:2px 4px; width:50%; font-weight:normal;">
										<strong><xsl:value-of select="celular"/></strong>
									</th>
								</tr>
								<tr bgcolor="#FFFDD7">
									<th align="right" valign="top" style="border:1px solid #fff; padding:2px 4px; width:50%; font-weight:normal;">
								...
								<tr bgcolor="#E5E5E5">
									...
									<th align="left" valign="top" style="border:1px solid #fff; padding:2px 4px; width:50%; font-weight:normal;">
										<xsl:value-of select="numero-comprobante"/>
									</th>
								</tr>
							</table>
							<div style="clear:both;"></div>
									<p><xsl:value-of select="pieInfo" /> <strong style="color:#FF0000">&#160;<xsl:value-of select="pieFono" /></strong>.</p>
