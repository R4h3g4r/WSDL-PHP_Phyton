	...
	<table width="616" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		<td width="597">
		  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#FF9; border:solid 1px #FC0; height:50px; color:#333333; font-family:Tahoma, Geneva, sans-serif; font-size:12px;">
			<tr>
			  <td style="padding-left:20px;"><p><xsl:value-of select="cabecera0" />&#13;</p></td>
			</tr>
		  </table> </td>
	  </tr>
	  <tr>
		<td style="font-size:12px; font-weight:bold; padding-left:20px; font-family:Tahoma, Geneva, sans-serif; padding-top:10px; padding-bottom:10px;"><xsl:value-of select="cabecera1" /> : <xsl:value-of select="nombre-cliente" /></td>
	  </tr>
	  <tr>
		<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#f2f2f2; border:solid 1px #e3e3e3; height:40px; color:#333333; font-family:Tahoma, Geneva, sans-serif; font-size:12px;">
		  <tr>
			<td style="padding-left:20px;"> <xsl:value-of select="cabecera2" />&#160;<strong>
			<xsl:call-template name="FormatDate">
               <xsl:with-param name="DateTime" select="fecha-recarga"/>		  
            </xsl:call-template>&#160;</strong><xsl:value-of select="cabecera2.1" /> 
			</td>
			</tr>
		</table></td>
	  </tr>
	  ...
	  <tr>
		<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="border: solid 1px #CCC;">
		 ...
		 <tr>
			<td width="49%" height="30" align="right" bgcolor="#c2c2c2"><strong>Número de celular </strong></td>
			<td width="4%" bgcolor="#c2c2c2"> </td>
			<td width="47%" bgcolor="#c2c2c2"> <strong><xsl:value-of select="celular"/></strong></td>
		  </tr>		
		  <tr>
	 		<td width="49%" height="30" align="right" bgcolor="#e3e3e3">Monto de recarga </td>
			<td width="4%" bgcolor="#e3e3e3"> </td>
			<td width="47%" bgcolor="#e3e3e3">$ <xsl:value-of select="monto"/></td>
		  </tr>
		  
		  
		  <tr>
			<td height="30" align="right" bgcolor="#f2f2f2"><p>Compañía&#13;</p></td>
			<td bgcolor="#f2f2f2"></td>
			<td bgcolor="#f2f2f2"><xsl:value-of select="compania" /></td>
		  </tr>
		  <tr>
			<td height="30" align="right" bgcolor="#e3e3e3"><p>Cuenta de cargo&#13;</p></td>
			<td bgcolor="#e3e3e3"> </td>
			<td bgcolor="#e3e3e3"> <xsl:value-of select="cuenta-cargo" /> </td>
		  </tr>
		  
		  <tr>
			<td height="30" align="right" bgcolor="#f2f2f2"><p>Número comprobante&#13;</p></td>
			<td bgcolor="#f2f2f2"> </td>
			<td bgcolor="#f2f2f2"> <xsl:value-of select="numero-comprobante"/> </td>
		  </tr>
