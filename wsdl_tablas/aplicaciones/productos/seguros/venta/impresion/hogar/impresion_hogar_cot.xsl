		...
		<fo:block span="none" padding-before="6pt">
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
								<xsl:if test="( materiaAsegurada/usoVivienda = '4')">
									<xsl:text>Deshabitada menos de 60 días</xsl:text>
								</xsl:if>
								<xsl:if test="( materiaAsegurada/usoVivienda != '4')">
									<xsl:text>Deshabitada menos de 30 días</xsl:text>
								</xsl:if>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text disable-output-escaping="no">Antigüedad de vivienda</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
								<xsl:if test="( materiaAsegurada/antiguedad = '0')">
									<xsl:text>Menor a 50 años</xsl:text>
								</xsl:if>
								<xsl:if test="( materiaAsegurada/antiguedad = '1')">
									<xsl:text>Entre 50 y 80 años</xsl:text>
								</xsl:if>
								<xsl:if test="( materiaAsegurada/antiguedad = '2')">
									<xsl:text>Más de 80 años</xsl:text>
								</xsl:if>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text disable-output-escaping="no">Interés Asegurable</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text disable-output-escaping="no">Que Asegura</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
								<xsl:if test="( materiaAsegurada/materiaAsegurada = '1')">
									<xsl:text>Sólo Edificio</xsl:text>
								</xsl:if>
								<xsl:if test="( materiaAsegurada/materiaAsegurada = '2')">
									<xsl:text>Sólo Contenido</xsl:text>
								</xsl:if>
								<xsl:if test="( materiaAsegurada/materiaAsegurada = '3')">
									<xsl:text>Edificio y Contenido</xsl:text>
								</xsl:if>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text disable-output-escaping="no">Siniestros en las últimas 48 horas</xsl:text>
							</fo:block>
						</fo:table-cell>
	...
	<xsl:template name="temp_tituloPrimas">
		<fo:block span="none" padding-before="2pt">
			...
			<fo:table-column column-width="proportional-column-width(50)" />
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text>Solo habitacional</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt" font-weight="bold">
								<xsl:if test="( materiaAsegurada/usoVivienda = '4')">
					...
					<fo:table-row>
						<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text>Con edificio en construcción</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt" font-weight="bold">
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text>Con alguna ubicación que manipulen sustancias químicas/inflamables o explosivas</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="1.0pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt" font-weight="bold">
		...
		<xsl:if test="( materiaAsegurada/usoVivienda != '4')">
			...
			<xsl:for-each select="xmlPrimas/cia">
				...
				<fo:table-column column-width="proportional-column-width(25)"/>
					...
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell text-align="start" number-columns-spanned="4" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
						...
						<fo:table-row>	
							<xsl:if test="( prima/montoAsegurado != '0')">
							<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							...
							<xsl:if test="( prima/primaIncendio != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="prima/primaIncendio"/>
								</fo:block>
							</fo:table-cell>
							</xsl:if>		
							<xsl:if test="( prima/primaIncendio = '0')">
							...
							<xsl:if test="( prima/primaIncendioSismo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
			...
			<xsl:for-each select="xmlPrimas/cia">
				...
				<fo:table-column column-width="proportional-column-width(25)"/>
					...
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell text-align="start" number-columns-spanned="6" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="nombreProducto"/> - <xsl:value-of disable-output-escaping="no" select="nombreCia"/>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row>
							...
							<xsl:if test="( primaIncendioRobo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
							...
							<xsl:if test="( primaIncendioSismo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
							...
							<xsl:if test="( primaIncendioRoboSismo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
			...
			<xsl:for-each select="xmlPrimas/cia">
				...
				<fo:table-column column-width="proportional-column-width(9)" background-color="#F4F4F4"/>
				<fo:table-column column-width="proportional-column-width(18)"/>
				<fo:table-column column-width="proportional-column-width(19)" background-color="#F4F4F4"/>
				<fo:table-column column-width="proportional-column-width(23)"/>
					
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell text-align="start" number-columns-spanned="7" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="nombreProducto"/> - <xsl:value-of disable-output-escaping="no" select="nombreCia"/>
								</fo:block>
							</fo:table-cell>
			...
			<xsl:for-each select="xmlPrimas/cia">
				...
				<fo:table-column column-width="proportional-column-width(25)"/>
					...
					<fo:table-body>
						...
						<fo:table-row>
						<xsl:if test="( /DatosCotizacion/materiaAsegurada/materiaAsegurada = '1')">
							<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:text>Edificio</xsl:text>
								</fo:block>
						...
						<xsl:if test="( /DatosCotizacion/materiaAsegurada/materiaAsegurada = '2')">
							<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:text>Contenido</xsl:text>
								</fo:block>
				...
				<fo:block span="none" padding-before="6pt">
						...
						<xsl:for-each select="xmlDetallePago/cia">
							...
							<fo:table-row>
								...
								<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
										<xsl:text>Primas Brutas (UF)</xsl:text>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>	
							...
							<fo:table-row>
								...
								<xsl:if test="( primaBrutaIncendio != '0')">
								<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								...
								<!-- 4 -->
								<xsl:if test="( primaBrutaIncendioSismo != '0')">
								<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
			...
			<xsl:if test="( materiaAsegurada/materiaAsegurada = '1')">
				...
				<fo:table-column column-width="proportional-column-width(25)" background-color="#F4F4F4"/>
					...
					<xsl:for-each select="xmlDetallePago/cia">
						...
						<fo:table-row>
							<fo:table-cell text-align="start" number-columns-spanned="1" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:text>Monto Asegurado (UF) </xsl:text>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row>
							...
							<xsl:if test="( prima/primaBrutaIncendio != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
							...
							<xsl:if test="( prima/primaBrutaIncendioSismo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
				...
				<fo:table-column column-width="proportional-column-width(25)"/>
					...
					<xsl:for-each select="xmlDetallePago/cia">
						...
						<fo:table-row>
							...
							<xsl:if test="( primaBrutaIncendioRobo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
							...
							<xsl:if test="( primaBrutaIncendioRoboSismo != '0')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
			...
			<fo:block span="none" padding-before="6pt">
					...
					<xsl:for-each select="xmlDetallePago/cia">
						...
						<fo:table-row>
							...
							<!-- 5 -->
							<xsl:if test="( primaBrutaIncendioRobo != '0' and primaBrutaIncendioRobo != ' ')">
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="primaBrutaIncendioRobo"/>
								</fo:block>
	...
	<xsl:template name="temp_tituloMediosPago">
		...
		<xsl:template name="temp_vigencia">
			<fo:block span="none">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="start"  border-width="0.1pt" padding="4pt">
					...
					<fo:table-row>
						<fo:table-cell text-align="start" border-width="0.1pt" padding="4pt">
								<fo:block padding-before="0pt" font-size="11.0pt" color="#0360A2">La vigencia de esta cotización es de 10 días</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
				</fo:table>
...
<!-- Se realiza modificacion  para seguro hogar de uso veraneo/recreacional -->