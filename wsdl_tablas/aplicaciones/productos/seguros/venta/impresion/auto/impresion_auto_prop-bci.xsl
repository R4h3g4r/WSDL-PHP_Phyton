...
<xsl:template match="DatosPropuesta">
		...
		<xsl:choose>
			<xsl:when test="(cobertura/flagPT = 'S')">
				<fo:block				
					...
					<xsl:attribute name="background-image">url('<xsl:value-of disable-output-escaping="no" select="rutaLogos"/>/logos/Hoja_resumen_PT.jpg')</xsl:attribute>
					<fo:table table-layout="fixed" width="100%">
		...
		<xsl:otherwise>
			<fo:block				
		        ...
		        background-color="white"
		        background-repeat="no-repeat">
				<xsl:attribute name="background-image">url('<xsl:value-of disable-output-escaping="no" select="rutaLogos"/>/logos/Hoja_resumen_sl_crecorte_r7.jpg')</xsl:attribute>
					<fo:table table-layout="fixed" width="100%">
			            <fo:table-column column-width="proportional-column-width(57)"/>
						<fo:table-body>
							<fo:table-row>
						...
						<fo:table-row>
							<fo:table-cell number-columns-spanned="3" padding="10pt" padding-after="3pt" padding-before="3pt">
								<fo:block text-align="left" font-size="11pt" color="#0360A2" padding="4pt" border-style="solid" border-width="0.1pt" border-color="#0360A2">
									Esta entidad aseguradora, en consideración a la Propuesta presentada por el asegurado, y por las Condiciones Particulares y Generales que a continuación se acompañan, asegura lo siguiente:
								</fo:block>
							</fo:table-cell>						
						</fo:table-row>
					</xsl:if>
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="2pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
								<xsl:text> ASEGURADO / CONTRATANTE</xsl:text>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
		...
		<fo:block span="none">
				...
				<fo:table-body>
					...
					<fo:table-row>
							...
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text>Interés Asegurable</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
			...
			<fo:table-column column-width="proportional-column-width(100)" background-color="#FFFFFF"/>
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
								<xsl:text>USO ESPECÍFICO</xsl:text>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			...
			<fo:table-column column-width="proportional-column-width(15)" background-color="#FFFFFF"/>
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="12.0pt" >
								<xsl:text>Vehículo de arriendo o rent car</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="12.0pt" border-style="solid" border-width="1.5pt" border-color="#0360A2">
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="12.0pt" >
								<xsl:text>Vehículo de emergencia</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="12.0pt" border-style="solid" border-width="1.5pt" border-color="#0360A2">
...
<!-- 
 ...
 -->
						...
						<fo:table-cell text-align="center" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="detallePago/montoPrimerPago"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
...
<!-- *********************************************************FIRMAS FINALES **************************************************** -->
	<xsl:template name="temp_firmas_poliza">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-width="proportional-column-width(24)"/>
			<fo:table-body>
				<xsl:if test="(contains(tarifa/descripcion, 'Ampliada')) or (contains(tarifa/descripcion, 'Trianual')) or (contains(tarifa/descripcion, 'Bianual'))">
				<fo:table-row keep-with-next="always">
	        	...
	        	<xsl:if test="not(contains(tarifa/descripcion, 'Ampliada')) and not(contains(tarifa/descripcion, 'Trianual')) and not(contains(tarifa/descripcion, 'Bianual'))">
				<fo:table-row keep-with-next="always">
					...
					<fo:table table-layout="fixed" width="100%">
						...
						<fo:table-body>
							<fo:table-row height="14pt">
								...
								<fo:table-cell text-align="left" display-align="left" padding-left="7pt">
									<fo:block white-space-collapse="true" text-align="left" color="#0360A2" font-size="9.0pt" font-weight="bold">
										<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/descripcionTipoVehiculo"/> - Año 
										<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/anoFabricacionVehiculo"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="left" display-align="left" padding-left="0pt">
			...
			<fo:table-body>
				<fo:table-row>					
					...
					<fo:table-cell text-align="justify" display-align="left" color="black">
						...
						<fo:block font-size="6pt" color="green" font-weight="bold">En caso de robo del vehículo asegurado (total o parcial) o accidente de tránsito con lesionados:</fo:block>
<fo:block white-space-collapse="false" text-align="left" color="black" font-size="6pt">Es obligación legal hacer la DENUNCIA INMEDIATA en un plazo máximo de 2 horas de ocurrido el siniestro del accidente/hechos, en la Comisaría 
más cercana.</fo:block><fo:block font-size="6pt" color="green" font-weight="bold">En caso de accidentes solo con consecuencia de daños, ya sea propios o a terceros:</fo:block>
<fo:block white-space-collapse="false" text-align="left" color="black" font-size="6pt">NO SE REQUIERE DEJAR CONSTANCIA en Carabineros, bastando informar del siniestro a la compañía de seguro mediante una DECLARACIÓN JURADA SIMPLE.
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		...
		<fo:table table-layout="fixed" width="100%" >
			...
			<fo:table-body>
				<fo:table-row>					
					...
					<fo:table-cell text-align="justify" display-align="left" color="black">
						<fo:block font-size="6pt" color="red" font-weight="bold">Denuncia Compañía</fo:block>
						<fo:block font-size="6pt" color="red" font-weight="bold">En caso de robo del vehículo asegurado (total o parcial) o accidente de tránsito con lesionados:</fo:block>
<fo:block white-space-collapse="false" text-align="left" color="black" font-size="6pt">Informar del siniestro a la Compañía de Seguros inmediatamente en un plazo máximo de 2 horas de ocurrido el siniestro-, ingresando los datos en www.bciseguros.cl o 
llamando desde Red Fija al 600 6000 292 y desde Celulares al (2) 2 679 9700. </fo:block>
<fo:block font-size="6pt" color="red" font-weight="bold">En caso de accidentes solo con consecuencia de daños, ya sea propios o a terceros:</fo:block>
<fo:block white-space-collapse="false" text-align="left" color="black" font-size="6pt">Informar del siniestro a la Compañía de Seguros mediante una DECLARACIÓN JURADA SIMPLE. Para efectuar la Declaración Jurada Simple, puede ingresar a www.bciseguros.cl o llamar desde Red Fija al 600 6000 292 y desde Celulares al (2) 2 679 9700. Tendrá un plazo máximo de 5 días de ocurrido el siniestro 
para informar del siniestro a la Compañía.
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		...
		<fo:table table-layout="fixed" width="100%" >
			...
			<fo:table-body>
				<fo:table-row>					
					...
					<fo:table-cell text-align="justify" display-align="left" color="black">
					<fo:block font-size="6pt" color="blue" font-weight="bold">Envío a Taller</fo:block>
<fo:block white-space-collapse="false" text-align="left" color="black" font-size="6pt" >Tras denunciar el siniestro, se asignará un liquidador y el taller al que deberá llevar su vehículo, previa reserva de hora.
						</fo:block>
                        ...
                        <fo:table-body>
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell text-align="start" display-align="before" border-color="#FFFFFF" padding-left="8pt">
                                    <fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
                                        <xsl:text>Póliza Nº :&#0160;&#0160;</xsl:text><xsl:value-of select="../../DatosPoliza/numeroPoliza" />
                                    </fo:block>
                                </fo:table-cell>
    ...
    <xsl:template name="temp_hoja_resumen_PT">
				...
				<fo:block span="none" padding-before="7pt" font-family="Helvetica">
					<fo:table table-layout="fixed" width="100%">
						<fo:table-column column-width="proportional-column-width(7)" />
						<fo:table-column column-width="proportional-column-width(15)" />
						<fo:table-column column-width="proportional-column-width(63)" />
				...
				<fo:block span="none" padding-before="4.5pt">
					<fo:table table-layout="fixed" width="100%">
						<fo:table-column column-width="proportional-column-width(70)" />
						<fo:table-column column-width="proportional-column-width(16)" />
						<fo:table-column column-width="proportional-column-width(8)" />
	...
	<fo:block padding-before="6pt">
		<fo:table table-layout="fixed" width="50%" >
			<fo:table-column column-width="proportional-column-width(7.7)" />
			<fo:table-column column-width="proportional-column-width(35.3)" />
			<fo:table-column column-width="proportional-column-width(25)" />
			<fo:table-column column-width="proportional-column-width(18)" />
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell text-align="left" display-align="left" padding-left="0pt">
						<fo:block white-space-collapse="true" text-align="left" color="#575756" font-size="6.5pt" font-weight="bold">
						CONCEPTO	
						</fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="left" display-align="left" padding-left="0pt">
                ...
                <fo:table-body>
					...
					<xsl:choose>
						<xsl:when test="( prima = '1,00' )">
							<fo:table-row>
								<fo:table-cell text-align="start" display-align="before" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt" font-weight="bold">
									</fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="start" display-align="before" border-bottom-style="solid" border-bottom-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" padding-top="1pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt" >
													<xsl:value-of disable-output-escaping="no" select="texto"/>
										</fo:block>
								</fo:table-cell >
								<fo:table-cell text-align="start" display-align="before" border-color="#DCDCDC" padding-left="8pt" padding-top="1pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt" padding-top="8.5pt">
													<xsl:value-of disable-output-escaping="no" select="monto"/>
									</fo:block>
								</fo:table-cell>                                
								<fo:table-cell text-align="start" display-align="before" border-color="#DCDCDC" padding-left="10pt" padding-top="1pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt" padding-top="10pt">
													<xsl:value-of disable-output-escaping="no" select="codigoSVS"/>
										</fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="start" display-align="before" border-color="#DCDCDC" padding-left="27pt" padding-top="1pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt">
							...
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt" font-weight="bold">
								...
								<fo:table-cell text-align="start" display-align="before" border-bottom-style="solid" border-bottom-width="0.1pt" border-color="#DCDCDC" padding-left="10pt" padding-top="1pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt">
													
										</fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="start" display-align="before" border-bottom-style="solid" border-bottom-width="0.1pt" border-color="#DCDCDC" padding-left="27pt" padding-top="1pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="7.55pt">
		...
		<fo:table table-layout="fixed" width="100%" >
			...
			<fo:table-body>
				<fo:table-row>					
					...
					<fo:table-cell text-align="justify" display-align="left" color="black">
						<fo:block white-space-collapse="false" text-align="left" color="white" font-size="6pt" >
      - En caso de cualquier accidente con daños en el auto asegurado o a terceros debe realizar,
	inmediatamente ocurrido el siniestro, una constancia o denuncia policial en la unidad de
	carabineros más cercana y entregar la mayor cantidad de datos posibles de los hechos ocurridos;
	salvo si hay alguna imposibilidad médica que debe estar acreditada por un médico. (Inmediato:
	Sin interposición de otra cosa. (ahora, al punto, al instante).
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		...
		<fo:table table-layout="fixed" width="100%" >
			...
			<fo:table-body>
				<fo:table-row>					
					...
					<fo:table-cell text-align="justify" display-align="left" color="black">
						<fo:block white-space-collapse="false" text-align="left" color="white" font-size="6pt" >
	- Llamar al call center 600 6000 292, desde celulares al (02) 26799700.
	- Para siniestros de Robo del vehículo o de alguna de sus partes y piezas, el denuncio en la Compañía de
	  Seguros es Inmediato.
	- Para siniestros distintos de robos , el plazo máximo para el denuncio en la Compañía es de 10 días corridos
		...
		<fo:table table-layout="fixed" width="100%" >
			...
			<fo:table-body>
				<fo:table-row>					
					...
					<fo:table-cell text-align="justify" display-align="left" color="black">
						<fo:block white-space-collapse="false" text-align="left" color="white" font-size="6pt" >
	- Recuerde que el liquidador inspeccionará y/o investigará las circunstancias del siniestro para confirmar si éste tiene
	  cobertura de acuerdo a las condiciones particulares y generales de la póliza contratada, para lo cual tiene un plazo de 45
	  días prorrogables ante la SVS en casos justificados .
	- Usted deberá tener la información necesaria para que el proceso pueda ser ágil (escrito completo policial, toda la
	  documentación del vehículo, y toda información anexa que requiera el liquidador).
	- En caso de terceros involucrados (inocentes/culpables), debe tomar la mayor cantidad de datos (nombre, rut, teléfono,
	  dirección, patente y marca del vehículo, si tiene seguros y en que compañía). *nunca llegar a ningún tipo de acuerdo.
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
