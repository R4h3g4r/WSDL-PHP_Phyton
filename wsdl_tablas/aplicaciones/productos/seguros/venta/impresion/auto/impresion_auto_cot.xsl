...
<xsl:template match="DatosCotizacion">
	...
	<xsl:template name="temp_datosConductorHabitual">
		<fo:block span="none" padding-before="6pt">
			...
			<fo:table-row>
				...
				<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
				<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
				<xsl:text></xsl:text><xsl:value-of disable-output-escaping="no" select="materiaAsegurada/rutConductorHabitual"/>
				<xsl:text>-</xsl:text><xsl:value-of disable-output-escaping="no" select="materiaAsegurada/dvConductorHabitual"/>
				</fo:block>
				</fo:table-cell>
				<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
				<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
				...
				<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
				<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
				<xsl:text></xsl:text><xsl:value-of disable-output-escaping="no" select="materiaAsegurada/edadConductorHabitual"/>
				</fo:block>
				</fo:table-cell>
				</fo:table-row>
		<!-- 		<fo:table-row>
	...
	<xsl:template name="temp_tituloDatosPrimas">
		<fo:block span="none" padding-before="6pt">
			<xsl:if test="( planesGlobales/largoTotal = '2' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(65)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(35)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="10pt" padding-left="8pt">
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" number-columns-spanned="1" column-number="2" display-align="before" font-weight="bold" padding-before="4pt">
						...
						<fo:table-row padding-before="0pt">
							<xsl:if test="( hayConConduccion = 'true' )">
								<fo:table-cell text-align="center" column-number="2" number-columns-spanned="1" display-align="before" font-weight="bold" padding-before="4pt">
									<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
										<xsl:text>Con Conducción Exclusiva</xsl:text>
									</fo:block>
								</fo:table-cell>
							</xsl:if>
							<xsl:if test="( haySinConduccion = 'true' )">	
								<fo:table-cell text-align="center" column-number="2" number-columns-spanned="1" display-align="before" font-weight="bold" padding-before="4pt">
									<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
										<xsl:text>Sin Conducción Exclusiva</xsl:text>
									</fo:block>
								</fo:table-cell>
							</xsl:if>
						</fo:table-row>
						<fo:table-row padding-before="0pt">
							<fo:table-cell text-align="start" column-number="1" number-rows-spanned="3" display-align="before" font-weight="bold" border-after-style="solid" border-color="#DCDCDC" background-color="#FFFFFF" padding-before="4pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Planes</xsl:text>
								</fo:block>
							</fo:table-cell>
							<xsl:for-each select="deducibles/deducible">
								<fo:table-cell text-align="center" display-align="center" font-weight="bold" border-after-style="solid" border-color="#DCDCDC" background-color="#FFFFFF" padding-before="4pt" padding-left="8pt">
									<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
										<xsl:text>Deducible </xsl:text><xsl:value-of disable-output-escaping="no" select="valor"/><xsl:text> UF</xsl:text>
									</fo:block>
								</fo:table-cell>
							</xsl:for-each>
						</fo:table-row>
			...
			<xsl:if test="( planesGlobales/largoTotal = '3' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(50)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(25)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(25)" column-number="3" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" number-columns-spanned="3" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="10pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Compañía&#0160;:&#0160;</xsl:text> <xsl:value-of disable-output-escaping="no" select="descripcionCompania"/>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" number-columns-spanned="2" column-number="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Primas Brutas Mensuales en UF</xsl:text>
								</fo:block>
							</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '4' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(20)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(20)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(20)" column-number="3" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(20)" column-number="4" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" number-columns-spanned="4" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="10pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Compañía&#0160;:&#0160;</xsl:text> <xsl:value-of disable-output-escaping="no" select="descripcionCompania"/>
								</fo:block>
							</fo:table-cell>
...
<xsl:if test="( hayConConduccion = 'true' )">
		 	...
		 	<xsl:if test="( planesGlobales/largoTotal = '5' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(25)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="3" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="4" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="5" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" number-columns-spanned="5" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="10pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Compañía&#0160;:&#0160;</xsl:text> <xsl:value-of disable-output-escaping="no" select="descripcionCompania"/>
								</fo:block>
							</fo:table-cell>
					...
					<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" number-columns-spanned="2" column-number="3" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Primas Brutas Mensuales en UF</xsl:text>
								</fo:block>
							</fo:table-cell>
					 ...
					 <fo:table-row padding-before="0pt">
								<fo:table-cell text-align="start" column-number="1" number-rows-spanned="1" display-align="center" font-weight="bold" border-after-style="solid" border-color="#DCDCDC" background-color="#FFFFFF" padding-before="4pt" padding-left="8pt">
									<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
										<xsl:text>Planes</xsl:text>
									</fo:block>
								</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '6' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(25)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="3" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="4" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="5" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(15)" column-number="6" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" number-columns-spanned="6" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="10pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Compañía&#0160;:&#0160;</xsl:text> <xsl:value-of disable-output-escaping="no" select="descripcionCompania"/>
								</fo:block>
							</fo:table-cell>
...
<xsl:if test="( hayConConduccion = 'true' )">
							<fo:table-cell text-align="center" column-number="2" number-columns-spanned="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Con Conducción Exclusiva</xsl:text>
								</fo:block>
							</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '7' )">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(20)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="2" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="3" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="4" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="5" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="6" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="7" background-color="#FFFFFF"/>
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" number-columns-spanned="7" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="10pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Compañía&#0160;:&#0160;</xsl:text> <xsl:value-of disable-output-escaping="no" select="descripcionCompania"/>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" number-columns-spanned="6" column-number="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Primas Brutas Mensuales en UF</xsl:text>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row padding-before="0pt">
						 <xsl:if test="( hayConConduccion = 'true' )">
							<fo:table-cell text-align="center" column-number="2" number-columns-spanned="3" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Con Conducción Exclusiva</xsl:text>
								</fo:block>
							</fo:table-cell>
						...
						<xsl:if test="( haySinConduccion = 'true' )">
							<fo:table-cell text-align="center" column-number="5" number-columns-spanned="3" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Sin Conducción Exclusiva</xsl:text>
								</fo:block>
							</fo:table-cell>
	...
	<xsl:template name="temp_datosPrimas">	
		<fo:block span="none" padding-before="6pt">
			<xsl:if test="( planesGlobales/largoTotal = '2' )">	
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(65)" background-color="#FFFFFF"/>
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_0_descripcionPlan"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_0_primaBrutaMensualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Sin_0_descripcionPlan"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Sin_0_primaBrutaMensualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
			...
			<xsl:if test="( planesGlobales/largoTotal = '3' )">	
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_1_primaBrutaMensualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Sin_1_primaBrutaMensualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
			...
			<xsl:if test="( planesGlobales/largoTotal = '4' )">	
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_2_primaBrutaMensualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Sin_2_primaBrutaMensualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
					...
					<xsl:if test="( hayConConduccion = 'true' )">
							...
							<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_2_primaBrutaMensualAMostrar"/>
											...
											<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
												<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
														<xsl:value-of disable-output-escaping="no" select="Con_3_primaBrutaMensualAMostrar"/>
												</fo:block>
											</fo:table-cell>
									   </fo:table-row>
								 </xsl:for-each>
						...
						<xsl:if test="( haySinConduccion = 'true' )">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
										...
										<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
											<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
													<xsl:value-of disable-output-escaping="no" select="Sin_3_primaBrutaMensualAMostrar"/>
											</fo:block>
										</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '6' )">
					...
					<xsl:for-each select="planesGlobales/compania">
									...
									<xsl:for-each select="plan">
										<fo:table-row padding-before="4pt">
											...
											<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
												...
												<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
												<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
														<xsl:value-of disable-output-escaping="no" select="Con_4_primaBrutaMensualAMostrar"/>
												</fo:block>
											</fo:table-cell>
									   </fo:table-row>
								 </xsl:for-each>
						...
						<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
										...
										<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
											<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
													<xsl:value-of disable-output-escaping="no" select="Sin_4_primaBrutaMensualAMostrar"/>
											</fo:block>
										</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '7' )">
					...
					<fo:table-column column-width="proportional-column-width(14)" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" background-color="#FFFFFF"/>
					...
					<xsl:if test="( hayConConduccion = 'true' )">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_5_primaBrutaMensualAMostrar"/>
												</fo:block>
											</fo:table-cell>
									   </fo:table-row>
								 </xsl:for-each>
						...
						<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
										...
										<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
											<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
													<xsl:value-of disable-output-escaping="no" select="Sin_5_primaBrutaMensualAMostrar"/>
											</fo:block>
										</fo:table-cell>
								</fo:table-row>
					</xsl:for-each>
			...
			<xsl:if test="( planesGlobales/largoTotal = '2' )">
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" number-columns-spanned="1" column-number="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Primas Brutas en UF</xsl:text>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row padding-before="0pt">
...
<xsl:if test="( hayConConduccion = 'true' )">
						...
						<fo:table-row padding-before="0pt">
							<fo:table-cell text-align="start" column-number="1" number-rows-spanned="1" display-align="before" font-weight="bold" border-after-style="solid" border-color="#DCDCDC" background-color="#FFFFFF" padding-before="4pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Planes</xsl:text>
								</fo:block>
							</fo:table-cell>
	 		...
	 		<xsl:if test="( planesGlobales/largoTotal = '5' )">
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="0pt">
						<xsl:if test="( hayConConduccion = 'true' )">
							<fo:table-cell text-align="center" column-number="3" number-columns-spanned="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Con Conducción Exclusiva</xsl:text>
								</fo:block>
							</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '2' )">	
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_0_primaBrutaAnualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Sin_0_primaBrutaAnualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
			...
			<xsl:if test="( planesGlobales/largoTotal = '3' )">	
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_1_primaBrutaAnualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Sin_1_primaBrutaAnualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
			...
			<xsl:if test="( planesGlobales/largoTotal = '4' )">	
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_2_primaBrutaAnualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						</xsl:for-each>
						...
						<xsl:if test="( haySinConduccion = 'true' )">
							<xsl:for-each select="plan">
								<fo:table-row padding-before="4pt">
										...
										<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
											<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
													<xsl:value-of disable-output-escaping="no" select="Sin_2_primaBrutaAnualAMostrar"/>
											</fo:block>
										</fo:table-cell>
								</fo:table-row>
							</xsl:for-each>
					...
					<xsl:if test="( hayConConduccion = 'true' )">
							...
							<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_2_primaBrutaAnualAMostrar"/>
											...
											<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
												<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
														<xsl:value-of disable-output-escaping="no" select="Con_3_primaBrutaAnualAMostrar"/>
												</fo:block>
											</fo:table-cell>
									   </fo:table-row>
								 </xsl:for-each>
						...
						<xsl:if test="( haySinConduccion = 'true' )">
							...
							<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
										...
										<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
											<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
													<xsl:value-of disable-output-escaping="no" select="Sin_3_primaBrutaAnualAMostrar"/>
											</fo:block>
										</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '6' )">
					...
					<xsl:for-each select="planesGlobales/compania">
							<xsl:if test="( hayConConduccion = 'true' )">
								...
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_3_primaBrutaAnualAMostrar"/>
											...
											<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
												<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
														<xsl:value-of disable-output-escaping="no" select="Con_4_primaBrutaAnualAMostrar"/>
												</fo:block>
											</fo:table-cell>
									   </fo:table-row>
								 </xsl:for-each>
						...
						<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
										...
										<fo:table-cell text-align="center" display-align="center" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
											<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
													<xsl:value-of disable-output-escaping="no" select="Sin_4_primaBrutaAnualAMostrar"/>
											</fo:block>
										</fo:table-cell>
			...
			<xsl:if test="( planesGlobales/largoTotal = '7' )">
					...
					<xsl:if test="( hayConConduccion = 'true' )">
						...
						<fo:table-row padding-before="4pt">
							...
							<fo:table-cell text-align="center" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="Con_5_primaBrutaAnualAMostrar"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</xsl:for-each>
