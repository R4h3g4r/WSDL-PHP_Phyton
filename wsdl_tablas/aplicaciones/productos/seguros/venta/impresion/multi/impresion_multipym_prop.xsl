		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block >
							<xsl:call-template name="temp_tituloAseguradosMuerteAccidental"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block >
							<xsl:call-template name="temp_datosAseguradosMuerteAccidental"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
...
<xsl:if test="( DatosPoliza/condicionPoliza = 'SI' )">
		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block >
							<xsl:call-template name="temp_poder_especial"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
	...
	<xsl:template name="temp_tituloAseguradosMuerteAccidental">
			<fo:block span="none">
				<fo:table table-layout="fixed" width="100%">
				<fo:table-column column-width="proportional-column-width(100)" background-color="#FFFFFF"/>
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
									<xsl:text>ASEGURADOS COBERTURA MUERTE ACCIDENTAL</xsl:text>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
	...
	<xsl:template name="temp_datosAseguradosMuerteAccidental">
		<xsl:variable name="auxCodigoPlan" select="tarifa/codigo" />
		<xsl:for-each select="xmlAseguradosMuerteAccidental/aseguradoMuerteAccidental">
				<fo:block span="none">
					<fo:table table-layout="fixed" width="100%">
						<fo:table-column column-width="proportional-column-width(100)" background-color="#FFFFFF"/>
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
									<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
											<xsl:if test="$auxCodigoPlan != 'PYMEM'">
										<xsl:text>ASEGURADO NRO. </xsl:text><xsl:value-of disable-output-escaping="no" select="correlativo"/><xsl:text> COB. MUERTE ACCIDENTAL </xsl:text>
											</xsl:if>
											<xsl:if test="$auxCodigoPlan = 'PYMEM'">
												<xsl:text>ASEGURADO ASOCIADO </xsl:text>
												<xsl:value-of disable-output-escaping="no" select="position()"/>
											</xsl:if>
				...
				<fo:block span="none">
					...
					<fo:table-body>
						...
						<fo:table-row>
							...
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="nombres"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
							...
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="apellidoPaterno"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row>
							...
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="apellidoMaterno"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
						...
						<fo:table-row>
							...
							<fo:table-cell text-align="start" number-columns-spanned="2" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="direccionPostal"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
						...
						<fo:table-row>
							...
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="descripcionCiudadPostal"/>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
							...
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="descripcionComunaPostal"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
...
<!-- *********************************************************FIRMAS FINALES **************************************************** -->
	...
	<xsl:template name="temp_poder_especial">
		<xsl:for-each select="adicional/texto">
			<xsl:if test="(condicion = 'PODER_ESPECIAL')">
				<fo:block break-before="page"></fo:block>
				<fo:block span="none" padding-before="6pt" margin="20pt">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(100)" />
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell border-left-style="solid" border-top-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#000000" background-color="#FFFFFF" padding="8pt" padding-left="8pt" color="#000000">
									<fo:block white-space-collapse="false" padding-before="0pt" font-size="11.0pt" text-align="center" font-weight="bold" padding-top="10pt">
										<fo:inline>
											<xsl:value-of disable-output-escaping="no" select="titulo"/>
										</fo:inline>
									</fo:block>
						...
						<fo:table-row>
							<fo:table-cell border-left-style="solid" border-bottom-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#000000" background-color="#FFFFFF" padding="15pt" padding-left="8pt" color="#000000">
									<fo:block white-space-collapse="false" padding-before="0pt" font-size="11.0pt" text-align="justify">
										<fo:inline>
											<xsl:value-of disable-output-escaping="no" select="descripcion"/>
										</fo:inline>
									</fo:block>
						...
						<fo:table-row>
							<fo:table-cell border-left-style="solid" border-bottom-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#000000" background-color="#FFFFFF" padding-top="15pt" padding-bottom="5pt" padding-left="8pt" color="#000000">
									<fo:block white-space-collapse="false" padding-before="0pt" font-size="11.0pt" text-align="center">
										<xsl:value-of select="../../Cotizacion/fechaPropuesta"/><xsl:text>                         ________________________</xsl:text>
									</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row>
							<fo:table-cell border-left-style="solid" border-bottom-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#000000" background-color="#FFFFFF" padding-left="8pt" padding-bottom="30pt" color="#000000">
									<fo:block white-space-collapse="false" padding-before="0pt" font-size="11.0pt">
										<xsl:text>                                           Fecha                                   Firma Asegurado Nº </xsl:text><xsl:value-of disable-output-escaping="no" select="nroAsegurado"/>
									</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
