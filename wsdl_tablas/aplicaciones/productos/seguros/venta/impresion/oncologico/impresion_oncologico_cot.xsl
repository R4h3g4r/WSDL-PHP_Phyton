				...
				<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
						<fo:table-row padding-before="2pt">
							<fo:table-cell text-align="start" number-columns-spanned="2"  display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
				...
				<fo:table-column column-width="proportional-column-width(90)" background-color="#FFFFFF"/>
					<fo:table-body>
						...
						<fo:table-cell text-align="start" display-align="before" font-weight="bold" border-after-style="solid" border-width="0.5pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
										<fo:block text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
											<xsl:text>Futuros pagos</xsl:text>										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
						</fo:table>
