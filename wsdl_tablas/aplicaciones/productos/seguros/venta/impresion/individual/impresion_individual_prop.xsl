		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block>
							<xsl:call-template name="recuadroOfertaSeguros"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block >
							<xsl:call-template name="temp_tituloCuestionarioRobo"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block >
							<xsl:call-template name="temp_cuestionarioRobo"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
						...
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
							<fo:block  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
								<xsl:if test="( materiaAsegurada/materiaAsegurada = '1' )">
									<xsl:text>MATERIA ASEGURADA PARA EL RAMO INDIVIDUAL INCENDIO - Sólo Edificio</xsl:text>			
								</xsl:if>	
								<xsl:if test="( materiaAsegurada/materiaAsegurada = '2' )">
										<xsl:text>MATERIA ASEGURADA PARA EL RAMO INDIVIDUAL INCENDIO - Sólo Contenido</xsl:text>
								</xsl:if>	
								<xsl:if test="( materiaAsegurada/materiaAsegurada = '3' )">
										<xsl:text>MATERIA ASEGURADA PARA EL RAMO INDIVIDUAL INCENDIO - Edificio + Contenido</xsl:text>
								</xsl:if>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:block span="none" padding-before="6pt">
				...
				<fo:table-body>
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:if test="( detallePago/codigoFuturosPagos = '12' )">
									<xsl:text>Nro Crédito Hipotecario:</xsl:text>
								</xsl:if>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
						...
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:if test="( materiaAsegurada/usoVivienda != '1')">
									<xsl:text>Tipo de Ocupación</xsl:text>
								</xsl:if>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
...
<!-- 
 ...
 -->
	...
	<xsl:template name="temp_tituloCuestionarioRobo">
		<xsl:if test="( materiaAsegurada/coberturaRobo = 'S' )">
			<fo:block span="none">		
				<fo:table table-layout="fixed" width="100%">
				<fo:table-column column-width="proportional-column-width(100)" background-color="#FFFFFF"/>
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
									<xsl:text>DATOS ADICIONALES ROBO</xsl:text>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
	...
	<xsl:template name="temp_cuestionarioRobo">
		<xsl:if test="( materiaAsegurada/coberturaRobo = 'S' )">
		<fo:block span="none">
				<fo:table table-layout="fixed" width="100%">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt">
								<xsl:text>1. Rejas de protección en todas las puertas y ventanas con cristales: </xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF"  padding-before="4pt" padding-after="2pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/indicadorReja"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt">
								<xsl:text>2. Alarma central conectada en todas las puertas y ventanas: </xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="2pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/indicadorAlarma"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt">
								<xsl:text>3. Está situada en condominio o edificio, ambos con vigilancia permanente: </xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="2pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/indicadorVigilancia"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt">
								<xsl:text>4. Departamento desde piso 3 o superior: </xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="2pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/indicadorPiso"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
	...
	<xsl:template name="temp_datosPrimerPago">
		<fo:block span="none">
				...
				<xsl:if test="( detallePago/codigoPrimerPago = '12' )"> 
						<fo:table-row>
							<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt">
									<xsl:text>Nro Crédito Hipotecario:</xsl:text>
...
<!-- *********************************************************FIRMAS FINALES **************************************************** -->
	...
	<xsl:template name="recuadroOfertaSeguros">	
			...
			<fo:table-column column-width="proportional-column-width(100)" background-color="#FFFFFF"/>
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-after-style="solid" border-width="1.0pt" border-color="#DCDCDC" background-color="#FFFFFF" padding="4pt" padding-left="16pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#000000" font-size="12.0pt" font-weight="bold">
								<xsl:text>Informe Comparativo de los Seguros de Incendio y Sismo</xsl:text>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
		...
		<fo:table table-layout="fixed" width="95%">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="center" number-columns-spanned="2" display-align="center" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text disable-output-escaping="no">Seguros de incendio y Sismo ofrecidos por Bci</xsl:text>
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:text disable-output-escaping="no">Individual Full</xsl:text>
								</fo:block>
							</fo:table-cell>
						</xsl:if>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro = '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:text disable-output-escaping="no">Individual Básico</xsl:text>
								</fo:block>
							</fo:table-cell>
						</xsl:if>
						<fo:table-cell text-align="center" display-align="center" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text disable-output-escaping="no">Colectivo Licitado</xsl:text>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="start" number-rows-spanned="14" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Coberturas
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Incendio
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							...
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<fo:external-graphic scaling="uniform" height="7pt" width="8pt"> 
										<xsl:attribute name="src">url('<xsl:value-of disable-output-escaping="no" select="rutaLogos"/>/img/icono_feriados.gif')</xsl:attribute> 
									</fo:external-graphic>
								</fo:block>
							</fo:table-cell>
						</xsl:if>
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Gastos incurridos por inhabitabilidad de la vivienda
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Incendio y daños materiales causados por riesgos de la naturaleza
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Daños causados por Sismo y salida de mar originada por sismo
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Daños materiales causados por explosión, aeronaves o vehículos motorizados
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Daños materiales por rotura de cañerías
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Honorarios profesionales, daño eléctrico
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Saqueo y/o daños materiales a consecuencia directa de huelga, desorden popular.
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Rotura de cristales (Hasta UF 50)
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Responsabilidad Civil Familiar (Hasta UF 300)
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Asistencia domiciliaria (Gasfitería, cerrajería, electricidad y vidriería)
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="start" number-rows-spanned="6" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Exclusiones
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
								<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Caso de guerra y delitos contra la seguridad del estado
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Huelga y delitos contra el orden público
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Conductas o delitos de terrorismo
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Consecuencia de acto malicioso
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Construcciones hechas de adobe y sus contenidos
							</fo:block>
						</fo:table-cell>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					...
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="start" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
						...
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro != '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="SegurosRecuadro/porcentajeFull"/>%
								</fo:block>
							</fo:table-cell>
						</xsl:if>
						<xsl:if test="( SegurosRecuadro/tipoSeguroRecuadro = '0' )">
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="SegurosRecuadro/porcentajeBasico"/>%
								</fo:block>
							</fo:table-cell>
						</xsl:if>
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="SegurosRecuadro/porcentajeColectivo"/>%
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					
					<fo:table-row padding-before="10pt">
						<fo:table-cell text-align="start" number-columns-spanned="2" display-align="center" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								Prima Total Bruta Mensual UF
							</fo:block>
						</fo:table-cell>
							<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" font-weight="bold" border-color="#DCDCDC">
								<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
									<xsl:value-of disable-output-escaping="no" select="tarifa/primaBrutaMensual"/>
								</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" display-align="center" border-style="solid" border-width="0.1pt" font-weight="bold" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="SegurosRecuadro/tasaSeguroColectivo"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			...
			<fo:table table-layout="fixed" width="100%">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="justify" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" padding-right="8pt">
								<fo:block white-space-collapse="true"  text-align="justify" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="SegurosRecuadro/textoDeclaracion"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			...
			<fo:table table-layout="fixed" width="100%">
				<fo:table-column column-width="proportional-column-width(100)"/>
				<fo:table-body>
					<fo:table-row padding-before="6pt">
						<fo:table-cell text-align="justify" display-align="center" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt" padding-right="8pt">
							<fo:block white-space-collapse="true"  text-align="justify" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="SegurosRecuadro/textoSeguros"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
