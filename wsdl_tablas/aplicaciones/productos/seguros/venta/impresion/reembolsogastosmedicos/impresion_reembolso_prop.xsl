		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block >
							<xsl:call-template name="temp_mensajeFechaUF"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
   ...
   <fo:block padding-before="2pt">
	...
	<xsl:template name="temp_datosPrimas">
			...
			<fo:table-row>
				...
				<fo:table-cell text-align="center" number-columns-spanned="2" display-align="before" border-top-style="solid" border-width="0.1pt" border-color="#DCDCDC">
					<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
						<xsl:text>Prima Bruta Unica</xsl:text>
					</fo:block>
				</fo:table-cell>
