...
<xsl:template match="DatosCotizacion">
					...
					<fo:table-row>
						...
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/montoAseguradoEdificio"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text>Monto Asegurado Contenido (UF)</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/montoAseguradoContenido"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
								<xsl:text>Monto Asegurado Mercaderia (UF)</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" font-weight="bold" border-width="0.1pt" border-color="#DCDCDC">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" font-weight="bold" padding-before="4pt" padding-after="2pt">
								<xsl:value-of disable-output-escaping="no" select="materiaAsegurada/montoAseguradoMercaderia"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="start" display-align="before" border-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
							<fo:block white-space-collapse="true"  text-align="start" color="#0360A2" font-size="11.0pt" padding-before="4pt" padding-after="2pt">
	...
	<xsl:template name="temp_tituloDatosPrimas">
		<fo:block span="none" padding-before="6pt">
					...
					<xsl:for-each select="planesGlobales/compania">
						...
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="center" column-number="1" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Planes</xsl:text>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" column-number="2" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Edificio</xsl:text>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" column-number="3" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Contenido</xsl:text>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" column-number="4" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Edificio y Contenido</xsl:text>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" column-number="5" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Edificio y Mercaderías</xsl:text>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" column-number="6" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Contenido y Mercaderías</xsl:text>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center" column-number="7" display-align="before" font-weight="bold" padding-before="4pt">
								<fo:block text-align="center" color="#0360A2" font-size="11.0pt" font-weight="bold">
									<xsl:text>Edificio, Contenido y Mercaderías</xsl:text>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</xsl:for-each>
	...
	<xsl:template name="temp_datosPrimas">	
		<fo:block span="none" padding-before="6pt">
					...
					<fo:table-body>
					<xsl:for-each select="planesGlobales/compania">
					<xsl:for-each select="planes/tarifas">
						<fo:table-row padding-before="4pt">
							<fo:table-cell text-align="start" display-align="before" background-color="#FFFFFF" padding="4pt" padding-left="8pt">
								<fo:block text-align="start" color="#0360A2" font-size="11.0pt">
										<xsl:value-of disable-output-escaping="no" select="descripcionSubPlan"/>
								</fo:block>
							</fo:table-cell>
	...
	<xsl:template name="temp_tituloDatosDetalle">
		<fo:block span="none" padding-before="6pt">
					<fo:table table-layout="fixed" width="100%">
					<fo:table-column column-width="proportional-column-width(20)" column-number="1" background-color="#FFFFFF"/>
					<fo:table-column column-width="proportional-column-width(14)" column-number="2" background-color="#FFFFFF"/>
