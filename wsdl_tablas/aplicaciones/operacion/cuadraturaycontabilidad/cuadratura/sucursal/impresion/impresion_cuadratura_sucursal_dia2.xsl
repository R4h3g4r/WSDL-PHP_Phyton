		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
				...
				<fo:page-sequence master-name="paginaPrincipal" master-reference="masterSequenceName1">
					...
					<xsl:template name="tempTituloPrincipal">
		
						<fo:block padding-before="2pt">
			
							<fo:table table-layout="fixed" width="100%">
								<fo:table-column column-width="proportional-column-width(2)" background-color="#FFFFFF"/>
								<fo:table-column column-width="proportional-column-width(96)" background-color="#FFFFFF"/>
								<fo:table-column column-width="proportional-column-width(2)" background-color="#FFFFFF"/>
								<fo:table-body>
									<fo:table-row>
									<fo:table-cell column-number="2" padding="2.0pt" text-align="start" border-style="solid" display-align="before" border-width="1.0pt" border-color="#000000" background-color="#336699" >
										...
										<xsl:text>CUADRATURA DE SUCURSAL - DIA 2</xsl:text>
										</fo:block>
									</fo:table-cell>
									</fo:table-row>
								</fo:table-body>
					...
					<fo:block span="none" padding-before="6pt">
							...
							<fo:table-column column-width="proportional-column-width(24)" background-color="#f0f0f0" />
							<fo:table-column column-width="proportional-column-width(72)" background-color="#f0f0f0" />
							<fo:table-column column-width="proportional-column-width(2)"/>
							<fo:table-body>
								<fo:table-row>
					...
					<fo:block span="none" padding-before="6pt">
							...
							<fo:table-column column-width="proportional-column-width(12)" background-color="#f0f0f0" />
							<fo:table-column column-width="proportional-column-width(12)" background-color="#f0f0f0" />
							<fo:table-column column-width="proportional-column-width(12)" background-color="#f0f0f0" />
							<fo:table-column column-width="proportional-column-width(12)" background-color="#f0f0f0" />
							<fo:table-column column-width="proportional-column-width(12)" background-color="#f0f0f0" />
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell number-columns-spanned="2" text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:text>DIA 1</xsl:text>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell number-columns-spanned="2" text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:text>DIA 2</xsl:text>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell number-columns-spanned="2" text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:text>DIFERENCIA</xsl:text>
									</fo:block>
									</fo:table-cell>
								</fo:table-row>							
								<fo:table-row>
									...
									<fo:table-cell column-number="6" text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:text disable-output-escaping="no">HABER</xsl:text>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="7" text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-width="0.1pt" border-color="#DCDCDC">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:text>DEBE</xsl:text>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="8" text-align="center" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-left="8pt">
									<fo:block white-space-collapse="true"  text-align="center" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:text disable-output-escaping="no">HABER</xsl:text>
									</fo:block>
									</fo:table-cell>
						...
						<xsl:for-each select="campos/campo">
								...
								<fo:table-row>
									...
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="debe1"/>
									</fo:block>
									</fo:table-cell>
									...
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="haber1"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="5" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="debe2"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="6" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="haber2"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="7" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="debeDiferencia"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="8" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="haberDiferencia"/>
									</fo:block>
									</fo:table-cell>
								</fo:table-row>		
					...
					<fo:block span="none" padding-before="6pt">
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell column-number="3" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="totalDebe1"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="4" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="totalHaber1"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="5" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="totalDebe2"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="6" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="totalHaber2"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="7" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="totalDiferenciaDebe"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="8" text-align="right" display-align="before" border-top-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="totalDiferenciaHaber"/>
									</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
									...
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="diferenciaDebe1"/>
									</fo:block>
									</fo:table-cell>
									...
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="diferenciaHaber1"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="5" text-align="right" display-align="before" border-top-style="solid" border-after-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="diferenciaDebe2"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="6" text-align="right" display-align="before" border-top-style="solid" border-after-style="solid"  border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="diferenciaHaber2"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="7" text-align="right" display-align="before" border-top-style="solid" border-after-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
										<xsl:value-of disable-output-escaping="no" select="diferenciaDebe"/>
									</fo:block>
									</fo:table-cell>
									<fo:table-cell column-number="8" text-align="right" display-align="before" border-top-style="solid" border-after-style="solid" border-left-style="solid" border-right-style="solid" border-width="0.1pt" border-color="#DCDCDC" padding-right="8pt">
									<fo:block white-space-collapse="true"  text-align="right" color="#0360A2" font-size="11.0pt" padding-before="4pt">
