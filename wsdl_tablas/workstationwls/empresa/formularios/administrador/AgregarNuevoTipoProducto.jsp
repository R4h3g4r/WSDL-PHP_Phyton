...
<head>
	...
	function fnAgregarProducto(){
		...
		document.forms[0].metodo.value = 'agregarTipoProducto';
...
<body>
	...
	<form action="administracionFormulario.do">
		...
		<fieldset>
		<legend style="font-size:13px;color: black;"><b><fmt:message key="adm.producto.agr"/></b></legend>
		<table id="lista-bonita" width="100%" height="100%">
			<tr>
				<th width="20%"><fmt:message key="adm.producto.nom"/></th><td><input class="caja280" type="text" name="nombrelDelProducto"> </td>
			</tr>
		</table>
		<div>
		<input class="boton160" type="button" value="<fmt:message key="adm.guardar"/>" onclick="fnAgregarProducto()">
		</div>
		</fieldset>
		</td>
		</tr>
...
<%--
 ******************************************************************************************************
 * Archivo           AgregarNuevoTipoProducto.jsp
 * Descripción       Agrega un nuevo tipo de producto
 * Versión           1.0
