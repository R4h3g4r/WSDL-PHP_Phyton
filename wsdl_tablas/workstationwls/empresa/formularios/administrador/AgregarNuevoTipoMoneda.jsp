...
<head>
	...
	function fnAgregarMoneda(){
		...
		if(trim(document.forms[0].nombreDeLaMoneda.value) == ''){
			...
			document.getElementById('error').innerHTML = 'Debe ingresar un Nombre de Moneda';
			return;
		}
		document.forms[0].metodo.value = 'agregarTipoMoneda';
...
<body>
	...
	<form action="administracionFormulario.do" >
		...
		<fieldset>
		<legend style="font-size:13px;color: black;"><b><fmt:message key="adm.moneda.agr"/><b></legend>
		<table id="lista-bonita" width="100%" height="100%">
			<tr>
				<th width="20%"><fmt:message key="adm.moneda.nom"/></th><td><input class="caja280" type="text" name="nombreDeLaMoneda"> </td>
			</tr>
		</table>
		<div>
		<input class="boton160" type="button" value="<fmt:message key="adm.guardar"/>" onclick="fnAgregarMoneda()">
		</div>
		</fieldset>
		</td>
		</tr>
...
<%--
 ******************************************************************************************************
 * Archivo           AgregarNuevoTipoMoneda.jsp
 * Descripción       Agrega un nuevo tipo de moneda
 * Versión           1.0
