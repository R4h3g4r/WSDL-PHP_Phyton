            ...
            <fo:table-body>
              <fo:table-row >
                ...
                <fo:table-cell>
                  ...
                  <fo:block text-align="left" font-size="13pt"> Nacional al <xsl:value-of select="encabezado/fecha/@value"/> </fo:block>
                </fo:table-cell>
              </fo:table-row>
              <fo:table-row >
		      ...
		      <fo:table-row>
                        ...
                        <fo:table-row>
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#EFEFEF" border-bottom-width="1px" border-bottom-style="solid">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" > CUENTA Nº </fo:block>
                          </fo:table-cell>
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#EFEFEF" border-bottom-width="1px" border-bottom-style="solid">
          ...
          <fo:table border-collapse="collapse" table-layout="fixed">
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell>
                  <fo:block text-align="right" font-size="9pt" margin-right="10pt"> Monto $ </fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>
                  ...
                  <fo:block text-align="center">
                    <fo:table border-collapse="collapse" table-layout="fixed">
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Pago Mínimo </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> $ <xsl:value-of select="encabezado/pagoMinimo/@value"/> </fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
