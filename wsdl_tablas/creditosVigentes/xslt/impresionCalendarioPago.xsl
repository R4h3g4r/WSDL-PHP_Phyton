...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:template match="impresionCalendarioPago">
                                                        ...
                                                        <fo:table-cell text-align="center">
                                                            ...
                                                            border-bottom-style="solid" border-bottom-width="1px">
                                                                <fo:table width="100%">
																    ...
																    <fo:table-column column-width="proportional-column-width(10)" column-number="9"/>
																	<fo:table-column column-width="proportional-column-width(10)" column-number="10"/>
                                                                    <fo:table-header>
                                                                    ...
                                                                    <xsl:for-each select="listaCalendario/cuota"> 
                                                                    <fo:table-body>
                                                                     <fo:table-row font-size="8pt" border-top-style="solid" border-top-width="2px" >
                                                                            ...
                                                                            <fo:table-cell border-right-style="solid" border-right-width="1px">  
																			  ...
																			  <fo:table-cell >  
                                                                                <fo:block text-align="center" space-before="5mm" > 
                                                                                    <xsl:value-of select="totalCuota"/>
                                                                                </fo:block>
                                                                            </fo:table-cell>
                                                                        </fo:table-row>
                                                                       </fo:table-body>
