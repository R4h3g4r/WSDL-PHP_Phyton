                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block>
                        ...
                        <fo:table width="100%" table-layout="fixed" space-before.optimum="1pt" space-after.optimum="2pt">
                            ...
                            <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell number-rows-spanned="2" text-align="center" width="195pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                            <fo:inline font-size="14pt" font-weight="bold">PACKING LIST</fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell line-height="10pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                    ...
                                    <fo:table-cell line-height="10pt" width="77pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                ...
                                <fo:table-row>
                                    <fo:table-cell number-columns-spanned="4" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                            <fo:inline font-size="9pt">Customer Ref.:</fo:inline>
                                ...
                                <fo:table-row>
                                    <fo:table-cell line-height="11pt" width="195pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                                        ...
                                                        <xsl:if test="position()=1">
                                                            <fo:table table-layout="fixed" width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                                                ...
                                                                <fo:table-body>
                                                                    <xsl:for-each select="../AddressInformation">
                                                                        <fo:table-row>
                                                                            <fo:table-cell line-height="11pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
                                                                                <fo:block>
                                                                                    <xsl:if test="contains(  ../partyQualifier  , &apos;DDD&apos;)  or  contains(  ../partyQualifier  , &apos;DWE&apos;)">
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell line-height="8pt" number-columns-spanned="4" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                            ...
                                            <fo:inline font-size="9pt">Issuing date:&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Expiry Date:</fo:inline>
                                            <fo:block>
                                                <fo:leader leader-pattern="space" />
                                            </fo:block>
                                        </fo:block>
                                ...
                                <fo:table-row>
                                    <fo:table-cell number-columns-spanned="5" width="221pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                        <fo:block>
                                            <fo:table width="100%" table-layout="fixed" space-before.optimum="1pt" space-after.optimum="2pt">
                                                ...
                                                <fo:table-body>
                                                    <fo:table-row>
                                                        <fo:table-cell width="97pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                            <fo:block>
                                                                                            ...
                                                                                            <xsl:for-each select="../Product">
                                                                                                <fo:table-row>
                                                                                                    <fo:table-cell text-align="right" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" border-style="solid" border-width="1pt" border-color="white">
                                                                                                        <fo:block>
                                                                                                            <fo:inline font-size="10pt">
                                                                                                            	 <xsl:value-of  select="packageQty  *  netWeight " />
                                                                                                            </fo:inline>
                                                                                                            <fo:block>
                                                                                                                <fo:leader leader-pattern="space" />
                                                                                                            </fo:block>
