...
<xsl:if test="contains(locationQualifier/text(),'4')">																										<xsl:for-each select="LocationCodeOrName">
...
<xsl:for-each select="Location">
<xsl:if test="contains(locationQualifier/text(),'6')">
																			...
																			<fo:table width="100%" table-layout="fixed" space-before.optimum="4pt" space-after.optimum="4pt">
																				...
																				<fo:table-body>
																					...
																					<fo:table-row>
																						...
																						<fo:table-cell text-align="center" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
																							<fo:block><xsl:value-of select="sum(LineItemDetails/LineItemQuantity/value)" /></fo:block>
																						</fo:table-cell>
																						...
																						<fo:table-cell text-align="center" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
																							<fo:block>
																							<xsl:value-of select="sum(LineItemDetails/LineItemTotalAmount/MultiCurrency/MonetaryAmount/value)" /> 
																							</fo:block>
																						</fo:table-cell>
																					</fo:table-row>
																					<fo:table-row>
