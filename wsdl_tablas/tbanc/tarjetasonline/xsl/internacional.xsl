    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="first"
          ...
          page-width="21cm"
          page-height="29.7cm">
          <fo:region-body margin-top="7.2cm" margin-bottom="12cm"/>
          ...
          <fo:table border-collapse="collapse" table-layout="fixed">
            ...
            <fo:table-body>
              <fo:table-row >
                ...
                <fo:table-cell>
                  <fo:block text-align="left" font-size="13pt"> Estado de Cuenta </fo:block>
                  <fo:block text-align="left" font-size="13pt"> Internacional al <xsl:value-of select="encabezado/fecha/@value"/> </fo:block>
                </fo:table-cell>
              </fo:table-row>
              <fo:table-row >
		      ...
		      <fo:table-row>
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#000000" border-bottom-width="2px" border-bottom-style="solid">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> US $ <xsl:value-of select="encabezado/cupoTotal/@value"/> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#000000" border-bottom-width="2px" border-bottom-style="solid">
                          ...
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#000000" border-bottom-width="2px" border-bottom-style="solid">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> US $ <xsl:value-of select="encabezado/cupoUtilizado/@value"/></fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          ...
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#000000" border-bottom-width="2px" border-bottom-style="solid">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> US $ <xsl:value-of select="encabezado/cupoDisponible/@value"/> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
			 <fo:table-row>
                          <fo:table-cell background-color="#EFEFEF">
		      ...
		      <fo:table-row>
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#EFEFEF" border-bottom-width="2px" border-bottom-style="solid">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> US $ <xsl:value-of select="encabezado/montoFacturado/@value"/> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          <fo:table-cell background-color="#EFEFEF" border-bottom-color="#EFEFEF" border-bottom-width="2px" border-bottom-style="solid">
			...
			<fo:table-row>
                ...
                <fo:table-cell>
                  ...
                  <fo:block text-align="left" font-size="5pt"> Consideramos aprobado este estado de cuenta </fo:block>
                  <fo:block text-align="left" font-size="5pt"> si dentro de 45 días no hemos recibido aviso por escrito en contrario </fo:block>
	    ...
	    <fo:table-column column-width="3cm"/>
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid">
                            <fo:block text-align="center" font-size="8pt" padding-top="2pt"> US $ <xsl:value-of select="encabezado/saldoCapitalCuotas/@value"/> </fo:block>
                          </fo:table-cell>
                          <fo:table-cell>
                                ...
                                <fo:table-body>
                                  <fo:table-row>
                                    <fo:table-cell height="12pt" border-color="black" border-width="0.5pt" border-style="solid">
                                      <fo:block text-align="center" font-size="8pt" padding-top="2pt"> US $ <xsl:value-of select="encabezado/vencimientoCuotas1/@value"/> </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell height="12pt" border-color="black" border-width="0.5pt" border-style="solid">
                                      <fo:block text-align="center" font-size="8pt" padding-top="2pt"> US $ <xsl:value-of select="encabezado/vencimientoCuotas2/@value"/></fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell height="12pt" border-color="black" border-width="0.5pt" border-style="solid">
                                      <fo:block text-align="center" font-size="8pt" padding-top="2pt"> US $ <xsl:value-of select="encabezado/vencimientoCuotas3/@value"/> </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell height="12pt" border-color="black" border-width="0.5pt" border-style="solid">
                                      <fo:block text-align="center" font-size="8pt" padding-top="2pt"> US $ <xsl:value-of select="encabezado/vencimientoCuotas4/@value"/> </fo:block>
                                    </fo:table-cell>
                                  </fo:table-row>
                                </fo:table-body>
                              </fo:table>
          ...
          <fo:table border-collapse="collapse" table-layout="fixed">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block text-align="right" font-size="7pt"> Movimientos del Periodo &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; <fo:page-number/> de 1 </fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>
          ...
          <fo:table border-collapse="collapse" table-layout="fixed">
            ...
            <fo:table-column column-width="2cm"/>
            <fo:table-column column-width="5cm"/>
            <fo:table-column column-width="2.28cm"/>
			<fo:table-column column-width="2.34cm"/>
            <fo:table-column column-width="2.5cm"/>
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell padding-top="0pt">
                  <fo:block text-align="left" font-size="9pt" margin-left="5pt"> Nº de Ref. </fo:block>
                </fo:table-cell>
                <fo:table-cell>
                  <fo:block text-align="left" font-size="9pt"> Fecha </fo:block>
                </fo:table-cell>
                <fo:table-cell>
                  <fo:block text-align="left" font-size="9pt"> Descripción </fo:block>
                </fo:table-cell>
                <fo:table-cell>
                  <fo:block text-align="left" font-size="9pt"> Ciudad </fo:block>
                </fo:table-cell>
				<fo:table-cell>
                  <fo:block text-align="left" font-size="9pt"> &#160; </fo:block>
                </fo:table-cell>
                <fo:table-cell>
                  <fo:block text-align="right" font-size="9pt" margin-right="10pt"> Monto US $ </fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>
        ...
        <fo:static-content flow-name="xsl-region-after">
                  ...
                  <fo:block text-align="center">
                    <fo:table border-collapse="collapse" table-layout="fixed">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell background-color="#EFEFEF">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> ACTIVIDAD DE LA CUENTA </fo:block>
                          </fo:table-cell>
                          <fo:table-cell background-color="#EFEFEF">
                            <fo:block text-align="center" font-size="8pt"> US $ </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
          ...
          <fo:table border-collapse="collapse" table-layout="fixed">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid">
                  <fo:block text-align="left" font-size="8pt" padding-top="10pt" margin-left="3pt"> Los cargos por retraso generan un recargo por concepto por los gastos de cobranza que incurra de acuerdo a lo
                ...
                <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid">
                  <fo:block text-align="left" font-size="8pt" padding-top="15pt" margin-left="3pt"> En caso de perdida o robo de su tarjeta de crédito, llame gratis al 800 201 090 para solicitar su bloqueo </fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="15pt">
                  <fo:block text-align="center" font-size="9pt" padding-top="2pt"> COMPROBANTE DE PAGO <xsl:value-of select="encabezado/file2/@value"/></fo:block>
                </fo:table-cell>
                <fo:table-cell>
                  <fo:block > </fo:block>
                </fo:table-cell>
                <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="15pt">
                  <fo:block text-align="center" font-size="9pt" padding-top="2pt"> COMPROBANTE DE PAGO </fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="7.5pt" margin-left="3pt" padding-top="2.5pt"> Nombre </fo:block>
                            <fo:block text-align="left" font-size="7.5pt" margin-left="3pt"> <xsl:value-of select="encabezado/nombre/@value"/> </fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="7.5pt" margin-left="3pt" padding-top="2.5pt"> Número de Cuenta </fo:block>
                            <fo:block text-align="left" font-size="7.5pt" margin-left="3pt"> <xsl:value-of select="encabezado/cuenta/@value"/> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="7.5pt" margin-left="3pt" padding-top="2.5pt"> Pagar Hasta </fo:block>
                            <fo:block text-align="left" font-size="7.5pt" margin-left="3pt"><xsl:value-of select="encabezado/fechaVencimientoFacturacion/@value"/></fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Monto Facturado </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> US $ <xsl:value-of select="encabezado/montoFacturado/@value"/> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> &#160; </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> &#160; </fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Monto Cancelado </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                      </fo:table-body>
                  ...
                  <fo:block text-align="center">
                    <fo:table border-collapse="collapse" table-layout="fixed">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Nombre </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> <xsl:value-of select="encabezado/nombre/@value"/> </fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Número de Cuenta </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"><xsl:value-of select="encabezado/cuenta/@value"/> </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Pagar Hasta </fo:block>
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt"> <xsl:value-of select="encabezado/fechaVencimientoFacturacion/@value"/> </fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-color="black" border-width="0.5pt" border-style="solid" height="25pt">
                            <fo:block text-align="left" font-size="8pt" margin-left="3pt" padding-top="2.5pt"> Monto Facturado </fo:block>
                      ...
                      <fo:block text-align="left">
                        <fo:table border-collapse="collapse" table-layout="fixed">
                          ...
                          <fo:table-body>
                            <fo:table-row>
                              <fo:table-cell>
                                <fo:block text-align="left" font-size="8pt" margin-left="3pt"> <xsl:value-of select="@glosa"/> </fo:block>
                              </fo:table-cell>
                              <fo:table-cell>
            ...
            <fo:table-column column-width="1.5cm"/>
                <fo:table-body>
                  <fo:table-row>
                    ...
                    <fo:table-cell>
                      <fo:block text-align="right" font-size="8pt" margin-right="4pt" font-weight="bold"> <xsl:value-of select="@monto"/> </fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
