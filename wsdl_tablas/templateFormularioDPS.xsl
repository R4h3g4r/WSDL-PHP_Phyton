        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="basicPSM">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block text-align="center" color="#000000" font-size="15pt" font-weight="100">DECLARACION PERSONAL DE SALUD</fo:block>
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <fo:table-cell background-color="#BEBEBE">
                                    <fo:block text-align="left" color="#000000" font-size="10pt" font-weight="100">DPS N°</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                                <fo:table-cell>
                    ...
                    <fo:table font-family="Arial,Verdana,Helvetica" border="solid 0.1mm black" padding-top="3pt" padding-left="5pt" padding-right="5pt">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell number-columns-spanned="4" background-color="#BEBEBE">
                                    <fo:block text-align="left" color="#000000" font-size="10pt" font-weight="100">¿Tiene Subsidio MINVU?</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
