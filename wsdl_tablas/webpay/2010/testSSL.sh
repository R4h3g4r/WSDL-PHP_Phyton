...
/usr/local/ssl/bin/openssl s_client -connect wswebpay:8443 -CAfile Transbank_CA_PublicKEY.pem -cert  credito_inversiones.firmado.pem -certform PEM -key private_KEY_emisor.pem -keyform PEM
