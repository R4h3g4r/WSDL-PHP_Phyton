...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
	...
	<fo:table>
     ...
     <fo:table-header>
	    <fo:table-row>
		  ...
		  <fo:table-cell border-style="solid" text-align="center" display-align="center">
		   <fo:block font-size="8pt" font-family="sans-serif">Fecha Creación</fo:block></fo:table-cell>
		  <fo:table-cell border-style="solid" text-align="center" display-align="center">
		   <fo:block font-size="8pt" font-family="sans-serif">Fecha Modificación</fo:block></fo:table-cell>
		   <fo:table-cell border-style="solid" text-align="center" display-align="center">
		   <fo:block font-size="8pt" font-family="sans-serif">Estado</fo:block></fo:table-cell>
		   <fo:table-cell border-style="solid" text-align="center" display-align="center">
	...
	<xsl:for-each select="fila">
		<fo:table-row>
		  ...
		  <fo:table-cell border-style="solid" text-align="center" display-align="center">
		    <fo:block font-size="8pt" font-family="sans-serif"><xsl:value-of select='fechaIng'/></fo:block></fo:table-cell>
		  <fo:table-cell border-style="solid" text-align="center" display-align="center">
		    <fo:block font-size="8pt" font-family="sans-serif"><xsl:value-of select='fechaMod'/></fo:block></fo:table-cell>
		  <fo:table-cell border-style="solid" text-align="center" display-align="center">
		    <fo:block font-size="8pt" font-family="sans-serif"><xsl:value-of select='estado'/></fo:block></fo:table-cell>
		  <fo:table-cell border-style="solid" text-align="center" display-align="center">
